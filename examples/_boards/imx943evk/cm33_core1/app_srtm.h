...
#define RPMSG_LITE_SRTM_LINK_ID    (RL_PLATFORM_IMX943_M331_A55_SRTM_LINK_ID)
#define RPMSG_LITE_MU (RPMSG_LITE_M331_A55_MU)
#define RPMSG_LITE_MU_IRQ (RPMSG_LITE_M331_A55_MU_IRQn)
...
extern int32_t RPMsg_MU15_A_IRQHandler(void);
/*******************************************************************************
 * API
 ******************************************************************************/
