...
#if !defined(MIMX94398_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MIMX94398_cm33_core1_H_
...
#endif  /* #if !defined(MIMX94398_cm33_core1_H_) */
