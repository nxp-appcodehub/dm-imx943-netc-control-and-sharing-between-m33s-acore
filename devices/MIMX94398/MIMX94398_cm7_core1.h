...
#if !defined(MIMX94398_cm7_core1_H_)  /* Check if memory map has not been already included */
#define MIMX94398_cm7_core1_H_
...
#endif  /* #if !defined(MIMX94398_cm7_core1_H_) */
