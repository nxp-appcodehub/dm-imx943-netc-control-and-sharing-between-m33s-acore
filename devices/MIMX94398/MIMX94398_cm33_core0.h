...
#if !defined(MIMX94398_cm33_core0_H_)  /* Check if memory map has not been already included */
#define MIMX94398_cm33_core0_H_
...
#endif  /* #if !defined(MIMX94398_cm33_core0_H_) */
