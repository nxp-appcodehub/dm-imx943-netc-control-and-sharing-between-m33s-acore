...
#if !defined(NOC_BLK_CTRL_NOCMIX_H_)
#define NOC_BLK_CTRL_NOCMIX_H_                   /**< Symbol preventing repeated inclusion */
...
typedef struct {
  ...
  __IO uint32_t INITIATOR_TIMEOUT;                 /**< Initiator timeout, offset: 0xF0 */
...
/*! @name INITIATOR_TIMEOUT - Initiator timeout */
/*! @{ */
...
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_rd_timeout_MASK (0x800U)
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_rd_timeout_SHIFT (11U)
...
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_wr_timeout_MASK (0x1000U)
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_wr_timeout_SHIFT (12U)
/*! m_e_6_wr_timeout - Initiator timeout for m_e_6_wr */
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_wr_timeout(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_wr_timeout_SHIFT)) & NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_6_wr_timeout_MASK)

#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_7_rd_timeout_MASK (0x2000U)
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_7_rd_timeout_SHIFT (13U)
...
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_7_wr_timeout_MASK (0x4000U)
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_7_wr_timeout_SHIFT (14U)
...
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_9_rd_timeout_MASK (0x8000U)
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_9_rd_timeout_SHIFT (15U)
...
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_9_wr_timeout_MASK (0x10000U)
#define NOC_BLK_CTRL_NOCMIX_INITIATOR_TIMEOUT_m_e_9_wr_timeout_SHIFT (16U)
...
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_MASK (0x1U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_SHIFT (0U)
/*! lpcg_apb_clk_root_force_on_off - lpcg_apb_clk_root_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_sel_MASK (0x2U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_sel_SHIFT (1U)
/*! lpcg_apb_clk_root_force_on_off_sel - lpcg_apb_clk_root_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_MASK (0x4U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_SHIFT (2U)
/*! lpcg_noc_clk_root_force_on_off - lpcg_noc_clk_root_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_sel_MASK (0x8U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_sel_SHIFT (3U)
/*! lpcg_noc_clk_root_force_on_off_sel - lpcg_noc_clk_root_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_MASK (0x10U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_SHIFT (4U)
/*! lpcg_noc_clk_root_ocram_force_on_off - lpcg_noc_clk_root_ocram_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_sel_MASK (0x20U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_sel_SHIFT (5U)
/*! lpcg_noc_clk_root_ocram_force_on_off_sel - lpcg_noc_clk_root_ocram_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ocram_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_MASK (0x40U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_SHIFT (6U)
/*! lpcg_gic700_force_on_off - lpcg_gic700_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_sel_MASK (0x80U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_sel_SHIFT (7U)
/*! lpcg_gic700_force_on_off_sel - lpcg_gic700_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_gic700_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_MASK (0x100U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_SHIFT (8U)
/*! lpcg_osc_24m_clk_root_force_on_off - lpcg_osc_24m_clk_root_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_sel_MASK (0x200U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_sel_SHIFT (9U)
/*! lpcg_osc_24m_clk_root_force_on_off_sel - lpcg_osc_24m_clk_root_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_MASK (0x400U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_SHIFT (10U)
/*! lpcg_noc_clk_root_ungated_force_on_off - lpcg_noc_clk_root_ungated_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_sel_MASK (0x800U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_sel_SHIFT (11U)
/*! lpcg_noc_clk_root_ungated_force_on_off_sel - lpcg_noc_clk_root_ungated_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_noc_clk_root_ungated_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_MASK (0x1000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_SHIFT (12U)
/*! lpcg_osc_24m_clk_root_ungated_force_on_off - lpcg_osc_24m_clk_root_ungated_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_sel_MASK (0x2000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_sel_SHIFT (13U)
/*! lpcg_osc_24m_clk_root_ungated_force_on_off_sel - lpcg_osc_24m_clk_root_ungated_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_osc_24m_clk_root_ungated_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_MASK (0x4000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_SHIFT (14U)
/*! lpcg_apb_clk_root_ungated_force_on_off - lpcg_apb_clk_root_ungated_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_sel_MASK (0x8000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_sel_SHIFT (15U)
/*! lpcg_apb_clk_root_ungated_force_on_off_sel - lpcg_apb_clk_root_ungated_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_root_ungated_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_MASK (0x10000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_SHIFT (16U)
/*! ipc_noc_central_force_on_off - ipc_noc_central_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_sel_MASK (0x20000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_sel_SHIFT (17U)
/*! ipc_noc_central_force_on_off_sel - ipc_noc_central_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_ipc_noc_central_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_MASK (0x40000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_SHIFT (18U)
/*! lpcg_apb_clk_wdog3_force_on_off - lpcg_apb_clk_wdog3_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_sel_MASK (0x80000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_sel_SHIFT (19U)
/*! lpcg_apb_clk_wdog3_force_on_off_sel - lpcg_apb_clk_wdog3_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog3_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_MASK (0x100000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_SHIFT (20U)
/*! lpcg_lpo_clk_wdog3_force_on_off - lpcg_lpo_clk_wdog3_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_sel_MASK (0x200000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_sel_SHIFT (21U)
/*! lpcg_lpo_clk_wdog3_force_on_off_sel - lpcg_lpo_clk_wdog3_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog3_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_MASK (0x400000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_SHIFT (22U)
/*! lpcg_ext_clk_wdog3_force_on_off - lpcg_ext_clk_wdog3_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_sel_MASK (0x800000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_sel_SHIFT (23U)
/*! lpcg_ext_clk_wdog3_force_on_off_sel - lpcg_ext_clk_wdog3_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog3_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_MASK (0x1000000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_SHIFT (24U)
/*! lpcg_apb_clk_wdog4_force_on_off - lpcg_apb_clk_wdog4_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_sel_MASK (0x2000000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_sel_SHIFT (25U)
/*! lpcg_apb_clk_wdog4_force_on_off_sel - lpcg_apb_clk_wdog4_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_apb_clk_wdog4_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_MASK (0x4000000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_SHIFT (26U)
/*! lpcg_lpo_clk_wdog4_force_on_off - lpcg_lpo_clk_wdog4_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_sel_MASK (0x8000000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_sel_SHIFT (27U)
/*! lpcg_lpo_clk_wdog4_force_on_off_sel - lpcg_lpo_clk_wdog4_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_lpo_clk_wdog4_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_MASK (0x10000000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_SHIFT (28U)
/*! lpcg_ext_clk_wdog4_force_on_off - lpcg_ext_clk_wdog4_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_sel_MASK (0x20000000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_sel_SHIFT (29U)
/*! lpcg_ext_clk_wdog4_force_on_off_sel - lpcg_ext_clk_wdog4_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG_NOCMIX_lpcg_ext_clk_wdog4_force_on_off_sel_MASK)
/*! @} */

/*! @name LPCG__NOCMIX - LPCG Controls */
/*! @{ */

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_MASK (0x1U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_SHIFT (0U)
/*! ipc_noc_clk_2_force_on_off - ipc_noc_clk_2_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_sel_MASK (0x2U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_sel_SHIFT (1U)
/*! ipc_noc_clk_2_force_on_off_sel - ipc_noc_clk_2_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_2_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_MASK (0x4U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_SHIFT (2U)
/*! ipc_noc_clk_3_force_on_off - ipc_noc_clk_3_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_sel_MASK (0x8U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_sel_SHIFT (3U)
/*! ipc_noc_clk_3_force_on_off_sel - ipc_noc_clk_3_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_noc_clk_3_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_MASK (0x10U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_SHIFT (4U)
/*! ipc_apb_clk_2_force_on_off - ipc_apb_clk_2_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_sel_MASK (0x20U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_sel_SHIFT (5U)
/*! ipc_apb_clk_2_force_on_off_sel - ipc_apb_clk_2_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_2_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_MASK (0x40U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_SHIFT (6U)
/*! ipc_apb_clk_3_force_on_off - ipc_apb_clk_3_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_sel_MASK (0x80U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_sel_SHIFT (7U)
/*! ipc_apb_clk_3_force_on_off_sel - ipc_apb_clk_3_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_3_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_MASK (0x100U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_SHIFT (8U)
/*! ipc_apb_clk_4_force_on_off - ipc_apb_clk_4_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_sel_MASK (0x200U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_sel_SHIFT (9U)
/*! ipc_apb_clk_4_force_on_off_sel - ipc_apb_clk_4_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_apb_clk_4_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_MASK (0x400U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_SHIFT (10U)
/*! ipc_refclk_force_on_off - ipc_refclk_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_sel_MASK (0x800U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_sel_SHIFT (11U)
/*! ipc_refclk_force_on_off_sel - ipc_refclk_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_refclk_force_on_off_sel_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_MASK (0x1000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_SHIFT (12U)
/*! ipc_aips4_force_on_off - ipc_aips4_force_on_off */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_MASK)

#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_sel_MASK (0x2000U)
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_sel_SHIFT (13U)
/*! ipc_aips4_force_on_off_sel - ipc_aips4_force_on_off_sel */
#define NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_sel(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_sel_SHIFT)) & NOC_BLK_CTRL_NOCMIX_LPCG__NOCMIX_ipc_aips4_force_on_off_sel_MASK)
/*! @} */

/*! @name WDOG_REGISTERS - wdog ipg_dbng(debug mode) */
/*! @{ */

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core0_MASK (0x1U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core0_SHIFT (0U)
/*! ipg_dbng_wdog3_core0 - ipg_dbng_wdog3_core0 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core0(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core0_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core0_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core1_MASK (0x2U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core1_SHIFT (1U)
/*! ipg_dbng_wdog3_core1 - ipg_dbng_wdog3_core1 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core1(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core1_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core1_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core2_MASK (0x4U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core2_SHIFT (2U)
/*! ipg_dbng_wdog3_core2 - ipg_dbng_wdog3_core2 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core2(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core2_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core2_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core3_MASK (0x8U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core3_SHIFT (3U)
/*! ipg_dbng_wdog3_core3 - ipg_dbng_wdog3_core3 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core3(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core3_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog3_core3_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core0_MASK (0x10U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core0_SHIFT (4U)
/*! ipg_dbng_wdog4_core0 - ipg_dbng_wdog4_core0 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core0(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core0_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core0_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core1_MASK (0x20U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core1_SHIFT (5U)
/*! ipg_dbng_wdog4_core1 - ipg_dbng_wdog4_core1 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core1(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core1_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core1_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core2_MASK (0x40U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core2_SHIFT (6U)
/*! ipg_dbng_wdog4_core2 - ipg_dbng_wdog4_core2 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core2(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core2_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core2_MASK)

#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core3_MASK (0x80U)
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core3_SHIFT (7U)
/*! ipg_dbng_wdog4_core3 - ipg_dbng_wdog4_core3 */
#define NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core3(x) (((uint32_t)(((uint32_t)(x)) << NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core3_SHIFT)) & NOC_BLK_CTRL_NOCMIX_WDOG_REGISTERS_ipg_dbng_wdog4_core3_MASK)
/*! @} */
