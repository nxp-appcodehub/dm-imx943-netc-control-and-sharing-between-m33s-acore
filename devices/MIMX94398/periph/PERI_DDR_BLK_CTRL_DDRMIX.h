...
#define DDR_BLK_CTRL_DDRMIX_AXI_PARITY_ERR_INJECT_RDATACHK_ERR_INJ_MASK (0x4U)
#define DDR_BLK_CTRL_DDRMIX_AXI_PARITY_ERR_INJECT_RDATACHK_ERR_INJ_SHIFT (2U)
/*! RDATACHK_ERR_INJ - DDRMIX AXI parity error injection on rdatachk[0] from ddrc */
#define DDR_BLK_CTRL_DDRMIX_AXI_PARITY_ERR_INJECT_RDATACHK_ERR_INJ(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_AXI_PARITY_ERR_INJECT_RDATACHK_ERR_INJ_SHIFT)) & DDR_BLK_CTRL_DDRMIX_AXI_PARITY_ERR_INJECT_RDATACHK_ERR_INJ_MASK)
/*! @} */
...
#define DDR_BLK_CTRL_DDRMIX_DDRPHY_BYPCLK_SRC_SEL_DRAM_PLL_SRC_EN_MASK (0x1U)
#define DDR_BLK_CTRL_DDRMIX_DDRPHY_BYPCLK_SRC_SEL_DRAM_PLL_SRC_EN_SHIFT (0U)
/*! DRAM_PLL_SRC_EN - 1: Use DRAM PLL clk for DDRPHY Bypass clk, 0: Use CCM clk for DDRPHY BYpass clk */
#define DDR_BLK_CTRL_DDRMIX_DDRPHY_BYPCLK_SRC_SEL_DRAM_PLL_SRC_EN(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_DDRPHY_BYPCLK_SRC_SEL_DRAM_PLL_SRC_EN_SHIFT)) & DDR_BLK_CTRL_DDRMIX_DDRPHY_BYPCLK_SRC_SEL_DRAM_PLL_SRC_EN_MASK)
/*! @} */
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SAFETY_MASK (0x2U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SAFETY_SHIFT (1U)
/*! SAFETY - force_on_off for SAFETY group */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SAFETY(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SAFETY_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SAFETY_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SSI_MASK (0x4U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SSI_SHIFT (2U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_DDRPHY_DFI_MASK (0x8U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_DDRPHY_DFI_SHIFT (3U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_MASK (0x10U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_SHIFT (4U)
/*! INFRA - force_on_off for INFRA group */
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_SECURITY_MASK (0x20U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_SECURITY_SHIFT (5U)
/*! INFRA_SECURITY - force_on_off for INFRA_SECURITY group */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_SECURITY(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_SECURITY_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_INFRA_SECURITY_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_LSTCU_MASK (0x40U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_LSTCU_SHIFT (6U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_PllBypClk_MASK (0x80U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_PllBypClk_SHIFT (7U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_DDRPHY_ALT_MASK (0x100U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_DDRPHY_ALT_SHIFT (8U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_cmu_clk_LPCG_MASK (0x200U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_cmu_clk_LPCG_SHIFT (9U)
/*! ipc_alt_root_cmu_clk_LPCG - ipc_alt_root_cmu_clk_LPCG.force_on_off */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_cmu_clk_LPCG(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_cmu_clk_LPCG_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_cmu_clk_LPCG_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_clk_LPCG_MASK (0x400U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_clk_LPCG_SHIFT (10U)
/*! ipc_alt_root_clk_LPCG - ipc_alt_root_clk_LPCG.force_on_off */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_clk_LPCG(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_clk_LPCG_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_alt_root_clk_LPCG_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_root_clk_DDRC_LPCG_MASK (0x800U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_root_clk_DDRC_LPCG_SHIFT (11U)
/*! ipc_apb_root_clk_DDRC_LPCG - ipc_apb_root_clk_DDRC_LPCG.force_on_off */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_root_clk_DDRC_LPCG(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_root_clk_DDRC_LPCG_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_root_clk_DDRC_LPCG_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_ref_clk_MASK (0x1000U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_ref_clk_SHIFT (12U)
/*! ipc_apb_ref_clk - ipc_apb_ref_clk.force_on_off */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_ref_clk(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_ref_clk_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_apb_ref_clk_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_pll_ai_clk_MASK (0x2000U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_pll_ai_clk_SHIFT (13U)
/*! ipc_pll_ai_clk - ipc_pll_ai_clk.force_on_off */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_pll_ai_clk(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_pll_ai_clk_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_ipc_pll_ai_clk_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_RESERVED_MASK (0xFFFFC000U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_RESERVED_SHIFT (14U)
/*! RESERVED - Reserved field */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_RESERVED(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_RESERVED_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_RESERVED_MASK)
/*! @} */
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SAFETY_MASK (0x2U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SAFETY_SHIFT (1U)
/*! SAFETY - force_on_off_sel for SAFETY group */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SAFETY(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SAFETY_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SAFETY_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SSI_MASK (0x4U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_SSI_SHIFT (2U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_DDRPHY_DFI_MASK (0x8U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_DDRPHY_DFI_SHIFT (3U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_MASK (0x10U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_SHIFT (4U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_SECURITY_MASK (0x20U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_SECURITY_SHIFT (5U)
/*! INFRA_SECURITY - force_on_off_sel for INFRA_SECURITY group */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_SECURITY(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_SECURITY_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_INFRA_SECURITY_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_LSTCU_MASK (0x40U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_LSTCU_SHIFT (6U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_PllBypClk_MASK (0x80U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_PllBypClk_SHIFT (7U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_DDRPHY_ALT_MASK (0x100U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_DDRPHY_ALT_SHIFT (8U)
...
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_cmu_clk_LPCG_MASK (0x200U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_cmu_clk_LPCG_SHIFT (9U)
/*! ipc_alt_root_cmu_clk_LPCG - ipc_alt_root_cmu_clk_LPCG.force_on_off_sel */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_cmu_clk_LPCG(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_cmu_clk_LPCG_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_cmu_clk_LPCG_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_clk_LPCG_MASK (0x400U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_clk_LPCG_SHIFT (10U)
/*! ipc_alt_root_clk_LPCG - ipc_alt_root_clk_LPCG.force_on_off_sel */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_clk_LPCG(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_clk_LPCG_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_alt_root_clk_LPCG_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_root_clk_DDRC_LPCG_MASK (0x800U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_root_clk_DDRC_LPCG_SHIFT (11U)
/*! ipc_apb_root_clk_DDRC_LPCG - ipc_apb_root_clk_DDRC_LPCG.force_on_off_sel */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_root_clk_DDRC_LPCG(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_root_clk_DDRC_LPCG_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_root_clk_DDRC_LPCG_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_ref_clk_MASK (0x1000U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_ref_clk_SHIFT (12U)
/*! ipc_apb_ref_clk - ipc_apb_ref_clk.force_on_off_sel */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_ref_clk(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_ref_clk_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_apb_ref_clk_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_pll_ai_clk_MASK (0x2000U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_pll_ai_clk_SHIFT (13U)
/*! ipc_pll_ai_clk - ipc_pll_ai_clk.force_on_off_sel */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_pll_ai_clk(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_pll_ai_clk_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_ipc_pll_ai_clk_MASK)

#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_RESERVED_MASK (0xFFFFC000U)
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_RESERVED_SHIFT (14U)
/*! RESERVED - Reserved field */
#define DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_RESERVED(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_RESERVED_SHIFT)) & DDR_BLK_CTRL_DDRMIX_LPCG_FORCE_ON_OFF_SEL_RESERVED_MASK)
/*! @} */
...
#define DDR_BLK_CTRL_DDRMIX_AUTO_IPG_STOP_ACK_EN_RESERVED_MASK (0xFFFFFFFEU)
#define DDR_BLK_CTRL_DDRMIX_AUTO_IPG_STOP_ACK_EN_RESERVED_SHIFT (1U)
/*! RESERVED - reserved space */
#define DDR_BLK_CTRL_DDRMIX_AUTO_IPG_STOP_ACK_EN_RESERVED(x) (((uint32_t)(((uint32_t)(x)) << DDR_BLK_CTRL_DDRMIX_AUTO_IPG_STOP_ACK_EN_RESERVED_SHIFT)) & DDR_BLK_CTRL_DDRMIX_AUTO_IPG_STOP_ACK_EN_RESERVED_MASK)
/*! @} */
