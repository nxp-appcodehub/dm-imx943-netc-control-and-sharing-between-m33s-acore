...
#define GPC_CPU_CTRL_CMC_IRQ_WAKEUP_MASK_ARRAY_COUNT 15u
#define GPC_CPU_CTRL_CMC_IRQ_WAKEUP_STAT_ARRAY_COUNT 15u
...
typedef struct {
  ...
  __IO uint32_t CMC_IRQ_WAKEUP_MASK[GPC_CPU_CTRL_CMC_IRQ_WAKEUP_MASK_ARRAY_COUNT]; /**< IRQ wake-up mask register, array offset: 0x100, array step: 0x4 */
       uint8_t RESERVED_3[4];
  __IO uint32_t CMC_NON_IRQ_WAKEUP_MASK;           /**< CMC non-IRQ wakeup mask, offset: 0x140 */
       uint8_t RESERVED_4[12];
  __I  uint32_t CMC_IRQ_WAKEUP_STAT[GPC_CPU_CTRL_CMC_IRQ_WAKEUP_STAT_ARRAY_COUNT]; /**< IRQ status register, array offset: 0x150, array step: 0x4 */
