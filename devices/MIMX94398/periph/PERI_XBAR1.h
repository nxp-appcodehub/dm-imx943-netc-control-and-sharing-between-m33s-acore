...
#if !defined(XBAR1_H_)
#define XBAR1_H_                                 /**< Symbol preventing repeated inclusion */
...
#define XBAR1_SEL_COUNT                           256u
#define XBAR1_CTRL_COUNT                          4u

/** XBAR1 - Register Layout Typedef */
typedef struct {
  __IO uint32_t SEL[XBAR1_SEL_COUNT];              /**< Crossbar Select Register, array offset: 0x0, array step: 0x4 */
  __IO uint32_t CTRL[XBAR1_CTRL_COUNT];            /**< Crossbar Control Register, array offset: 0x400, array step: 0x4 */
} XBAR1_Type;
...
#define XBAR1_SEL_SEL_MASK                       (0x1FFU)
