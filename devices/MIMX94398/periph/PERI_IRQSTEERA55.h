...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for IRQSTEERA55
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for IRQSTEERA55
 *
 * CMSIS Peripheral Access Layer for IRQSTEERA55
 */

#if !defined(IRQSTEERA55_H_)
#define IRQSTEERA55_H_                           /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- IRQSTEERA55 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup IRQSTEERA55_Peripheral_Access_Layer IRQSTEERA55 Peripheral Access Layer
 * @{
 */

/** IRQSTEERA55 - Size of Registers Arrays */
#define IRQSTEERA55_CHN_MASK_COUNT                30u
#define IRQSTEERA55_CHN_SET_COUNT                 30u
#define IRQSTEERA55_CHN_STATUS_COUNT              30u

/** IRQSTEERA55 - Register Layout Typedef */
typedef struct {
       uint8_t RESERVED_0[4];
  __IO uint32_t CHN_MASK[IRQSTEERA55_CHN_MASK_COUNT]; /**< Channel n Interrupt Mask, array offset: 0x4, array step: 0x4 */
  __IO uint32_t CHN_SET[IRQSTEERA55_CHN_SET_COUNT]; /**< Channel n Interrupt Set, array offset: 0x7C, array step: 0x4 */
  __I  uint32_t CHN_STATUS[IRQSTEERA55_CHN_STATUS_COUNT]; /**< Channel n Interrupt Status, array offset: 0xF4, array step: 0x4 */
  __IO uint32_t CHN_MINTDIS;                       /**< Channel n Group Interrupt Disable, offset: 0x16C */
  __I  uint32_t CHN_MSTRSTAT;                      /**< Channel n Group Status, offset: 0x170 */
} IRQSTEERA55_Type;

/* ----------------------------------------------------------------------------
   -- IRQSTEERA55 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup IRQSTEERA55_Register_Masks IRQSTEERA55 Register Masks
 * @{
 */
...
#define IRQSTEERA55_CHN_MASK_MASKFLD_MASK        (0xFFFFFFFFU)
#define IRQSTEERA55_CHN_MASK_MASKFLD_SHIFT       (0U)
/*! MASKFLD - Masks */
#define IRQSTEERA55_CHN_MASK_MASKFLD(x)          (((uint32_t)(((uint32_t)(x)) << IRQSTEERA55_CHN_MASK_MASKFLD_SHIFT)) & IRQSTEERA55_CHN_MASK_MASKFLD_MASK)
/*! @} */

/*! @name CHN_SET - Channel n Interrupt Set */
/*! @{ */

#define IRQSTEERA55_CHN_SET_FORCEFLD_MASK        (0xFFFFFFFFU)
#define IRQSTEERA55_CHN_SET_FORCEFLD_SHIFT       (0U)
/*! FORCEFLD - Force Interrupt */
#define IRQSTEERA55_CHN_SET_FORCEFLD(x)          (((uint32_t)(((uint32_t)(x)) << IRQSTEERA55_CHN_SET_FORCEFLD_SHIFT)) & IRQSTEERA55_CHN_SET_FORCEFLD_MASK)
/*! @} */

/*! @name CHN_STATUS - Channel n Interrupt Status */
/*! @{ */

#define IRQSTEERA55_CHN_STATUS_STATUS_MASK       (0xFFFFFFFFU)
#define IRQSTEERA55_CHN_STATUS_STATUS_SHIFT      (0U)
/*! STATUS - Status of an interrupt */
#define IRQSTEERA55_CHN_STATUS_STATUS(x)         (((uint32_t)(((uint32_t)(x)) << IRQSTEERA55_CHN_STATUS_STATUS_SHIFT)) & IRQSTEERA55_CHN_STATUS_STATUS_MASK)
/*! @} */

/*! @name CHN_MINTDIS - Channel n Group Interrupt Disable */
/*! @{ */

#define IRQSTEERA55_CHN_MINTDIS_DISABLE_MASK     (0x7FFFU)
#define IRQSTEERA55_CHN_MINTDIS_DISABLE_SHIFT    (0U)
/*! DISABLE - Interrupt Disable
 *  0b000000000000000..Enable interrupts
 *  0b000000000000001..Disable interrupts
 */
#define IRQSTEERA55_CHN_MINTDIS_DISABLE(x)       (((uint32_t)(((uint32_t)(x)) << IRQSTEERA55_CHN_MINTDIS_DISABLE_SHIFT)) & IRQSTEERA55_CHN_MINTDIS_DISABLE_MASK)
/*! @} */

/*! @name CHN_MSTRSTAT - Channel n Group Status */
/*! @{ */

#define IRQSTEERA55_CHN_MSTRSTAT_STATUS_MASK     (0x1U)
#define IRQSTEERA55_CHN_MSTRSTAT_STATUS_SHIFT    (0U)
/*! STATUS - Group Interrupt Status
 *  0b0..No interrupts are asserted.
 *  0b1..At least one interrupt is asserted.
 */
#define IRQSTEERA55_CHN_MSTRSTAT_STATUS(x)       (((uint32_t)(((uint32_t)(x)) << IRQSTEERA55_CHN_MSTRSTAT_STATUS_SHIFT)) & IRQSTEERA55_CHN_MSTRSTAT_STATUS_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group IRQSTEERA55_Register_Masks */


/*!
 * @}
 */ /* end of group IRQSTEERA55_Peripheral_Access_Layer */
