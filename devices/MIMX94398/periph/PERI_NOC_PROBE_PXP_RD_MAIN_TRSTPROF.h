...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_Probe_PXP_rd_main_TrStProf
**
...
/*!
 * @file NOC_Probe_PXP_rd_main_TrStProf.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_Probe_PXP_rd_main_TrStProf
 *
 * CMSIS Peripheral Access Layer for NOC_Probe_PXP_rd_main_TrStProf
 */

#if !defined(NOC_Probe_PXP_rd_main_TrStProf_H_)
#define NOC_Probe_PXP_rd_main_TrStProf_H_        /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_Probe_PXP_rd_main_TrStProf Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_Probe_PXP_rd_main_TrStProf_Peripheral_Access_Layer NOC_Probe_PXP_rd_main_TrStProf Peripheral Access Layer
 * @{
 */

/** NOC_Probe_PXP_rd_main_TrStProf - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0; /**< offset: 0x2C */
  __IO uint32_t PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1; /**< offset: 0x30 */
  __IO uint32_t PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2; /**< offset: 0x34 */
  __IO uint32_t PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3; /**< offset: 0x38 */
...
} NOC_Probe_PXP_rd_main_TrStProf_Type;

/* ----------------------------------------------------------------------------
   -- NOC_Probe_PXP_rd_main_TrStProf Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_Probe_PXP_rd_main_TrStProf_Register_Masks NOC_Probe_PXP_rd_main_TrStProf Register Masks
 * @{
 */
...
#define NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORETYPEID_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORETYPEID_MASK)

#define NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_USERID_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_USERID_MASK)

#define NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_NOCID_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name EN - Enable */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_EN_EN_MASK (0x1U)
#define NOC_Probe_PXP_rd_main_TrStProf_EN_EN_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_EN_EN(x)  (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_EN_EN_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_EN_EN_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_MODE_MODE_MASK (0x1U)
#define NOC_Probe_PXP_rd_main_TrStProf_MODE_MODE_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_MODE_MODE_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_MODE_MODE_MASK)
/*! @} */

/*! @name PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0 -  */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_MASK (0x7FFU)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_MASK)
/*! @} */

/*! @name PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1 -  */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_MASK (0x7FFU)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_MASK)
/*! @} */

/*! @name PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2 -  */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_MASK (0x7FFU)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_MASK)
/*! @} */

/*! @name PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3 -  */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_MASK (0x7FFU)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_PROBE_PXP_RD_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_MASK)
/*! @} */

/*! @name OVERFLOWSTATUS - Overflow Status */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK (0x1U)
#define NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWSTATUS_OVERFLOWSTATUS(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK)
/*! @} */

/*! @name OVERFLOWRESET - Overflow Reset */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWRESET_OVERFLOWRESET_MASK (0x1U)
#define NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWRESET_OVERFLOWRESET_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWRESET_OVERFLOWRESET(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWRESET_OVERFLOWRESET_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_OVERFLOWRESET_OVERFLOWRESET_MASK)
/*! @} */

/*! @name PENDINGEVENTMODE - Pending Event Mode */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK (0x1U)
#define NOC_Probe_PXP_rd_main_TrStProf_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_PENDINGEVENTMODE_PENDINGEVENTMODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK)
/*! @} */

/*! @name PRESCALER - Pre Scaler */
/*! @{ */

#define NOC_Probe_PXP_rd_main_TrStProf_PRESCALER_PRESCALER_MASK (0xFFU)
#define NOC_Probe_PXP_rd_main_TrStProf_PRESCALER_PRESCALER_SHIFT (0U)
#define NOC_Probe_PXP_rd_main_TrStProf_PRESCALER_PRESCALER(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_PXP_rd_main_TrStProf_PRESCALER_PRESCALER_SHIFT)) & NOC_Probe_PXP_rd_main_TrStProf_PRESCALER_PRESCALER_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_Probe_PXP_rd_main_TrStProf_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_Probe_PXP_rd_main_TrStProf_Peripheral_Access_Layer */
...
#endif  /* NOC_Probe_PXP_rd_main_TrStProf_H_ */
