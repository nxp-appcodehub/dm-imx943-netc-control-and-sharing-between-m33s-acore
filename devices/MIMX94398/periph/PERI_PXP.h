...
typedef struct {
  ...
  __IO uint32_t INPUT_STORE_D_SHIFT_H_CH0;         /**< Input Store Data Shift High Channel 0 Register, offset: 0x800 */
       uint8_t RESERVED_89[9436];
  __IO uint32_t BUS_MUX;                           /**< Bus MUX Register, offset: 0x2CE0 */
       uint8_t RESERVED_90[796];
  __IO uint32_t PS_LRC;                            /**< Processed Surface Lower Right Coordinate Register, offset: 0x3000 */
       uint8_t RESERVED_91[12];
  __IO uint32_t AS_BACKGROUND;                     /**< AS Background Color Register, offset: 0x3010 */
} PXP_Type;
...
#define PXP_CTRL_BLOCK_32_MASK                   (0x400000U)
#define PXP_CTRL_BLOCK_32_SHIFT                  (22U)
/*! BLOCK_32 - BLOCK_32
 *  0b0..Block size is determined by CTRL[BLOCK_SIZE] value
 *  0b1..BLK_SIZE_32x32 : Process 32x32 pixel blocks. CTRL[BLOCK_SIZE] should be 0 in this mode.
 */
#define PXP_CTRL_BLOCK_32(x)                     (((uint32_t)(((uint32_t)(x)) << PXP_CTRL_BLOCK_32_SHIFT)) & PXP_CTRL_BLOCK_32_MASK)
...
/*! FORMAT - FORMAT
 *  0b00000..ARGB8888 : 32-bit RGB format with blue in LSB
 *  0b00001..RGBA8888 : 32-bit RGB format with alpha in LSB
 *  0b00010..ABGR8888 : 32-bit BGR format with red in LSB
 *  0b00011..BGRA8888 : 32-bit BGR format with alpha in LSB
 *  0b00100..RGB888 : 32-bit RGB format with blue in LSB (unpacked 24-bit pixel in 32 bit DWORD)
 *  0b00101..RGB888P : 24-bit RGB format with blue in LSB (packed 24-bit format)
 *  0b00110..BGR888 : 32-bit BGR format with red in LSB (unpacked 24-bit pixel in 32 bit DWORD)
 *  0b00111..BGR888P : 24-bit BGR format with red in LSB (packed 24-bit format)
 *  0b01000..ARGB1555 : 16-bit RGB format with blue in LSB
 *  0b01001..ARGB4444 : 16-bit RGB format with blue in LSB
 *  0b01100..RGB555 : 16-bit RGB format with blue in LSB
 *  0b01101..RGB444 : 16-bit RGB format with blue in LSB
 *  0b01110..RGB565 : 16-bit RGB format with blue in LSB
 *  0b01111..RGB3P888 : 24-bit RGB format (3-plane RGB)
...
/*! FORMAT - FORMAT
 *  0b000000..ARGB8888 : 32-bit RGB format with blue in LSB
 *  0b000001..RGBA8888 : 32-bit RGB format with alpha in LSB
 *  0b000010..ABGR8888 : 32-bit BGR format with red in LSB
 *  0b000011..BGRA8888 : 32-bit BGR format with alpha in LSB
 *  0b000100..RGB888 : 32-bit RGB format with blue in LSB (unpacked 24-bit pixel in 32 bit DWORD)
 *  0b000101..RGB888P : 24-bit RGB format with blue in LSB (packed 24-bit format)
 *  0b000110..BGR888 : 32-bit BGR format with red in LSB (unpacked 24-bit pixel in 32 bit DWORD)
 *  0b000111..BGR888P : 24-bit BGR format with red in LSB (packed 24-bit format)
 *  0b001000..ARGB1555 : 16-bit RGB format with blue in LSB
 *  0b001001..ARGB4444 : 16-bit RGB format with blue in LSB
 *  0b001100..RGB555 : 16-bit RGB format with blue in LSB
 *  0b001101..RGB444 : 16-bit RGB format with blue in LSB
 *  0b001110..RGB565 : 16-bit RGB format with blue in LSB
...
#define PXP_PS_BACKGROUND_0_COLOR_MASK           (0xFFFFFFFFU)
...
/*! FORMAT - FORMAT
 *  0b0000..ARGB8888 : 32-bit RGB format with blue in LSB
 *  0b0001..RGBA8888 : 32-bit RGB format with alpha in LSB
 *  0b0010..ABGR8888 : 32-bit BGR format with red in LSB
 *  0b0011..BGRA8888 : 32-bit BGR format with alpha in LSB
 *  0b0100..RGB888 : 32-bit RGB format with blue in LSB (unpacked 24-bit pixel in 32 bit DWORD)
 *  0b0101..RGB888P : 24-bit RGB format with blue in LSB (packed 24-bit format)
 *  0b0110..BGR888 : 32-bit BGR format with red in LSB (unpacked 24-bit pixel in 32 bit DWORD)
 *  0b0111..BGR888P : 24-bit BGR format with red in LSB (packed 24-bit format)
 *  0b1000..ARGB1555 : 16-bit RGB format with blue in LSB
 *  0b1001..ARGB4444 : 16-bit RGB format with blue in LSB
 *  0b1100..RGB555 : 16-bit RGB format with blue in LSB
 *  0b1101..RGB444 : 16-bit RGB format with blue in LSB
 *  0b1110..RGB565 : 16-bit RGB format with blue in LSB
 */
...
/*! ROP - ROP
 *  0b0000..MASKAS : S1 AND S0
 *  0b0001..MASKNOTAS : nS1 AND S0
 *  0b0010..MASKASNOT : S1 AND nS0
 *  0b0011..MERGEAS : S1 OR S0
 *  0b0100..MERGENOTAS : nS1 OR S0
 *  0b0101..MERGEASNOT : S1 OR nS0
 *  0b0110..NOTCOPYAS : nS1
 *  0b0111..NOT : nS0
 *  0b1000..NOTMASKAS : S1 NAND S0
 *  0b1001..NOTMERGEAS : S1 NOR S0
 *  0b1010..XORAS : S1 XOR S0
 *  0b1011..NOTXORAS : S1 XNOR S0
 */
...
#define PXP_PS_BACKGROUND_1_COLOR_MASK           (0xFFFFFFFFU)
...
#define PXP_CTRL2_BLOCK_32_MASK                  (0x400000U)
#define PXP_CTRL2_BLOCK_32_SHIFT                 (22U)
/*! BLOCK_32 - BLOCK_32
 *  0b0..Block size is determined by CTRL2[BLOCK_SIZE] value
 *  0b1..BLK_SIZE_32x32 : Block size is 32x32
 */
#define PXP_CTRL2_BLOCK_32(x)                    (((uint32_t)(((uint32_t)(x)) << PXP_CTRL2_BLOCK_32_SHIFT)) & PXP_CTRL2_BLOCK_32_MASK)
...
/*! @name OUT_BUF3 - Output Frame Buffer Pointer #3 Register */
/*! @{ */

#define PXP_OUT_BUF3_ADDR_MASK                   (0xFFFFFFFFU)
#define PXP_OUT_BUF3_ADDR_SHIFT                  (0U)
/*! ADDR - ADDR */
#define PXP_OUT_BUF3_ADDR(x)                     (((uint32_t)(((uint32_t)(x)) << PXP_OUT_BUF3_ADDR_SHIFT)) & PXP_OUT_BUF3_ADDR_MASK)
/*! @} */
...
#define PXP_INPUT_FETCH_CTRL_CH0_BLOCK_32_MASK   (0x40U)
#define PXP_INPUT_FETCH_CTRL_CH0_BLOCK_32_SHIFT  (6U)
/*! BLOCK_32 - BLOCK_32
 *  0b0..Block size is determined by INPUT_FETCH_CTRL_CH0[BLOCK_16] value
 *  0b1..BLK_SIZE_32x32 : Block size is 32x32
 */
#define PXP_INPUT_FETCH_CTRL_CH0_BLOCK_32(x)     (((uint32_t)(((uint32_t)(x)) << PXP_INPUT_FETCH_CTRL_CH0_BLOCK_32_SHIFT)) & PXP_INPUT_FETCH_CTRL_CH0_BLOCK_32_MASK)
...
#define PXP_INPUT_FETCH_CTRL_CH0_RD_NUM_BYTES_MASK (0x70000U)
#define PXP_INPUT_FETCH_CTRL_CH0_RD_NUM_BYTES_SHIFT (16U)
/*! RD_NUM_BYTES - RD_NUM_BYTES
 *  0b000..NUM_8_BYTES : 8 bytes
 *  0b001..NUM_16_BYTES : 16 bytes
 *  0b010..NUM_32_BYTES : 32 bytes
 *  0b011..NUM_64_BYTES : 64 bytes
 *  0b100..NUM_128_BYTES : 128 bytes
 *  0b101..reserved
 *  0b110..reserved
 *  0b111..reserved
 */
...
#define PXP_INPUT_FETCH_CTRL_CH1_BLOCK_32_MASK   (0x40U)
#define PXP_INPUT_FETCH_CTRL_CH1_BLOCK_32_SHIFT  (6U)
/*! BLOCK_32 - BLOCK_32
 *  0b0..Block size is determined by INPUT_FETCH_CTRL_CH1[BLOCK_16] value
 *  0b1..BLK_SIZE_32x32 : Block size is 32x32
 */
#define PXP_INPUT_FETCH_CTRL_CH1_BLOCK_32(x)     (((uint32_t)(((uint32_t)(x)) << PXP_INPUT_FETCH_CTRL_CH1_BLOCK_32_SHIFT)) & PXP_INPUT_FETCH_CTRL_CH1_BLOCK_32_MASK)
...
#define PXP_INPUT_FETCH_CTRL_CH1_RD_NUM_BYTES_MASK (0x70000U)
...
#define PXP_INPUT_STORE_CTRL_CH0_BLOCK_32_MASK   (0x1000U)
#define PXP_INPUT_STORE_CTRL_CH0_BLOCK_32_SHIFT  (12U)
/*! BLOCK_32 - BLOCK_32
 *  0b0..Block size is determined by INPUT_STORE_CTRL_CH0[BLOCK_16] value
 *  0b1..BLK_SIZE_32x32 : Block size is 32x32
 */
#define PXP_INPUT_STORE_CTRL_CH0_BLOCK_32(x)     (((uint32_t)(((uint32_t)(x)) << PXP_INPUT_STORE_CTRL_CH0_BLOCK_32_SHIFT)) & PXP_INPUT_STORE_CTRL_CH0_BLOCK_32_MASK)

#define PXP_INPUT_STORE_CTRL_CH0_WR_NUM_BYTES_MASK (0x70000U)
...
#define PXP_INPUT_STORE_CTRL_CH1_BLOCK_32_MASK   (0x1000U)
#define PXP_INPUT_STORE_CTRL_CH1_BLOCK_32_SHIFT  (12U)
/*! BLOCK_32 - BLOCK_32
 *  0b0..Block size is determined by INPUT_STORE_CTRL_CH1[BLOCK_16] value
 *  0b1..BLK_SIZE_32x32 : Block size is 32x32
 */
#define PXP_INPUT_STORE_CTRL_CH1_BLOCK_32(x)     (((uint32_t)(((uint32_t)(x)) << PXP_INPUT_STORE_CTRL_CH1_BLOCK_32_SHIFT)) & PXP_INPUT_STORE_CTRL_CH1_BLOCK_32_MASK)

#define PXP_INPUT_STORE_CTRL_CH1_WR_NUM_BYTES_MASK (0x70000U)
 ...
 *  0b0..YUYV422 1 plane disabled.
 *  0b1..YUYV422 1 plane enabled.
 */
...
/*! @name PS_LRC - Processed Surface Lower Right Coordinate Register */
/*! @{ */

#define PXP_PS_LRC_Y_MASK                        (0x3FFFU)
#define PXP_PS_LRC_Y_SHIFT                       (0U)
/*! Y - Y */
#define PXP_PS_LRC_Y(x)                          (((uint32_t)(((uint32_t)(x)) << PXP_PS_LRC_Y_SHIFT)) & PXP_PS_LRC_Y_MASK)

#define PXP_PS_LRC_X_MASK                        (0x3FFF0000U)
#define PXP_PS_LRC_X_SHIFT                       (16U)
/*! X - X */
#define PXP_PS_LRC_X(x)                          (((uint32_t)(((uint32_t)(x)) << PXP_PS_LRC_X_SHIFT)) & PXP_PS_LRC_X_MASK)
/*! @} */

/*! @name AS_BACKGROUND - AS Background Color Register */
/*! @{ */

#define PXP_AS_BACKGROUND_COLOR_MASK             (0xFFFFFFFFU)
#define PXP_AS_BACKGROUND_COLOR_SHIFT            (0U)
/*! COLOR - COLOR */
#define PXP_AS_BACKGROUND_COLOR(x)               (((uint32_t)(((uint32_t)(x)) << PXP_AS_BACKGROUND_COLOR_SHIFT)) & PXP_AS_BACKGROUND_COLOR_MASK)
/*! @} */
