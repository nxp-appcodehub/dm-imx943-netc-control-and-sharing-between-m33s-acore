...
#if !defined(NETC_ENETC_H_)
#define NETC_ENETC_H_                            /**< Symbol preventing repeated inclusion */
...
#define NETC_ENETC_NUM_SI_COUNT                   4u
...
typedef struct {
  ...
  __I  uint32_t PRSSCAPR;                          /**< Port RSS capability register, offset: 0x240 */
  __IO uint32_t PRSSCR;                            /**< Port RSS Control Register, offset: 0x244 */
       uint8_t RESERVED_8[8];
  __IO uint32_t PRSSKR0;                           /**< Port RSS key register 0, offset: 0x250 */
  __IO uint32_t PRSSKR1;                           /**< Port RSS key register 1, offset: 0x254 */
  __IO uint32_t PRSSKR2;                           /**< Port RSS key register 2, offset: 0x258 */
  __IO uint32_t PRSSKR3;                           /**< Port RSS key register 3, offset: 0x25C */
  __IO uint32_t PRSSKR4;                           /**< Port RSS key register 4, offset: 0x260 */
  __IO uint32_t PRSSKR5;                           /**< Port RSS key register 5, offset: 0x264 */
  __IO uint32_t PRSSKR6;                           /**< Port RSS key register 6, offset: 0x268 */
  __IO uint32_t PRSSKR7;                           /**< Port RSS key register 7, offset: 0x26C */
  __IO uint32_t PRSSKR8;                           /**< Port RSS key register 8, offset: 0x270 */
  __IO uint32_t PRSSKR9;                           /**< Port RSS key register 9, offset: 0x274 */
  ...
  __IO uint32_t PLPMR;                             /**< Port low power mode register, offset: 0x340, not available in all instances (available on 72 out of 96) */
  __I  uint32_t PWOSR;                             /**< Port wake-on status register, offset: 0x344, not available in all instances (available on 72 out of 96) */
  ...
  __IO uint32_t PTCTSDR[NETC_ENETC_TC_TBS_NUM_COUNT]; /**< Port traffic class a time specific departure register, array offset: 0x390, array step: 0x4 */
       uint8_t RESERVED_19[1104];
  __I  uint32_t SMCAPR;                            /**< Switch management capability register, offset: 0x800 */
       uint8_t RESERVED_20[124];
  __IO uint32_t SMHRBDRMR[NETC_ENETC_NUM_SMHRBDRMR_COUNT]; /**< Switch management host reason 1 receive BD ring mapping register..Switch management host reason 15 receive BD ring mapping register, array offset: 0x880, array step: 0x4, not available in all instances (available on 24 out of 96) */
       uint8_t RESERVED_21[5956];
  struct {                                         /* offset: 0x2000, array step: 0x80 */
    __IO uint32_t PSIPMAR0;                          /**< Port station interface 0 primary MAC address register 0..Port station interface 3 primary MAC address register 0, array offset: 0x2000, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIPMAR1;                          /**< Port station interface 0 primary MAC address register 1..Port station interface 3 primary MAC address register 1, array offset: 0x2004, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIVLANR;                          /**< Port station interface 0 VLAN register..Port station interface 3 VLAN register, array offset: 0x2008, array step: 0x80, irregular array, not all indices are valid */
         uint8_t RESERVED_0[4];
    __IO uint32_t PSICFGR0;                          /**< Port station interface 0 configuration register 0..Port station interface 3 configuration register 0, array offset: 0x2010, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSICFGR1;                          /**< Port station interface 1 configuration register 1..Port station interface 3 configuration register 1, array offset: 0x2014, array step: 0x80, not available in all instances (available on 24 out of 96), valid indices: [1-3] */
    __IO uint32_t PSICFGR2;                          /**< Port station interface 0 configuration register 2..Port station interface 3 configuration register 2, array offset: 0x2018, array step: 0x80, irregular array, not all indices are valid */
         uint8_t RESERVED_1[20];
    __IO uint32_t PSIVMAFCFGR;                       /**< Port station interface 0 VSI MAC address filtering configuration register..Port station interface 3 VSI MAC address filtering configuration register, array offset: 0x2030, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIVLANFCFGR;                      /**< Port station interface 0 VLAN filtering configuration register..Port station interface 3 VLAN filtering configuration register, array offset: 0x2034, array step: 0x80, irregular array, not all indices are valid */
         uint8_t RESERVED_2[8];
    __I  uint32_t PSIRFSCFGR;                        /**< Port station interface 0 RFS configuration register..Port station interface 3 RFS configuration register, array offset: 0x2040, array step: 0x80, irregular array, not all indices are valid */
         uint8_t RESERVED_3[12];
    __IO uint32_t PSIUMHFR0;                         /**< Port station interface 0 unicast MAC hash filter register 0..Port station interface 3 unicast MAC hash filter register 0, array offset: 0x2050, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIUMHFR1;                         /**< Port station interface 0 unicast MAC hash filter register 1..Port station interface 3 unicast MAC hash filter register 1, array offset: 0x2054, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIMMHFR0;                         /**< Port station interface 0 multicast MAC hash filter register 0..Port station interface 3 multicast MAC hash filter register 0, array offset: 0x2058, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIMMHFR1;                         /**< Port station interface 0 multicast MAC hash filter register 1..Port station interface 3 multicast MAC hash filter register 1, array offset: 0x205C, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIVHFR0;                          /**< Port station interface 0 VLAN hash filter register 0..Port station interface 3 VLAN hash filter register 0, array offset: 0x2060, array step: 0x80, irregular array, not all indices are valid */
    __IO uint32_t PSIVHFR1;                          /**< Port station interface 0 VLAN hash filter register 1..Port station interface 3 VLAN hash filter register 1, array offset: 0x2064, array step: 0x80, irregular array, not all indices are valid */
...
#define NETC_ENETC_ECAPR0_ET_MASK                (0x10U)
#define NETC_ENETC_ECAPR0_ET_SHIFT               (4U)
#define NETC_ENETC_ECAPR0_ET(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_ECAPR0_ET_SHIFT)) & NETC_ENETC_ECAPR0_ET_MASK)
...
#define NETC_ENETC_ECAPR0_RSC_MASK               (0x200U)
#define NETC_ENETC_ECAPR0_RSC_SHIFT              (9U)
#define NETC_ENETC_ECAPR0_RSC(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_ECAPR0_RSC_SHIFT)) & NETC_ENETC_ECAPR0_RSC_MASK)

#define NETC_ENETC_ECAPR0_LSO_MASK               (0x400U)
#define NETC_ENETC_ECAPR0_LSO_SHIFT              (10U)
#define NETC_ENETC_ECAPR0_LSO(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_ECAPR0_LSO_SHIFT)) & NETC_ENETC_ECAPR0_LSO_MASK)
...
#define NETC_ENETC_ECAPR0_FCSU_MASK              (0x100000U)
#define NETC_ENETC_ECAPR0_FCSU_SHIFT             (20U)
/*! FCSU - FCS update capability supported. */
#define NETC_ENETC_ECAPR0_FCSU(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_ECAPR0_FCSU_SHIFT)) & NETC_ENETC_ECAPR0_FCSU_MASK)
/*! @} */
...
#define NETC_ENETC_PMR_SI2EN_MASK                (0x40000U)
#define NETC_ENETC_PMR_SI2EN_SHIFT               (18U)
#define NETC_ENETC_PMR_SI2EN(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PMR_SI2EN_SHIFT)) & NETC_ENETC_PMR_SI2EN_MASK)

#define NETC_ENETC_PMR_SI3EN_MASK                (0x80000U)
#define NETC_ENETC_PMR_SI3EN_SHIFT               (19U)
#define NETC_ENETC_PMR_SI3EN(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PMR_SI3EN_SHIFT)) & NETC_ENETC_PMR_SI3EN_MASK)
/*! @} */
...
/*! L4CD - Layer 4 TCP and UDP checksum validation Disable.
 *  0b0..Enabled
 *  0b1..Disabled
 */
...
/*! L3CD - Layer 3 IPv4 Header checksum validation Disable.
 *  0b0..Enabled
 *  0b1..Disabled
 */
...
#define NETC_ENETC_PSIPMMR_SI2_MAC_UP_MASK       (0x4U)
#define NETC_ENETC_PSIPMMR_SI2_MAC_UP_SHIFT      (2U)
#define NETC_ENETC_PSIPMMR_SI2_MAC_UP(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPMMR_SI2_MAC_UP_SHIFT)) & NETC_ENETC_PSIPMMR_SI2_MAC_UP_MASK)

#define NETC_ENETC_PSIPMMR_SI3_MAC_UP_MASK       (0x8U)
#define NETC_ENETC_PSIPMMR_SI3_MAC_UP_SHIFT      (3U)
#define NETC_ENETC_PSIPMMR_SI3_MAC_UP(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPMMR_SI3_MAC_UP_SHIFT)) & NETC_ENETC_PSIPMMR_SI3_MAC_UP_MASK)
...
#define NETC_ENETC_PSIPMMR_SI2_MAC_MP_MASK       (0x40000U)
#define NETC_ENETC_PSIPMMR_SI2_MAC_MP_SHIFT      (18U)
#define NETC_ENETC_PSIPMMR_SI2_MAC_MP(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPMMR_SI2_MAC_MP_SHIFT)) & NETC_ENETC_PSIPMMR_SI2_MAC_MP_MASK)

#define NETC_ENETC_PSIPMMR_SI3_MAC_MP_MASK       (0x80000U)
#define NETC_ENETC_PSIPMMR_SI3_MAC_MP_SHIFT      (19U)
#define NETC_ENETC_PSIPMMR_SI3_MAC_MP(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPMMR_SI3_MAC_MP_SHIFT)) & NETC_ENETC_PSIPMMR_SI3_MAC_MP_MASK)
/*! @} */
...
#define NETC_ENETC_PSIPVMR_SI2_VLAN_P_MASK       (0x4U)
#define NETC_ENETC_PSIPVMR_SI2_VLAN_P_SHIFT      (2U)
#define NETC_ENETC_PSIPVMR_SI2_VLAN_P(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPVMR_SI2_VLAN_P_SHIFT)) & NETC_ENETC_PSIPVMR_SI2_VLAN_P_MASK)

#define NETC_ENETC_PSIPVMR_SI3_VLAN_P_MASK       (0x8U)
#define NETC_ENETC_PSIPVMR_SI3_VLAN_P_SHIFT      (3U)
#define NETC_ENETC_PSIPVMR_SI3_VLAN_P(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPVMR_SI3_VLAN_P_SHIFT)) & NETC_ENETC_PSIPVMR_SI3_VLAN_P_MASK)
...
#define NETC_ENETC_PSIPVMR_SI2_VLAN_UTA_MASK     (0x40000U)
#define NETC_ENETC_PSIPVMR_SI2_VLAN_UTA_SHIFT    (18U)
#define NETC_ENETC_PSIPVMR_SI2_VLAN_UTA(x)       (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPVMR_SI2_VLAN_UTA_SHIFT)) & NETC_ENETC_PSIPVMR_SI2_VLAN_UTA_MASK)

#define NETC_ENETC_PSIPVMR_SI3_VLAN_UTA_MASK     (0x80000U)
#define NETC_ENETC_PSIPVMR_SI3_VLAN_UTA_SHIFT    (19U)
#define NETC_ENETC_PSIPVMR_SI3_VLAN_UTA(x)       (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIPVMR_SI3_VLAN_UTA_SHIFT)) & NETC_ENETC_PSIPVMR_SI3_VLAN_UTA_MASK)
/*! @} */
...
/*! @name PRSSCAPR - Port RSS capability register */
/*! @{ */

#define NETC_ENETC_PRSSCAPR_NUM_RSS_MASK         (0xFU)
#define NETC_ENETC_PRSSCAPR_NUM_RSS_SHIFT        (0U)
#define NETC_ENETC_PRSSCAPR_NUM_RSS(x)           (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCAPR_NUM_RSS_SHIFT)) & NETC_ENETC_PRSSCAPR_NUM_RSS_MASK)
/*! @} */

/*! @name PRSSCR - Port RSS Control Register */
/*! @{ */

#define NETC_ENETC_PRSSCR_IP4TCP_DIS_MASK        (0x1U)
#define NETC_ENETC_PRSSCR_IP4TCP_DIS_SHIFT       (0U)
/*! IP4TCP_DIS - IPv4 with TCP packet disable. */
#define NETC_ENETC_PRSSCR_IP4TCP_DIS(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCR_IP4TCP_DIS_SHIFT)) & NETC_ENETC_PRSSCR_IP4TCP_DIS_MASK)

#define NETC_ENETC_PRSSCR_IP4_DIS_MASK           (0x2U)
#define NETC_ENETC_PRSSCR_IP4_DIS_SHIFT          (1U)
/*! IP4_DIS - IPv4 packet disable. */
#define NETC_ENETC_PRSSCR_IP4_DIS(x)             (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCR_IP4_DIS_SHIFT)) & NETC_ENETC_PRSSCR_IP4_DIS_MASK)

#define NETC_ENETC_PRSSCR_IP6TCP_DIS_MASK        (0x4U)
#define NETC_ENETC_PRSSCR_IP6TCP_DIS_SHIFT       (2U)
/*! IP6TCP_DIS - IPv6 with TCP packet disable. */
#define NETC_ENETC_PRSSCR_IP6TCP_DIS(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCR_IP6TCP_DIS_SHIFT)) & NETC_ENETC_PRSSCR_IP6TCP_DIS_MASK)

#define NETC_ENETC_PRSSCR_IP4UDP_DIS_MASK        (0x8U)
#define NETC_ENETC_PRSSCR_IP4UDP_DIS_SHIFT       (3U)
/*! IP4UDP_DIS - IPv4 with UDP disable. */
#define NETC_ENETC_PRSSCR_IP4UDP_DIS(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCR_IP4UDP_DIS_SHIFT)) & NETC_ENETC_PRSSCR_IP4UDP_DIS_MASK)

#define NETC_ENETC_PRSSCR_IP6UDP_DIS_MASK        (0x10U)
#define NETC_ENETC_PRSSCR_IP6UDP_DIS_SHIFT       (4U)
/*! IP6UDP_DIS - IPv6 with UDP disable. */
#define NETC_ENETC_PRSSCR_IP6UDP_DIS(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCR_IP6UDP_DIS_SHIFT)) & NETC_ENETC_PRSSCR_IP6UDP_DIS_MASK)

#define NETC_ENETC_PRSSCR_IP6_DIS_MASK           (0x20U)
#define NETC_ENETC_PRSSCR_IP6_DIS_SHIFT          (5U)
/*! IP6_DIS - IPv6 packet disable. */
#define NETC_ENETC_PRSSCR_IP6_DIS(x)             (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSCR_IP6_DIS_SHIFT)) & NETC_ENETC_PRSSCR_IP6_DIS_MASK)
/*! @} */

/*! @name PRSSKR0 - Port RSS key register 0 */
/*! @{ */

#define NETC_ENETC_PRSSKR0_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR0_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR0_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR0_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR0_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR1 - Port RSS key register 1 */
/*! @{ */

#define NETC_ENETC_PRSSKR1_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR1_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR1_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR1_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR1_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR2 - Port RSS key register 2 */
/*! @{ */

#define NETC_ENETC_PRSSKR2_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR2_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR2_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR2_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR2_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR3 - Port RSS key register 3 */
/*! @{ */

#define NETC_ENETC_PRSSKR3_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR3_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR3_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR3_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR3_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR4 - Port RSS key register 4 */
/*! @{ */

#define NETC_ENETC_PRSSKR4_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR4_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR4_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR4_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR4_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR5 - Port RSS key register 5 */
/*! @{ */

#define NETC_ENETC_PRSSKR5_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR5_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR5_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR5_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR5_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR6 - Port RSS key register 6 */
/*! @{ */

#define NETC_ENETC_PRSSKR6_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR6_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR6_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR6_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR6_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR7 - Port RSS key register 7 */
/*! @{ */

#define NETC_ENETC_PRSSKR7_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR7_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR7_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR7_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR7_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR8 - Port RSS key register 8 */
/*! @{ */

#define NETC_ENETC_PRSSKR8_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR8_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR8_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR8_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR8_RSS_KEY_MASK)
/*! @} */

/*! @name PRSSKR9 - Port RSS key register 9 */
/*! @{ */

#define NETC_ENETC_PRSSKR9_RSS_KEY_MASK          (0xFFFFFFFFU)
#define NETC_ENETC_PRSSKR9_RSS_KEY_SHIFT         (0U)
#define NETC_ENETC_PRSSKR9_RSS_KEY(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRSSKR9_RSS_KEY_SHIFT)) & NETC_ENETC_PRSSKR9_RSS_KEY_MASK)
/*! @} */
...
#define NETC_ENETC_PRFSCAPR_NUM_RFS_MASK         (0xFFU)
#define NETC_ENETC_PRFSCAPR_NUM_RFS_SHIFT        (0U)
#define NETC_ENETC_PRFSCAPR_NUM_RFS(x)           (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRFSCAPR_NUM_RFS_SHIFT)) & NETC_ENETC_PRFSCAPR_NUM_RFS_MASK)
/*! @} */

/*! @name PRFSMR - Port RFS mode register */
/*! @{ */

#define NETC_ENETC_PRFSMR_RFSE_MASK              (0x80000000U)
#define NETC_ENETC_PRFSMR_RFSE_SHIFT             (31U)
#define NETC_ENETC_PRFSMR_RFSE(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PRFSMR_RFSE_SHIFT)) & NETC_ENETC_PRFSMR_RFSE_MASK)
/*! @} */
...
#define NETC_ENETC_TGSLR_MIN_LOOKAHEAD_MASK      (0xFFFFFU)
#define NETC_ENETC_TGSLR_MIN_LOOKAHEAD_SHIFT     (0U)
#define NETC_ENETC_TGSLR_MIN_LOOKAHEAD(x)        (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_TGSLR_MIN_LOOKAHEAD_SHIFT)) & NETC_ENETC_TGSLR_MIN_LOOKAHEAD_MASK)
/*! @} */
...
/*! TSDE - Time Specific Departure Enable
 *  0b0..Disabled
 *  0b1..Enabled
 */
...
#define NETC_ENETC_SMHRBDRMR_EN_MASK             (0x80000000U)
#define NETC_ENETC_SMHRBDRMR_EN_SHIFT            (31U)
#define NETC_ENETC_SMHRBDRMR_EN(x)               (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_SMHRBDRMR_EN_SHIFT)) & NETC_ENETC_SMHRBDRMR_EN_MASK)
/*! @} */

/* The count of NETC_ENETC_SMHRBDRMR */
#define NETC_ENETC_SMHRBDRMR_COUNT               (15U)

/*! @name PSIPMAR0 - Port station interface 0 primary MAC address register 0..Port station interface 3 primary MAC address register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIPMAR0_COUNT                (4U)

/*! @name PSIPMAR1 - Port station interface 0 primary MAC address register 1..Port station interface 3 primary MAC address register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIPMAR1_COUNT                (4U)

/*! @name PSIVLANR - Port station interface 0 VLAN register..Port station interface 3 VLAN register */
/*! @{ */
...
#define NETC_ENETC_PSIVLANR_TXTAGR_MASK          (0xF00000U)
#define NETC_ENETC_PSIVLANR_TXTAGR_SHIFT         (20U)
#define NETC_ENETC_PSIVLANR_TXTAGR(x)            (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIVLANR_TXTAGR_SHIFT)) & NETC_ENETC_PSIVLANR_TXTAGR_MASK)

#define NETC_ENETC_PSIVLANR_VTEA_MASK            (0x40000000U)
#define NETC_ENETC_PSIVLANR_VTEA_SHIFT           (30U)
/*! VTEA - VLAN tag extract action
 *  0b0..SI-based VLAN header is removed from received frames.
 *  0b1..The VID in the SI-based VLAN header is zeroed. The SI-based VLAN header becomes a priority tag.
 */
#define NETC_ENETC_PSIVLANR_VTEA(x)              (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIVLANR_VTEA_SHIFT)) & NETC_ENETC_PSIVLANR_VTEA_MASK)
...
#define NETC_ENETC_PSIVLANR_COUNT                (4U)

/*! @name PSICFGR0 - Port station interface 0 configuration register 0..Port station interface 3 configuration register 0 */
/*! @{ */
...
#define NETC_ENETC_PSICFGR0_VTIA_MASK            (0x400U)
#define NETC_ENETC_PSICFGR0_VTIA_SHIFT           (10U)
#define NETC_ENETC_PSICFGR0_VTIA(x)              (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSICFGR0_VTIA_SHIFT)) & NETC_ENETC_PSICFGR0_VTIA_MASK)
...
#define NETC_ENETC_PSICFGR0_VASE_MASK            (0x2000U)
#define NETC_ENETC_PSICFGR0_VASE_SHIFT           (13U)
#define NETC_ENETC_PSICFGR0_VASE(x)              (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSICFGR0_VASE_SHIFT)) & NETC_ENETC_PSICFGR0_VASE_MASK)
...
#define NETC_ENETC_PSICFGR0_COUNT                (4U)

/*! @name PSICFGR1 - Port station interface 1 configuration register 1..Port station interface 3 configuration register 1 */
/*! @{ */
...
#define NETC_ENETC_PSICFGR1_COUNT                (4U)

/*! @name PSICFGR2 - Port station interface 0 configuration register 2..Port station interface 3 configuration register 2 */
/*! @{ */
...
#define NETC_ENETC_PSICFGR2_COUNT                (4U)

/*! @name PSIVMAFCFGR - Port station interface 0 VSI MAC address filtering configuration register..Port station interface 3 VSI MAC address filtering configuration register */
/*! @{ */
...
#define NETC_ENETC_PSIVMAFCFGR_COUNT             (4U)

/*! @name PSIVLANFCFGR - Port station interface 0 VLAN filtering configuration register..Port station interface 3 VLAN filtering configuration register */
/*! @{ */
...
#define NETC_ENETC_PSIVLANFCFGR_COUNT            (4U)

/*! @name PSIRFSCFGR - Port station interface 0 RFS configuration register..Port station interface 3 RFS configuration register */
/*! @{ */

#define NETC_ENETC_PSIRFSCFGR_NUM_RFS_MASK       (0x1FFU)
#define NETC_ENETC_PSIRFSCFGR_NUM_RFS_SHIFT      (0U)
#define NETC_ENETC_PSIRFSCFGR_NUM_RFS(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ENETC_PSIRFSCFGR_NUM_RFS_SHIFT)) & NETC_ENETC_PSIRFSCFGR_NUM_RFS_MASK)
/*! @} */

/* The count of NETC_ENETC_PSIRFSCFGR */
#define NETC_ENETC_PSIRFSCFGR_COUNT              (4U)

/*! @name PSIUMHFR0 - Port station interface 0 unicast MAC hash filter register 0..Port station interface 3 unicast MAC hash filter register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIUMHFR0_COUNT               (4U)

/*! @name PSIUMHFR1 - Port station interface 0 unicast MAC hash filter register 1..Port station interface 3 unicast MAC hash filter register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIUMHFR1_COUNT               (4U)

/*! @name PSIMMHFR0 - Port station interface 0 multicast MAC hash filter register 0..Port station interface 3 multicast MAC hash filter register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIMMHFR0_COUNT               (4U)

/*! @name PSIMMHFR1 - Port station interface 0 multicast MAC hash filter register 1..Port station interface 3 multicast MAC hash filter register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIMMHFR1_COUNT               (4U)

/*! @name PSIVHFR0 - Port station interface 0 VLAN hash filter register 0..Port station interface 3 VLAN hash filter register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIVHFR0_COUNT                (4U)

/*! @name PSIVHFR1 - Port station interface 0 VLAN hash filter register 1..Port station interface 3 VLAN hash filter register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIVHFR1_COUNT                (4U)
