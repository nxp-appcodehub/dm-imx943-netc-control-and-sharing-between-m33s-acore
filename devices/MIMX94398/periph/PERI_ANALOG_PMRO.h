...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for ANALOG_PMRO
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for ANALOG_PMRO
 *
 * CMSIS Peripheral Access Layer for ANALOG_PMRO
 */

#if !defined(ANALOG_PMRO_H_)
#define ANALOG_PMRO_H_                           /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- ANALOG_PMRO Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ANALOG_PMRO_Peripheral_Access_Layer ANALOG_PMRO Peripheral Access Layer
 * @{
 */

/** ANALOG_PMRO - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- ANALOG_PMRO Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ANALOG_PMRO_Register_Masks ANALOG_PMRO Register Masks
 * @{
 */
...
#define ANALOG_PMRO_CTRL1_EN_MASK                (0x3FFFFU)
#define ANALOG_PMRO_CTRL1_EN_SHIFT               (0U)
/*! EN - 18 Dut Ring Oscillator enable */
#define ANALOG_PMRO_CTRL1_EN(x)                  (((uint32_t)(((uint32_t)(x)) << ANALOG_PMRO_CTRL1_EN_SHIFT)) & ANALOG_PMRO_CTRL1_EN_MASK)

#define ANALOG_PMRO_CTRL1_DIV_MASK               (0x7000000U)
#define ANALOG_PMRO_CTRL1_DIV_SHIFT              (24U)
 ...
 *  0b111..Divide by 128
 */
#define ANALOG_PMRO_CTRL1_DIV(x)                 (((uint32_t)(((uint32_t)(x)) << ANALOG_PMRO_CTRL1_DIV_SHIFT)) & ANALOG_PMRO_CTRL1_DIV_MASK)
/*! @} */

/*! @name CTRL2 - Control Register CTRL2 */
/*! @{ */

#define ANALOG_PMRO_CTRL2_CLKGEN_MASK            (0x3FFFFU)
#define ANALOG_PMRO_CTRL2_CLKGEN_SHIFT           (0U)
/*! CLKGEN - 18 Dut Ring Oscillator (RO) Clock Gate enable */
#define ANALOG_PMRO_CTRL2_CLKGEN(x)              (((uint32_t)(((uint32_t)(x)) << ANALOG_PMRO_CTRL2_CLKGEN_SHIFT)) & ANALOG_PMRO_CTRL2_CLKGEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group ANALOG_PMRO_Register_Masks */


/*!
 * @}
 */ /* end of group ANALOG_PMRO_Peripheral_Access_Layer */
