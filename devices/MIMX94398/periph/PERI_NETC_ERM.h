...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NETC_ERM
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NETC_ERM
 *
 * CMSIS Peripheral Access Layer for NETC_ERM
 */

#if !defined(NETC_ERM_H_)
#define NETC_ERM_H_                              /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NETC_ERM Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NETC_ERM_Peripheral_Access_Layer NETC_ERM Peripheral Access Layer
 * @{
 */

/** NETC_ERM - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- NETC_ERM Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NETC_ERM_Register_Masks NETC_ERM Register Masks
 * @{
 */
...
#define NETC_ERM_CR0_ENCIE7_MASK                 (0x4U)
#define NETC_ERM_CR0_ENCIE7_SHIFT                (2U)
/*! ENCIE7 - ENCIE7
 ...
 */
#define NETC_ERM_CR0_ENCIE7(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE7_SHIFT)) & NETC_ERM_CR0_ENCIE7_MASK)

#define NETC_ERM_CR0_ESCIE7_MASK                 (0x8U)
#define NETC_ERM_CR0_ESCIE7_SHIFT                (3U)
/*! ESCIE7 - ESCIE7
 ...
 */
#define NETC_ERM_CR0_ESCIE7(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE7_SHIFT)) & NETC_ERM_CR0_ESCIE7_MASK)

#define NETC_ERM_CR0_ENCIE6_MASK                 (0x40U)
#define NETC_ERM_CR0_ENCIE6_SHIFT                (6U)
/*! ENCIE6 - ENCIE6
 ...
 */
#define NETC_ERM_CR0_ENCIE6(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE6_SHIFT)) & NETC_ERM_CR0_ENCIE6_MASK)

#define NETC_ERM_CR0_ESCIE6_MASK                 (0x80U)
#define NETC_ERM_CR0_ESCIE6_SHIFT                (7U)
/*! ESCIE6 - ESCIE6
 ...
 */
#define NETC_ERM_CR0_ESCIE6(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE6_SHIFT)) & NETC_ERM_CR0_ESCIE6_MASK)

#define NETC_ERM_CR0_ENCIE5_MASK                 (0x400U)
#define NETC_ERM_CR0_ENCIE5_SHIFT                (10U)
/*! ENCIE5 - ENCIE5
 ...
 */
#define NETC_ERM_CR0_ENCIE5(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE5_SHIFT)) & NETC_ERM_CR0_ENCIE5_MASK)

#define NETC_ERM_CR0_ESCIE5_MASK                 (0x800U)
#define NETC_ERM_CR0_ESCIE5_SHIFT                (11U)
/*! ESCIE5 - ESCIE5
 ...
 */
#define NETC_ERM_CR0_ESCIE5(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE5_SHIFT)) & NETC_ERM_CR0_ESCIE5_MASK)

#define NETC_ERM_CR0_ENCIE4_MASK                 (0x4000U)
#define NETC_ERM_CR0_ENCIE4_SHIFT                (14U)
/*! ENCIE4 - ENCIE4
 ...
 */
#define NETC_ERM_CR0_ENCIE4(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE4_SHIFT)) & NETC_ERM_CR0_ENCIE4_MASK)

#define NETC_ERM_CR0_ESCIE4_MASK                 (0x8000U)
#define NETC_ERM_CR0_ESCIE4_SHIFT                (15U)
/*! ESCIE4 - ESCIE4
 ...
 */
#define NETC_ERM_CR0_ESCIE4(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE4_SHIFT)) & NETC_ERM_CR0_ESCIE4_MASK)

#define NETC_ERM_CR0_ENCIE3_MASK                 (0x40000U)
#define NETC_ERM_CR0_ENCIE3_SHIFT                (18U)
/*! ENCIE3 - ENCIE3
 ...
 */
#define NETC_ERM_CR0_ENCIE3(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE3_SHIFT)) & NETC_ERM_CR0_ENCIE3_MASK)

#define NETC_ERM_CR0_ESCIE3_MASK                 (0x80000U)
#define NETC_ERM_CR0_ESCIE3_SHIFT                (19U)
/*! ESCIE3 - ESCIE3
 ...
 */
#define NETC_ERM_CR0_ESCIE3(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE3_SHIFT)) & NETC_ERM_CR0_ESCIE3_MASK)

#define NETC_ERM_CR0_ENCIE2_MASK                 (0x400000U)
#define NETC_ERM_CR0_ENCIE2_SHIFT                (22U)
/*! ENCIE2 - ENCIE2
 ...
 */
#define NETC_ERM_CR0_ENCIE2(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE2_SHIFT)) & NETC_ERM_CR0_ENCIE2_MASK)

#define NETC_ERM_CR0_ESCIE2_MASK                 (0x800000U)
#define NETC_ERM_CR0_ESCIE2_SHIFT                (23U)
/*! ESCIE2 - ESCIE2
 ...
 */
#define NETC_ERM_CR0_ESCIE2(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE2_SHIFT)) & NETC_ERM_CR0_ESCIE2_MASK)

#define NETC_ERM_CR0_ENCIE1_MASK                 (0x4000000U)
#define NETC_ERM_CR0_ENCIE1_SHIFT                (26U)
/*! ENCIE1 - ENCIE1
 ...
 */
#define NETC_ERM_CR0_ENCIE1(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE1_SHIFT)) & NETC_ERM_CR0_ENCIE1_MASK)

#define NETC_ERM_CR0_ESCIE1_MASK                 (0x8000000U)
#define NETC_ERM_CR0_ESCIE1_SHIFT                (27U)
/*! ESCIE1 - ESCIE1
 ...
 */
#define NETC_ERM_CR0_ESCIE1(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE1_SHIFT)) & NETC_ERM_CR0_ESCIE1_MASK)

#define NETC_ERM_CR0_ENCIE0_MASK                 (0x40000000U)
#define NETC_ERM_CR0_ENCIE0_SHIFT                (30U)
/*! ENCIE0 - ENCIE0
 ...
 */
#define NETC_ERM_CR0_ENCIE0(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ENCIE0_SHIFT)) & NETC_ERM_CR0_ENCIE0_MASK)

#define NETC_ERM_CR0_ESCIE0_MASK                 (0x80000000U)
#define NETC_ERM_CR0_ESCIE0_SHIFT                (31U)
/*! ESCIE0 - ESCIE0
 ...
 */
#define NETC_ERM_CR0_ESCIE0(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR0_ESCIE0_SHIFT)) & NETC_ERM_CR0_ESCIE0_MASK)
/*! @} */

/*! @name CR1 - ERM Configuration Register 1 */
/*! @{ */

#define NETC_ERM_CR1_ENCIE15_MASK                (0x4U)
#define NETC_ERM_CR1_ENCIE15_SHIFT               (2U)
/*! ENCIE15 - ENCIE15
 ...
 */
#define NETC_ERM_CR1_ENCIE15(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ENCIE15_SHIFT)) & NETC_ERM_CR1_ENCIE15_MASK)

#define NETC_ERM_CR1_ESCIE15_MASK                (0x8U)
#define NETC_ERM_CR1_ESCIE15_SHIFT               (3U)
/*! ESCIE15 - ESCIE15
 ...
 */
#define NETC_ERM_CR1_ESCIE15(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ESCIE15_SHIFT)) & NETC_ERM_CR1_ESCIE15_MASK)

#define NETC_ERM_CR1_ENCIE14_MASK                (0x40U)
#define NETC_ERM_CR1_ENCIE14_SHIFT               (6U)
/*! ENCIE14 - ENCIE14
 ...
 */
#define NETC_ERM_CR1_ENCIE14(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ENCIE14_SHIFT)) & NETC_ERM_CR1_ENCIE14_MASK)

#define NETC_ERM_CR1_ESCIE14_MASK                (0x80U)
#define NETC_ERM_CR1_ESCIE14_SHIFT               (7U)
/*! ESCIE14 - ESCIE14
 ...
 */
#define NETC_ERM_CR1_ESCIE14(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ESCIE14_SHIFT)) & NETC_ERM_CR1_ESCIE14_MASK)

#define NETC_ERM_CR1_ENCIE13_MASK                (0x400U)
#define NETC_ERM_CR1_ENCIE13_SHIFT               (10U)
/*! ENCIE13 - ENCIE13
 ...
 */
#define NETC_ERM_CR1_ENCIE13(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ENCIE13_SHIFT)) & NETC_ERM_CR1_ENCIE13_MASK)

#define NETC_ERM_CR1_ESCIE13_MASK                (0x800U)
#define NETC_ERM_CR1_ESCIE13_SHIFT               (11U)
/*! ESCIE13 - ESCIE13
 ...
 */
#define NETC_ERM_CR1_ESCIE13(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ESCIE13_SHIFT)) & NETC_ERM_CR1_ESCIE13_MASK)

#define NETC_ERM_CR1_ENCIE9_MASK                 (0x4000000U)
#define NETC_ERM_CR1_ENCIE9_SHIFT                (26U)
/*! ENCIE9 - ENCIE9
 ...
 */
#define NETC_ERM_CR1_ENCIE9(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ENCIE9_SHIFT)) & NETC_ERM_CR1_ENCIE9_MASK)

#define NETC_ERM_CR1_ESCIE9_MASK                 (0x8000000U)
#define NETC_ERM_CR1_ESCIE9_SHIFT                (27U)
/*! ESCIE9 - ESCIE9
 ...
 */
#define NETC_ERM_CR1_ESCIE9(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ESCIE9_SHIFT)) & NETC_ERM_CR1_ESCIE9_MASK)

#define NETC_ERM_CR1_ENCIE8_MASK                 (0x40000000U)
#define NETC_ERM_CR1_ENCIE8_SHIFT                (30U)
/*! ENCIE8 - ENCIE8
 ...
 */
#define NETC_ERM_CR1_ENCIE8(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ENCIE8_SHIFT)) & NETC_ERM_CR1_ENCIE8_MASK)

#define NETC_ERM_CR1_ESCIE8_MASK                 (0x80000000U)
#define NETC_ERM_CR1_ESCIE8_SHIFT                (31U)
/*! ESCIE8 - ESCIE8
 ...
 */
#define NETC_ERM_CR1_ESCIE8(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CR1_ESCIE8_SHIFT)) & NETC_ERM_CR1_ESCIE8_MASK)
/*! @} */

/*! @name SR0 - ERM Status Register 0 */
/*! @{ */

#define NETC_ERM_SR0_NCE7_MASK                   (0x4U)
#define NETC_ERM_SR0_NCE7_SHIFT                  (2U)
/*! NCE7 - NCE7
 *  0b0..No non-correctable error event on Memory 7 detected.
 *  0b1..Non-correctable error event on Memory 7 detected.
 */
#define NETC_ERM_SR0_NCE7(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE7_SHIFT)) & NETC_ERM_SR0_NCE7_MASK)

#define NETC_ERM_SR0_SBC7_MASK                   (0x8U)
#define NETC_ERM_SR0_SBC7_SHIFT                  (3U)
/*! SBC7 - SBC7
 *  0b0..No single-bit correction event on Memory 7 detected.
 *  0b1..Single-bit correction event on Memory 7 detected.
 */
#define NETC_ERM_SR0_SBC7(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC7_SHIFT)) & NETC_ERM_SR0_SBC7_MASK)

#define NETC_ERM_SR0_NCE6_MASK                   (0x40U)
#define NETC_ERM_SR0_NCE6_SHIFT                  (6U)
/*! NCE6 - NCE6
 *  0b0..No non-correctable error event on Memory 6 detected.
 *  0b1..Non-correctable error event on Memory 6 detected.
 */
#define NETC_ERM_SR0_NCE6(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE6_SHIFT)) & NETC_ERM_SR0_NCE6_MASK)

#define NETC_ERM_SR0_SBC6_MASK                   (0x80U)
#define NETC_ERM_SR0_SBC6_SHIFT                  (7U)
/*! SBC6 - SBC6
 *  0b0..No single-bit correction event on Memory 6 detected.
 *  0b1..Single-bit correction event on Memory 6 detected.
 */
#define NETC_ERM_SR0_SBC6(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC6_SHIFT)) & NETC_ERM_SR0_SBC6_MASK)

#define NETC_ERM_SR0_NCE5_MASK                   (0x400U)
#define NETC_ERM_SR0_NCE5_SHIFT                  (10U)
/*! NCE5 - NCE5
 *  0b0..No non-correctable error event on Memory 5 detected.
 *  0b1..Non-correctable error event on Memory 5 detected.
 */
#define NETC_ERM_SR0_NCE5(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE5_SHIFT)) & NETC_ERM_SR0_NCE5_MASK)

#define NETC_ERM_SR0_SBC5_MASK                   (0x800U)
#define NETC_ERM_SR0_SBC5_SHIFT                  (11U)
/*! SBC5 - SBC5
 *  0b0..No single-bit correction event on Memory 5 detected.
 *  0b1..Single-bit correction event on Memory 5 detected.
 */
#define NETC_ERM_SR0_SBC5(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC5_SHIFT)) & NETC_ERM_SR0_SBC5_MASK)

#define NETC_ERM_SR0_NCE4_MASK                   (0x4000U)
#define NETC_ERM_SR0_NCE4_SHIFT                  (14U)
/*! NCE4 - NCE4
 *  0b0..No non-correctable error event on Memory 4 detected.
 *  0b1..Non-correctable error event on Memory 4 detected.
 */
#define NETC_ERM_SR0_NCE4(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE4_SHIFT)) & NETC_ERM_SR0_NCE4_MASK)

#define NETC_ERM_SR0_SBC4_MASK                   (0x8000U)
#define NETC_ERM_SR0_SBC4_SHIFT                  (15U)
/*! SBC4 - SBC4
 *  0b0..No single-bit correction event on Memory 4 detected.
 *  0b1..Single-bit correction event on Memory 4 detected.
 */
#define NETC_ERM_SR0_SBC4(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC4_SHIFT)) & NETC_ERM_SR0_SBC4_MASK)

#define NETC_ERM_SR0_NCE3_MASK                   (0x40000U)
#define NETC_ERM_SR0_NCE3_SHIFT                  (18U)
/*! NCE3 - NCE3
 *  0b0..No non-correctable error event on Memory 3 detected.
 *  0b1..Non-correctable error event on Memory 3 detected.
 */
#define NETC_ERM_SR0_NCE3(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE3_SHIFT)) & NETC_ERM_SR0_NCE3_MASK)

#define NETC_ERM_SR0_SBC3_MASK                   (0x80000U)
#define NETC_ERM_SR0_SBC3_SHIFT                  (19U)
/*! SBC3 - SBC3
 *  0b0..No single-bit correction event on Memory 3 detected.
 *  0b1..Single-bit correction event on Memory 3 detected.
 */
#define NETC_ERM_SR0_SBC3(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC3_SHIFT)) & NETC_ERM_SR0_SBC3_MASK)

#define NETC_ERM_SR0_NCE2_MASK                   (0x400000U)
#define NETC_ERM_SR0_NCE2_SHIFT                  (22U)
/*! NCE2 - NCE2
 *  0b0..No non-correctable error event on Memory 2 detected.
 *  0b1..Non-correctable error event on Memory 2 detected.
 */
#define NETC_ERM_SR0_NCE2(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE2_SHIFT)) & NETC_ERM_SR0_NCE2_MASK)

#define NETC_ERM_SR0_SBC2_MASK                   (0x800000U)
#define NETC_ERM_SR0_SBC2_SHIFT                  (23U)
/*! SBC2 - SBC2
 *  0b0..No single-bit correction event on Memory 2 detected.
 *  0b1..Single-bit correction event on Memory 2 detected.
 */
#define NETC_ERM_SR0_SBC2(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC2_SHIFT)) & NETC_ERM_SR0_SBC2_MASK)

#define NETC_ERM_SR0_NCE1_MASK                   (0x4000000U)
#define NETC_ERM_SR0_NCE1_SHIFT                  (26U)
/*! NCE1 - NCE1
 *  0b0..No non-correctable error event on Memory 1 detected.
 *  0b1..Non-correctable error event on Memory 1 detected.
 */
#define NETC_ERM_SR0_NCE1(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE1_SHIFT)) & NETC_ERM_SR0_NCE1_MASK)

#define NETC_ERM_SR0_SBC1_MASK                   (0x8000000U)
#define NETC_ERM_SR0_SBC1_SHIFT                  (27U)
/*! SBC1 - SBC1
 *  0b0..No single-bit correction event on Memory 1 detected.
 *  0b1..Single-bit correction event on Memory 1 detected.
 */
#define NETC_ERM_SR0_SBC1(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC1_SHIFT)) & NETC_ERM_SR0_SBC1_MASK)

#define NETC_ERM_SR0_NCE0_MASK                   (0x40000000U)
#define NETC_ERM_SR0_NCE0_SHIFT                  (30U)
/*! NCE0 - NCE0
 *  0b0..No non-correctable error event on Memory 0 detected.
 *  0b1..Non-correctable error event on Memory 0 detected.
 */
#define NETC_ERM_SR0_NCE0(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_NCE0_SHIFT)) & NETC_ERM_SR0_NCE0_MASK)

#define NETC_ERM_SR0_SBC0_MASK                   (0x80000000U)
#define NETC_ERM_SR0_SBC0_SHIFT                  (31U)
/*! SBC0 - SBC0
 *  0b0..No single-bit correction event on Memory 0 detected.
 *  0b1..Single-bit correction event on Memory 0 detected.
 */
#define NETC_ERM_SR0_SBC0(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR0_SBC0_SHIFT)) & NETC_ERM_SR0_SBC0_MASK)
/*! @} */

/*! @name SR1 - ERM Status Register 1 */
/*! @{ */

#define NETC_ERM_SR1_NCE15_MASK                  (0x4U)
#define NETC_ERM_SR1_NCE15_SHIFT                 (2U)
/*! NCE15 - NCE15
 *  0b0..No non-correctable error event on Memory 15 detected.
 *  0b1..Non-correctable error event on Memory 15 detected.
 */
#define NETC_ERM_SR1_NCE15(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_NCE15_SHIFT)) & NETC_ERM_SR1_NCE15_MASK)

#define NETC_ERM_SR1_SBC15_MASK                  (0x8U)
#define NETC_ERM_SR1_SBC15_SHIFT                 (3U)
/*! SBC15 - SBC15
 *  0b0..No single-bit correction event on Memory 15 detected.
 *  0b1..Single-bit correction event on Memory 15 detected.
 */
#define NETC_ERM_SR1_SBC15(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_SBC15_SHIFT)) & NETC_ERM_SR1_SBC15_MASK)

#define NETC_ERM_SR1_NCE14_MASK                  (0x40U)
#define NETC_ERM_SR1_NCE14_SHIFT                 (6U)
/*! NCE14 - NCE14
 *  0b0..No non-correctable error event on Memory 14 detected.
 *  0b1..Non-correctable error event on Memory 14 detected.
 */
#define NETC_ERM_SR1_NCE14(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_NCE14_SHIFT)) & NETC_ERM_SR1_NCE14_MASK)

#define NETC_ERM_SR1_SBC14_MASK                  (0x80U)
#define NETC_ERM_SR1_SBC14_SHIFT                 (7U)
/*! SBC14 - SBC14
 *  0b0..No single-bit correction event on Memory 14 detected.
 *  0b1..Single-bit correction event on Memory 14 detected.
 */
#define NETC_ERM_SR1_SBC14(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_SBC14_SHIFT)) & NETC_ERM_SR1_SBC14_MASK)

#define NETC_ERM_SR1_NCE13_MASK                  (0x400U)
#define NETC_ERM_SR1_NCE13_SHIFT                 (10U)
/*! NCE13 - NCE13
 *  0b0..No non-correctable error event on Memory 13 detected.
 *  0b1..Non-correctable error event on Memory 13 detected.
 */
#define NETC_ERM_SR1_NCE13(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_NCE13_SHIFT)) & NETC_ERM_SR1_NCE13_MASK)

#define NETC_ERM_SR1_SBC13_MASK                  (0x800U)
#define NETC_ERM_SR1_SBC13_SHIFT                 (11U)
/*! SBC13 - SBC13
 *  0b0..No single-bit correction event on Memory 13 detected.
 *  0b1..Single-bit correction event on Memory 13 detected.
 */
#define NETC_ERM_SR1_SBC13(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_SBC13_SHIFT)) & NETC_ERM_SR1_SBC13_MASK)

#define NETC_ERM_SR1_NCE9_MASK                   (0x4000000U)
#define NETC_ERM_SR1_NCE9_SHIFT                  (26U)
/*! NCE9 - NCE9
 *  0b0..No non-correctable error event on Memory 9 detected.
 *  0b1..Non-correctable error event on Memory 9 detected.
 */
#define NETC_ERM_SR1_NCE9(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_NCE9_SHIFT)) & NETC_ERM_SR1_NCE9_MASK)

#define NETC_ERM_SR1_SBC9_MASK                   (0x8000000U)
#define NETC_ERM_SR1_SBC9_SHIFT                  (27U)
/*! SBC9 - SBC9
 *  0b0..No single-bit correction event on Memory 9 detected.
 *  0b1..Single-bit correction event on Memory 9 detected.
 */
#define NETC_ERM_SR1_SBC9(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_SBC9_SHIFT)) & NETC_ERM_SR1_SBC9_MASK)

#define NETC_ERM_SR1_NCE8_MASK                   (0x40000000U)
#define NETC_ERM_SR1_NCE8_SHIFT                  (30U)
/*! NCE8 - NCE8
 *  0b0..No non-correctable error event on Memory 8 detected.
 *  0b1..Non-correctable error event on Memory 8 detected.
 */
#define NETC_ERM_SR1_NCE8(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_NCE8_SHIFT)) & NETC_ERM_SR1_NCE8_MASK)

#define NETC_ERM_SR1_SBC8_MASK                   (0x80000000U)
#define NETC_ERM_SR1_SBC8_SHIFT                  (31U)
/*! SBC8 - SBC8
 *  0b0..No single-bit correction event on Memory 8 detected.
 *  0b1..Single-bit correction event on Memory 8 detected.
 */
#define NETC_ERM_SR1_SBC8(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SR1_SBC8_SHIFT)) & NETC_ERM_SR1_SBC8_MASK)
/*! @} */

/*! @name EAR0 - ERM Memory 0 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR0_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR0_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR0_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR0_EAR_SHIFT)) & NETC_ERM_EAR0_EAR_MASK)
/*! @} */

/*! @name SYN0 - ERM Memory 0 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN0_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN0_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN0_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN0_SYNDROME_SHIFT)) & NETC_ERM_SYN0_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT0 - ERM Memory 0 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT0_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT0_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT0_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT0_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT0_COUNT_MASK)
/*! @} */

/*! @name EAR1 - ERM Memory 1 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR1_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR1_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR1_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR1_EAR_SHIFT)) & NETC_ERM_EAR1_EAR_MASK)
/*! @} */

/*! @name SYN1 - ERM Memory 1 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN1_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN1_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN1_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN1_SYNDROME_SHIFT)) & NETC_ERM_SYN1_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT1 - ERM Memory 1 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT1_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT1_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT1_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT1_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT1_COUNT_MASK)
/*! @} */

/*! @name EAR2 - ERM Memory 2 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR2_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR2_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR2_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR2_EAR_SHIFT)) & NETC_ERM_EAR2_EAR_MASK)
/*! @} */

/*! @name SYN2 - ERM Memory 2 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN2_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN2_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN2_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN2_SYNDROME_SHIFT)) & NETC_ERM_SYN2_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT2 - ERM Memory 2 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT2_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT2_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT2_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT2_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT2_COUNT_MASK)
/*! @} */

/*! @name EAR3 - ERM Memory 3 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR3_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR3_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR3_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR3_EAR_SHIFT)) & NETC_ERM_EAR3_EAR_MASK)
/*! @} */

/*! @name SYN3 - ERM Memory 3 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN3_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN3_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN3_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN3_SYNDROME_SHIFT)) & NETC_ERM_SYN3_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT3 - ERM Memory 3 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT3_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT3_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT3_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT3_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT3_COUNT_MASK)
/*! @} */

/*! @name EAR4 - ERM Memory 4 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR4_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR4_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR4_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR4_EAR_SHIFT)) & NETC_ERM_EAR4_EAR_MASK)
/*! @} */

/*! @name SYN4 - ERM Memory 4 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN4_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN4_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN4_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN4_SYNDROME_SHIFT)) & NETC_ERM_SYN4_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT4 - ERM Memory 4 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT4_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT4_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT4_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT4_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT4_COUNT_MASK)
/*! @} */

/*! @name EAR5 - ERM Memory 5 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR5_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR5_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR5_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR5_EAR_SHIFT)) & NETC_ERM_EAR5_EAR_MASK)
/*! @} */

/*! @name SYN5 - ERM Memory 5 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN5_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN5_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN5_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN5_SYNDROME_SHIFT)) & NETC_ERM_SYN5_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT5 - ERM Memory 5 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT5_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT5_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT5_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT5_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT5_COUNT_MASK)
/*! @} */

/*! @name EAR6 - ERM Memory 6 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR6_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR6_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR6_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR6_EAR_SHIFT)) & NETC_ERM_EAR6_EAR_MASK)
/*! @} */

/*! @name SYN6 - ERM Memory 6 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN6_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN6_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN6_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN6_SYNDROME_SHIFT)) & NETC_ERM_SYN6_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT6 - ERM Memory 6 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT6_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT6_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT6_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT6_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT6_COUNT_MASK)
/*! @} */

/*! @name EAR7 - ERM Memory 7 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR7_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR7_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR7_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR7_EAR_SHIFT)) & NETC_ERM_EAR7_EAR_MASK)
/*! @} */

/*! @name SYN7 - ERM Memory 7 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN7_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN7_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN7_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN7_SYNDROME_SHIFT)) & NETC_ERM_SYN7_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT7 - ERM Memory 7 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT7_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT7_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT7_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT7_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT7_COUNT_MASK)
/*! @} */

/*! @name EAR8 - ERM Memory 8 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR8_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR8_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR8_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR8_EAR_SHIFT)) & NETC_ERM_EAR8_EAR_MASK)
/*! @} */

/*! @name SYN8 - ERM Memory 8 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN8_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN8_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN8_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN8_SYNDROME_SHIFT)) & NETC_ERM_SYN8_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT8 - ERM Memory 8 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT8_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT8_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT8_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT8_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT8_COUNT_MASK)
/*! @} */

/*! @name EAR9 - ERM Memory 9 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR9_EAR_MASK                   (0xFFFFFFFFU)
#define NETC_ERM_EAR9_EAR_SHIFT                  (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR9_EAR(x)                     (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR9_EAR_SHIFT)) & NETC_ERM_EAR9_EAR_MASK)
/*! @} */

/*! @name SYN9 - ERM Memory 9 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN9_SYNDROME_MASK              (0xFF000000U)
#define NETC_ERM_SYN9_SYNDROME_SHIFT             (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN9_SYNDROME(x)                (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN9_SYNDROME_SHIFT)) & NETC_ERM_SYN9_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT9 - ERM Memory 9 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT9_COUNT_MASK        (0xFFU)
#define NETC_ERM_CORR_ERR_CNT9_COUNT_SHIFT       (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT9_COUNT(x)          (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT9_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT9_COUNT_MASK)
/*! @} */

/*! @name EAR13 - ERM Memory 13 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR13_EAR_MASK                  (0xFFFFFFFFU)
#define NETC_ERM_EAR13_EAR_SHIFT                 (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR13_EAR(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR13_EAR_SHIFT)) & NETC_ERM_EAR13_EAR_MASK)
/*! @} */

/*! @name SYN13 - ERM Memory 13 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN13_SYNDROME_MASK             (0xFF000000U)
#define NETC_ERM_SYN13_SYNDROME_SHIFT            (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN13_SYNDROME(x)               (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN13_SYNDROME_SHIFT)) & NETC_ERM_SYN13_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT13 - ERM Memory 13 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT13_COUNT_MASK       (0xFFU)
#define NETC_ERM_CORR_ERR_CNT13_COUNT_SHIFT      (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT13_COUNT(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT13_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT13_COUNT_MASK)
/*! @} */

/*! @name EAR14 - ERM Memory 14 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR14_EAR_MASK                  (0xFFFFFFFFU)
#define NETC_ERM_EAR14_EAR_SHIFT                 (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR14_EAR(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR14_EAR_SHIFT)) & NETC_ERM_EAR14_EAR_MASK)
/*! @} */

/*! @name SYN14 - ERM Memory 14 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN14_SYNDROME_MASK             (0xFF000000U)
#define NETC_ERM_SYN14_SYNDROME_SHIFT            (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN14_SYNDROME(x)               (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN14_SYNDROME_SHIFT)) & NETC_ERM_SYN14_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT14 - ERM Memory 14 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT14_COUNT_MASK       (0xFFU)
#define NETC_ERM_CORR_ERR_CNT14_COUNT_SHIFT      (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT14_COUNT(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT14_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT14_COUNT_MASK)
/*! @} */

/*! @name EAR15 - ERM Memory 15 Error Address Register */
/*! @{ */

#define NETC_ERM_EAR15_EAR_MASK                  (0xFFFFFFFFU)
#define NETC_ERM_EAR15_EAR_SHIFT                 (0U)
/*! EAR - EAR */
#define NETC_ERM_EAR15_EAR(x)                    (((uint32_t)(((uint32_t)(x)) << NETC_ERM_EAR15_EAR_SHIFT)) & NETC_ERM_EAR15_EAR_MASK)
/*! @} */

/*! @name SYN15 - ERM Memory 15 Syndrome Register */
/*! @{ */

#define NETC_ERM_SYN15_SYNDROME_MASK             (0xFF000000U)
#define NETC_ERM_SYN15_SYNDROME_SHIFT            (24U)
/*! SYNDROME - SYNDROME */
#define NETC_ERM_SYN15_SYNDROME(x)               (((uint32_t)(((uint32_t)(x)) << NETC_ERM_SYN15_SYNDROME_SHIFT)) & NETC_ERM_SYN15_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT15 - ERM Memory 15 Correctable Error Count Register */
/*! @{ */

#define NETC_ERM_CORR_ERR_CNT15_COUNT_MASK       (0xFFU)
#define NETC_ERM_CORR_ERR_CNT15_COUNT_SHIFT      (0U)
/*! COUNT - Memory n Correctable Error Count */
#define NETC_ERM_CORR_ERR_CNT15_COUNT(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ERM_CORR_ERR_CNT15_COUNT_SHIFT)) & NETC_ERM_CORR_ERR_CNT15_COUNT_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NETC_ERM_Register_Masks */


/*!
 * @}
 */ /* end of group NETC_ERM_Peripheral_Access_Layer */
