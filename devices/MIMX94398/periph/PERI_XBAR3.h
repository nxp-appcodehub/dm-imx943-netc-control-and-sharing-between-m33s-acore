...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for XBAR3
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for XBAR3
 *
 * CMSIS Peripheral Access Layer for XBAR3
 */

#if !defined(XBAR3_H_)
#define XBAR3_H_                                 /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- XBAR3 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup XBAR3_Peripheral_Access_Layer XBAR3 Peripheral Access Layer
 * @{
 */

/** XBAR3 - Size of Registers Arrays */
#define XBAR3_SEL_COUNT                           32u
#define XBAR3_CTRL_COUNT                          1u

/** XBAR3 - Register Layout Typedef */
typedef struct {
  __IO uint32_t SEL[XBAR3_SEL_COUNT];              /**< Crossbar Select Register, array offset: 0x0, array step: 0x4 */
  __IO uint32_t CTRL[XBAR3_CTRL_COUNT];            /**< Crossbar Control Register, array offset: 0x80, array step: 0x4 */
} XBAR3_Type;

/* ----------------------------------------------------------------------------
   -- XBAR3 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup XBAR3_Register_Masks XBAR3 Register Masks
 * @{
 */
...
#define XBAR3_SEL_SEL_MASK                       (0xFFU)
#define XBAR3_SEL_SEL_SHIFT                      (0U)
/*! SEL - SEL */
#define XBAR3_SEL_SEL(x)                         (((uint32_t)(((uint32_t)(x)) << XBAR3_SEL_SEL_SHIFT)) & XBAR3_SEL_SEL_MASK)

#define XBAR3_SEL_WP_MASK                        (0x80000000U)
#define XBAR3_SEL_WP_SHIFT                       (31U)
/*! WP - Write Protect
 *  0b0..Writing to this register is allowed.
 *  0b1..No further writing to this register is allowed.
 */
#define XBAR3_SEL_WP(x)                          (((uint32_t)(((uint32_t)(x)) << XBAR3_SEL_WP_SHIFT)) & XBAR3_SEL_WP_MASK)
/*! @} */

/*! @name CTRL - Crossbar Control Register */
/*! @{ */

#define XBAR3_CTRL_DEN_MASK                      (0x1U)
#define XBAR3_CTRL_DEN_SHIFT                     (0U)
/*! DEN - DMA Enable for XBAR_OUTn
 *  0b0..DMA disabled
 *  0b1..DMA enabled
 */
#define XBAR3_CTRL_DEN(x)                        (((uint32_t)(((uint32_t)(x)) << XBAR3_CTRL_DEN_SHIFT)) & XBAR3_CTRL_DEN_MASK)

#define XBAR3_CTRL_IEN_MASK                      (0x2U)
#define XBAR3_CTRL_IEN_SHIFT                     (1U)
/*! IEN - Interrupt Enable for XBAR_OUTn
 *  0b0..Interrupt disabled
 *  0b1..Interrupt enabled
 */
#define XBAR3_CTRL_IEN(x)                        (((uint32_t)(((uint32_t)(x)) << XBAR3_CTRL_IEN_SHIFT)) & XBAR3_CTRL_IEN_MASK)

#define XBAR3_CTRL_EDGE_MASK                     (0xCU)
#define XBAR3_CTRL_EDGE_SHIFT                    (2U)
 ...
 */
#define XBAR3_CTRL_EDGE(x)                       (((uint32_t)(((uint32_t)(x)) << XBAR3_CTRL_EDGE_SHIFT)) & XBAR3_CTRL_EDGE_MASK)

#define XBAR3_CTRL_STS_MASK                      (0x10U)
#define XBAR3_CTRL_STS_SHIFT                     (4U)
 ...
 */
#define XBAR3_CTRL_STS(x)                        (((uint32_t)(((uint32_t)(x)) << XBAR3_CTRL_STS_SHIFT)) & XBAR3_CTRL_STS_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group XBAR3_Register_Masks */


/*!
 * @}
 */ /* end of group XBAR3_Peripheral_Access_Layer */
