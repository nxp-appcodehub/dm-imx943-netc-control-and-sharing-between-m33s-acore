...
#define AON_CSTCU_LSTCU_MBSCH_COUNT               7u
...
#define AON_CSTCU_LRFSTAT_RFSLSTCU5_MASK         (0x20U)
#define AON_CSTCU_LRFSTAT_RFSLSTCU5_SHIFT        (5U)
/*! RFSLSTCU5 - Recoverable Fault Occurrence Status from LSTCU5
 *  0b0..Not occurred
 *  0b1..Occurred
 */
#define AON_CSTCU_LRFSTAT_RFSLSTCU5(x)           (((uint32_t)(((uint32_t)(x)) << AON_CSTCU_LRFSTAT_RFSLSTCU5_SHIFT)) & AON_CSTCU_LRFSTAT_RFSLSTCU5_MASK)

#define AON_CSTCU_LRFSTAT_RFSLSTCU6_MASK         (0x40U)
#define AON_CSTCU_LRFSTAT_RFSLSTCU6_SHIFT        (6U)
/*! RFSLSTCU6 - Recoverable Fault Occurrence Status from LSTCU6
 *  0b0..Not occurred
 *  0b1..Occurred
 */
#define AON_CSTCU_LRFSTAT_RFSLSTCU6(x)           (((uint32_t)(((uint32_t)(x)) << AON_CSTCU_LRFSTAT_RFSLSTCU6_SHIFT)) & AON_CSTCU_LRFSTAT_RFSLSTCU6_MASK)
/*! @} */
...
#define AON_CSTCU_LUFSTAT_UFSLSTCU5_MASK         (0x20U)
#define AON_CSTCU_LUFSTAT_UFSLSTCU5_SHIFT        (5U)
/*! UFSLSTCU5 - Unrecoverable Fault Occurrence Status from LSTCU5
 *  0b0..Not occurred
 *  0b1..Occurred
 */
#define AON_CSTCU_LUFSTAT_UFSLSTCU5(x)           (((uint32_t)(((uint32_t)(x)) << AON_CSTCU_LUFSTAT_UFSLSTCU5_SHIFT)) & AON_CSTCU_LUFSTAT_UFSLSTCU5_MASK)

#define AON_CSTCU_LUFSTAT_UFSLSTCU6_MASK         (0x40U)
#define AON_CSTCU_LUFSTAT_UFSLSTCU6_SHIFT        (6U)
/*! UFSLSTCU6 - Unrecoverable Fault Occurrence Status from LSTCU6
 *  0b0..Not occurred
 *  0b1..Occurred
 */
#define AON_CSTCU_LUFSTAT_UFSLSTCU6(x)           (((uint32_t)(((uint32_t)(x)) << AON_CSTCU_LUFSTAT_UFSLSTCU6_SHIFT)) & AON_CSTCU_LUFSTAT_UFSLSTCU6_MASK)
/*! @} */
...
#define AON_CSTCU_BYPLSTCU_BYP_L5_MASK           (0x20U)
#define AON_CSTCU_BYPLSTCU_BYP_L5_SHIFT          (5U)
/*! BYP_L5 - Bypass LSTCU 5
 *  0b0..No bypass
 *  0b1..Bypass
 */
#define AON_CSTCU_BYPLSTCU_BYP_L5(x)             (((uint32_t)(((uint32_t)(x)) << AON_CSTCU_BYPLSTCU_BYP_L5_SHIFT)) & AON_CSTCU_BYPLSTCU_BYP_L5_MASK)

#define AON_CSTCU_BYPLSTCU_BYP_L6_MASK           (0x40U)
#define AON_CSTCU_BYPLSTCU_BYP_L6_SHIFT          (6U)
/*! BYP_L6 - Bypass LSTCU 6
 *  0b0..No bypass
 *  0b1..Bypass
 */
#define AON_CSTCU_BYPLSTCU_BYP_L6(x)             (((uint32_t)(((uint32_t)(x)) << AON_CSTCU_BYPLSTCU_BYP_L6_SHIFT)) & AON_CSTCU_BYPLSTCU_BYP_L6_MASK)
/*! @} */
...
#define AON_CSTCU_LMBPTR_COUNT                   (7U)
