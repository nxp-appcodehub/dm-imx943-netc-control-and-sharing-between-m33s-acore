...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NECTMIX_CM33_AIPS
**
...
/*!
 * @file NECTMIX_CM33_AIPS.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NECTMIX_CM33_AIPS
 *
 * CMSIS Peripheral Access Layer for NECTMIX_CM33_AIPS
 */

#if !defined(NECTMIX_CM33_AIPS_H_)
#define NECTMIX_CM33_AIPS_H_                     /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NECTMIX_CM33_AIPS Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NECTMIX_CM33_AIPS_Peripheral_Access_Layer NECTMIX_CM33_AIPS Peripheral Access Layer
 * @{
 */

/** NECTMIX_CM33_AIPS - Size of Registers Arrays */
#define NECTMIX_CM33_AIPS_PMCR_PMECTR_COUNT       3u
#define NECTMIX_CM33_AIPS_PMCR_COUNT              1u

/** NECTMIX_CM33_AIPS - Register Layout Typedef */
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x30 */
    ...
    } PMECTR[NECTMIX_CM33_AIPS_PMCR_PMECTR_COUNT];
  } PMCR[NECTMIX_CM33_AIPS_PMCR_COUNT];
} NECTMIX_CM33_AIPS_Type;

/* ----------------------------------------------------------------------------
   -- NECTMIX_CM33_AIPS Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NECTMIX_CM33_AIPS_Register_Masks NECTMIX_CM33_AIPS Register Masks
 * @{
 */
...
#define NECTMIX_CM33_AIPS_PMCR_MENB_MASK         (0x1U)
#define NECTMIX_CM33_AIPS_PMCR_MENB_SHIFT        (0U)
/*! MENB - Module Is Enabled
 *  0b0..Disabled
 *  0b1..Enabled
 */
#define NECTMIX_CM33_AIPS_PMCR_MENB(x)           (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_MENB_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_MENB_MASK)

#define NECTMIX_CM33_AIPS_PMCR_SSC_MASK          (0xEU)
#define NECTMIX_CM33_AIPS_PMCR_SSC_SHIFT         (1U)
 ...
 *  0b110, 0b111..
 */
#define NECTMIX_CM33_AIPS_PMCR_SSC(x)            (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_SSC_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_SSC_MASK)

#define NECTMIX_CM33_AIPS_PMCR_CMODE_MASK        (0x30U)
#define NECTMIX_CM33_AIPS_PMCR_CMODE_SHIFT       (4U)
/*! CMODE - Count Mode
 ...
 *  0b11..
 */
#define NECTMIX_CM33_AIPS_PMCR_CMODE(x)          (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_CMODE_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_CMODE_MASK)

#define NECTMIX_CM33_AIPS_PMCR_DCIFSH_MASK       (0x40U)
#define NECTMIX_CM33_AIPS_PMCR_DCIFSH_SHIFT      (6U)
/*! DCIFSH - Disable Counters if Stopped or Halted
 *  0b0..Continue
 *  0b1..Stop
 */
#define NECTMIX_CM33_AIPS_PMCR_DCIFSH(x)         (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_DCIFSH_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_DCIFSH_MASK)

#define NECTMIX_CM33_AIPS_PMCR_RICTR_MASK        (0x80U)
#define NECTMIX_CM33_AIPS_PMCR_RICTR_SHIFT       (7U)
/*! RICTR - Reset Instruction Counter
 *  0b0..Do not reset
 *  0b1..Clear
 */
#define NECTMIX_CM33_AIPS_PMCR_RICTR(x)          (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_RICTR_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_RICTR_MASK)

#define NECTMIX_CM33_AIPS_PMCR_RECTR1_MASK       (0x100U)
#define NECTMIX_CM33_AIPS_PMCR_RECTR1_SHIFT      (8U)
/*! RECTR1 - Reset Event Counter 1
 *  0b0..Run normally
 *  0b1..Reset
 */
#define NECTMIX_CM33_AIPS_PMCR_RECTR1(x)         (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_RECTR1_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_RECTR1_MASK)

#define NECTMIX_CM33_AIPS_PMCR_RECTR2_MASK       (0x200U)
#define NECTMIX_CM33_AIPS_PMCR_RECTR2_SHIFT      (9U)
/*! RECTR2 - Reset Event Counter 2
 *  0b0..Run normally
 *  0b1..Reset
 */
#define NECTMIX_CM33_AIPS_PMCR_RECTR2(x)         (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_RECTR2_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_RECTR2_MASK)

#define NECTMIX_CM33_AIPS_PMCR_RECTR3_MASK       (0x400U)
#define NECTMIX_CM33_AIPS_PMCR_RECTR3_SHIFT      (10U)
/*! RECTR3 - Reset Event Counter 3
 *  0b0..Run normally
 *  0b1..Reset
 */
#define NECTMIX_CM33_AIPS_PMCR_RECTR3(x)         (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_RECTR3_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_RECTR3_MASK)

#define NECTMIX_CM33_AIPS_PMCR_SELEVT1_MASK      (0x3F800U)
#define NECTMIX_CM33_AIPS_PMCR_SELEVT1_SHIFT     (11U)
/*! SELEVT1 - Select Event 1 */
#define NECTMIX_CM33_AIPS_PMCR_SELEVT1(x)        (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_SELEVT1_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_SELEVT1_MASK)

#define NECTMIX_CM33_AIPS_PMCR_SELEVT2_MASK      (0x1FC0000U)
#define NECTMIX_CM33_AIPS_PMCR_SELEVT2_SHIFT     (18U)
/*! SELEVT2 - Select Event 2 */
#define NECTMIX_CM33_AIPS_PMCR_SELEVT2(x)        (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_SELEVT2_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_SELEVT2_MASK)

#define NECTMIX_CM33_AIPS_PMCR_SELEVT3_MASK      (0xFE000000U)
#define NECTMIX_CM33_AIPS_PMCR_SELEVT3_SHIFT     (25U)
/*! SELEVT3 - Select Event 3 */
#define NECTMIX_CM33_AIPS_PMCR_SELEVT3(x)        (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMCR_SELEVT3_SHIFT)) & NECTMIX_CM33_AIPS_PMCR_SELEVT3_MASK)
/*! @} */

/*! @name PMICTR_HI - Performance Monitor Instruction Counter */
/*! @{ */

#define NECTMIX_CM33_AIPS_PMICTR_HI_ICTR_MASK    (0xFFU)
#define NECTMIX_CM33_AIPS_PMICTR_HI_ICTR_SHIFT   (0U)
/*! ICTR - Instruction Counter */
#define NECTMIX_CM33_AIPS_PMICTR_HI_ICTR(x)      (((uint8_t)(((uint8_t)(x)) << NECTMIX_CM33_AIPS_PMICTR_HI_ICTR_SHIFT)) & NECTMIX_CM33_AIPS_PMICTR_HI_ICTR_MASK)
/*! @} */

/* The count of NECTMIX_CM33_AIPS_PMICTR_HI */
#define NECTMIX_CM33_AIPS_PMICTR_HI_COUNT        (1U)

/*! @name PMICTR_LO - Performance Monitor Instruction Counter */
/*! @{ */

#define NECTMIX_CM33_AIPS_PMICTR_LO_ICTR_MASK    (0xFFFFFFFFU)
#define NECTMIX_CM33_AIPS_PMICTR_LO_ICTR_SHIFT   (0U)
/*! ICTR - Instruction Counter */
#define NECTMIX_CM33_AIPS_PMICTR_LO_ICTR(x)      (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_PMICTR_LO_ICTR_SHIFT)) & NECTMIX_CM33_AIPS_PMICTR_LO_ICTR_MASK)
/*! @} */

/* The count of NECTMIX_CM33_AIPS_PMICTR_LO */
#define NECTMIX_CM33_AIPS_PMICTR_LO_COUNT        (1U)

/*! @name HI - Performance Monitor Event Counter */
/*! @{ */

#define NECTMIX_CM33_AIPS_HI_ECTR_MASK           (0xFFU)
#define NECTMIX_CM33_AIPS_HI_ECTR_SHIFT          (0U)
/*! ECTR - Event Counter */
#define NECTMIX_CM33_AIPS_HI_ECTR(x)             (((uint8_t)(((uint8_t)(x)) << NECTMIX_CM33_AIPS_HI_ECTR_SHIFT)) & NECTMIX_CM33_AIPS_HI_ECTR_MASK)
/*! @} */

/* The count of NECTMIX_CM33_AIPS_HI */
#define NECTMIX_CM33_AIPS_HI_COUNT               (1U)

/* The count of NECTMIX_CM33_AIPS_HI */
#define NECTMIX_CM33_AIPS_HI_COUNT2              (3U)

/*! @name LO - Performance Monitor Event Counter */
/*! @{ */

#define NECTMIX_CM33_AIPS_LO_ECTR_MASK           (0xFFFFFFFFU)
#define NECTMIX_CM33_AIPS_LO_ECTR_SHIFT          (0U)
/*! ECTR - Event Counter */
#define NECTMIX_CM33_AIPS_LO_ECTR(x)             (((uint32_t)(((uint32_t)(x)) << NECTMIX_CM33_AIPS_LO_ECTR_SHIFT)) & NECTMIX_CM33_AIPS_LO_ECTR_MASK)
/*! @} */

/* The count of NECTMIX_CM33_AIPS_LO */
#define NECTMIX_CM33_AIPS_LO_COUNT               (1U)

/* The count of NECTMIX_CM33_AIPS_LO */
#define NECTMIX_CM33_AIPS_LO_COUNT2              (3U)


/*!
 * @}
 */ /* end of group NECTMIX_CM33_AIPS_Register_Masks */


/*!
 * @}
 */ /* end of group NECTMIX_CM33_AIPS_Peripheral_Access_Layer */
