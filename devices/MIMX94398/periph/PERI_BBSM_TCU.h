...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for BBSM_TCU
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for BBSM_TCU
 *
 * CMSIS Peripheral Access Layer for BBSM_TCU
 */

#if !defined(BBSM_TCU_H_)
#define BBSM_TCU_H_                              /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- BBSM_TCU Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup BBSM_TCU_Peripheral_Access_Layer BBSM_TCU Peripheral Access Layer
 * @{
 */

/** BBSM_TCU - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- BBSM_TCU Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup BBSM_TCU_Register_Masks BBSM_TCU Register Masks
 * @{
 */
...
#define BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_MASK (0xFFFFFFFFU)
#define BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_SHIFT (0U)
/*! out - 32-Bit Magic KW0 used in conjuction with Magic KW1 to unlock the writes to test mode registers (Value is 0x12345678) */
#define BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW0_out(x)  (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_SHIFT)) & BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_MASK)
/*! @} */

/*! @name TCU_MAGIC_KW__MAGIC_KW1 - Magic KW1 */
/*! @{ */

#define BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_MASK (0xFFFFFFFFU)
#define BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_SHIFT (0U)
/*! out - 32-Bit Magic KW1 used in conjuction with Magic KW0 to unlock the writes to test mode registers (Value - 0x87654321) */
#define BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW1_out(x)  (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_SHIFT)) & BBSM_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_MASK)
/*! @} */

/*! @name TCU_PLL_COUNTER - tcu pll counter reg */
/*! @{ */

#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_rst_n_MASK (0x1U)
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_rst_n_SHIFT (0U)
/*! pll_count_rst_n - pll count reset */
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_rst_n(x) (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_PLL_COUNTER_pll_count_rst_n_SHIFT)) & BBSM_TCU_TCU_PLL_COUNTER_pll_count_rst_n_MASK)

#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_start_MASK (0x2U)
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_start_SHIFT (1U)
/*! pll_count_start - pll count start */
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_start(x) (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_PLL_COUNTER_pll_count_start_SHIFT)) & BBSM_TCU_TCU_PLL_COUNTER_pll_count_start_MASK)

#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_div_en_MASK (0x4U)
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_div_en_SHIFT (2U)
/*! pll_count_div_en - pll count div en */
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_div_en(x) (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_PLL_COUNTER_pll_count_div_en_SHIFT)) & BBSM_TCU_TCU_PLL_COUNTER_pll_count_div_en_MASK)

#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_MASK (0x38U)
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_SHIFT (3U)
/*! pll_count_clk_sel - pll count clk sel */
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_clk_sel(x) (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_SHIFT)) & BBSM_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_MASK)

#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_ref_val_MASK (0xFF00U)
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_ref_val_SHIFT (8U)
/*! pll_count_ref_val - pll count ref val */
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_ref_val(x) (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_PLL_COUNTER_pll_count_ref_val_SHIFT)) & BBSM_TCU_TCU_PLL_COUNTER_pll_count_ref_val_MASK)

#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_cnt_MASK (0xFFFF0000U)
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_cnt_SHIFT (16U)
/*! pll_count_cnt - pll count cnt */
#define BBSM_TCU_TCU_PLL_COUNTER_pll_count_cnt(x) (((uint32_t)(((uint32_t)(x)) << BBSM_TCU_TCU_PLL_COUNTER_pll_count_cnt_SHIFT)) & BBSM_TCU_TCU_PLL_COUNTER_pll_count_cnt_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group BBSM_TCU_Register_Masks */


/*!
 * @}
 */ /* end of group BBSM_TCU_Peripheral_Access_Layer */
