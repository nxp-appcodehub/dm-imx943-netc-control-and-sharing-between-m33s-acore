...
#define CCM_CLOCK_ROOT_COUNT                      128u
#define CCM_GPR_SHARED_COUNT                      5u
#define CCM_GPR_PRIVATE_COUNT                     8u
#define CCM_OSCPLL_COUNT                          44u
#define CCM_LPCG_COUNT                            320u
...
typedef struct {
  ...
  struct {                                         /* offset: 0x5000, array step: 0x40 */
    __IO uint32_t DIRECT;                            /**< Clock source direct control, array offset: 0x5000, array step: 0x40, valid indices: [0-17, 24-43] */
    __I  uint32_t LPM_STATUS0;                       /**< Low power mode information transfer status, array offset: 0x5004, array step: 0x40, valid indices: [0-17, 24-43] */
    __I  uint32_t LPM_STATUS1;                       /**< Low power mode information transfer status, array offset: 0x5008, array step: 0x40, valid indices: [0-17, 24-43] */
         uint8_t RESERVED_0[4];
    __IO uint32_t LPM0;                              /**< Clock source low power mode setting, array offset: 0x5010, array step: 0x40, valid indices: [0-17, 24-43] */
    __IO uint32_t LPM1;                              /**< clock source low power mode setting, array offset: 0x5014, array step: 0x40, valid indices: [0-17, 24-43] */
         uint8_t RESERVED_1[4];
    __I  uint32_t LPM_CUR;                           /**< LPM setting of current CPU domain, array offset: 0x501C, array step: 0x40, valid indices: [0-17, 24-43] */
    __I  uint32_t STATUS0;                           /**< Clock source working status, array offset: 0x5020, array step: 0x40, valid indices: [0-17, 24-43] */
    __I  uint32_t STATUS1;                           /**< Clock source domain status, array offset: 0x5024, array step: 0x40, valid indices: [0-17, 24-43] */
         uint8_t RESERVED_2[8];
    __IO uint32_t AUTHEN;                            /**< Clock Source access control, array offset: 0x5030, array step: 0x40, valid indices: [0-17, 24-43] */
  ...
  __IO uint32_t CCM_LPCG288_319_QACCEPTN_TIMEOUT_INT_MASK; /**< LPCG288 to LPCG319 QACCEPTN TIMEOUT interrupt mask register., offset: 0xD050 */
       uint32_t NPUMIX_LPCG_BLK_CTRL;              /**< Block control register for NPUMIX LPCG control, offset: 0xD054 */
       uint32_t M7MIX_0_LPCG_BLK_CTRL0;            /**< Block control register 0 for M7MIX_0 LPCG control, offset: 0xD058 */
       uint32_t M7MIX_0_LPCG_BLK_CTRL1;            /**< Block control register 1 for M7MIX_0 LPCG control, offset: 0xD05C */
       uint32_t M7MIX_1_LPCG_BLK_CTRL0;            /**< Block control register 0 for M7MIX_1 LPCG control, offset: 0xD060 */
       uint32_t M7MIX_1_LPCG_BLK_CTRL1;            /**< Block control register 1 for M7MIX_1 LPCG control, offset: 0xD064 */
} CCM_Type;
