...
typedef struct {
  ...
  __I  uint32_t DATACH[PDM_DATACHN_COUNT];         /**< MICFIL Output Result, array offset: 0x20, array step: 0x4 */
...
#define PDM_VAD0_CTRL_1_VADS_MASK                (0x20U)
#define PDM_VAD0_CTRL_1_VADS_SHIFT               (5U)
/*! VADS - HWVAD Disable
 *  0b0..Not disabled
 *  0b1..Disabled
 */
#define PDM_VAD0_CTRL_1_VADS(x)                  (((uint32_t)(((uint32_t)(x)) << PDM_VAD0_CTRL_1_VADS_SHIFT)) & PDM_VAD0_CTRL_1_VADS_MASK)
