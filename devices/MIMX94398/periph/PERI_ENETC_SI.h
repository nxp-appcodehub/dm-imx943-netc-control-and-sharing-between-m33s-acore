...
#if !defined(ENETC_SI_H_)
#define ENETC_SI_H_                              /**< Symbol preventing repeated inclusion */
...
#define ENETC_SI_MSGSR_PSI_A_VSI_NUM_COUNT        3u
#define ENETC_SI_SI_BOOT_LOAD_COUNT               2u
#define ENETC_SI_TX_MSI_COUNT                     28u
#define ENETC_SI_RX_GRP_COUNT                     28u
#define ENETC_SI_BDR_COUNT                        28u
...
typedef struct {
  ...
  __IO uint32_t SIMCAR;                            /**< Station interface message cache attribute register, offset: 0x44, not available in all instances (available on 24 out of 168) */
  ...
  union {                                          /* offset: 0x204 */
    struct {                                         /* offset: 0x204 */
      __IO uint32_t PSIMSGRR;                          /**< Physical station interface message receive register, offset: 0x204, not available in all instances (available on 24 out of 168) */
      __IO uint32_t PSIMSGSR;                          /**< Physical station interface message send register, offset: 0x208, not available in all instances (available on 24 out of 168) */
           uint8_t RESERVED_0[4];
      struct {                                         /* offset: 0x210, array step: 0x8 */
        __IO uint32_t PSIVMSGRCVAR0;                     /**< PSI VSI 1 message receive address register 0..PSI VSI 3 message receive address register 0, array offset: 0x210, array step: 0x8, not available in all instances (available on 24 out of 168) */
        __IO uint32_t PSIVMSGRCVAR1;                     /**< PSI VSI 1 message receive address register 1..PSI VSI 3 message receive address register 1, array offset: 0x214, array step: 0x8, not available in all instances (available on 24 out of 168) */
      } VSI_NUM[ENETC_SI_MSGSR_PSI_A_VSI_NUM_COUNT];
    } PSI_A;
    struct {                                         /* offset: 0x204 */
      __I  uint32_t VSIMSGSR;                          /**< Virtual station interface message send register, offset: 0x204, not available in all instances (available on 72 out of 168) */
      __I  uint32_t VSIMSGRR;                          /**< Virtual station interface message receive register, offset: 0x208, not available in all instances (available on 72 out of 168) */
           uint8_t RESERVED_0[4];
      __IO uint32_t VSIMSGSNDAR0;                      /**< Virtual station interface message address send register 0, offset: 0x210, not available in all instances (available on 72 out of 168) */
      __IO uint32_t VSIMSGSNDAR1;                      /**< Virtual station interface message send address register 1, offset: 0x214, not available in all instances (available on 72 out of 168) */
    } VSI_A;
  };
  ...
  __I  uint32_t SIBLPR[ENETC_SI_SI_BOOT_LOAD_COUNT]; /**< Station interface boot loader parameter register 0..Station interface boot loader parameter register 1, array offset: 0x3F0, array step: 0x4, not available in all instances (available on 72 out of 168) */
  ...
  union {                                          /* offset: 0xA00 */
    struct {                                         /* offset: 0xA00 */
      __IO uint32_t PSIIER;                            /**< Physical station interface interrupt enable register, offset: 0xA00, not available in all instances (available on 24 out of 168) */
           uint8_t RESERVED_0[4];
      __IO uint32_t PSIIDR;                            /**< Physical station interface interrupt detect register, offset: 0xA08, not available in all instances (available on 24 out of 168) */
    } PSI;
    struct {                                         /* offset: 0xA00 */
      __IO uint32_t VSIIER;                            /**< Virtual station interface interrupt enable register, offset: 0xA00, not available in all instances (available on 72 out of 168) */
           uint8_t RESERVED_0[4];
      __IO uint32_t VSIIDR;                            /**< Virtual station interface interrupt detect register, offset: 0xA08, not available in all instances (available on 72 out of 168) */
    } VSI;
  };
  ...
  __IO uint32_t SIMSIVR;                           /**< Station interface MSI-X vector register, offset: 0xA30, not available in all instances (available on 96 out of 168) */
  ...
  __IO uint32_t SIMSITRVR[ENETC_SI_TX_MSI_COUNT];  /**< Station interface MSI-X transmit ring 0 vector register..Station interface MSI-X transmit ring 27 vector register, array offset: 0xB00, array step: 0x4 */
       uint8_t RESERVED_22[16];
  __IO uint32_t SIMSIRRVR[ENETC_SI_RX_GRP_COUNT];  /**< Station interface MSI-X receive ring 0 vector register..Station interface MSI-X receive ring 27 vector register, array offset: 0xB80, array step: 0x4 */
       uint8_t RESERVED_23[528];
  ...
  __IO uint32_t SILSOSFMR1;                        /**< Station interface LSO segmentation flag mask register 1, offset: 0x1304 */
       uint8_t RESERVED_32[760];
  __I  uint32_t SIRSSCAPR;                         /**< Station interface RSS capability register, offset: 0x1600 */
       uint8_t RESERVED_33[27132];
  struct {                                         /* offset: 0x8000, array step: 0x200 */
    __IO uint32_t TBMR;                              /**< Tx BDR 0 mode register..Tx BDR 27 mode register, array offset: 0x8000, array step: 0x200 */
    __IO uint32_t TBSR;                              /**< Tx BDR 0 status register..Tx BDR 27 status register, array offset: 0x8004, array step: 0x200 */
         uint8_t RESERVED_0[8];
    __IO uint32_t TBBAR0;                            /**< Tx BDR 0 base address register 0..Tx BDR 27 base address register 0, array offset: 0x8010, array step: 0x200 */
    __IO uint32_t TBBAR1;                            /**< Tx BDR 0 base address register 1..Tx BDR 27 base address register 1, array offset: 0x8014, array step: 0x200 */
    __IO uint32_t TBPIR;                             /**< Tx BDR 0 producer index register..Tx BDR 27 producer index register, array offset: 0x8018, array step: 0x200 */
    __IO uint32_t TBCIR;                             /**< Tx BDR 0 consumer index register..Tx BDR 27 consumer index register, array offset: 0x801C, array step: 0x200 */
    __IO uint32_t TBLENR;                            /**< Tx BDR 0 length register..Tx BDR 27 length register, array offset: 0x8020, array step: 0x200 */
         uint8_t RESERVED_1[124];
    __IO uint32_t TBIER;                             /**< Tx BDR 0 interrupt enable register..Tx BDR 27 interrupt enable register, array offset: 0x80A0, array step: 0x200 */
    __I  uint32_t TBIDR;                             /**< Tx BDR 0 interrupt detect register..Tx BDR 27 interrupt detect register, array offset: 0x80A4, array step: 0x200 */
    __IO uint32_t TBICR0;                            /**< Tx BDR 0 interrupt coalescing register 0..Tx BDR 27 interrupt coalescing register 0, array offset: 0x80A8, array step: 0x200 */
    __IO uint32_t TBICR1;                            /**< Tx BDR 0 interrupt coalescing register 1..Tx BDR 27 interrupt coalescing register 1, array offset: 0x80AC, array step: 0x200 */
         uint8_t RESERVED_2[80];
    __IO uint32_t RBMR;                              /**< Rx BDR 0 mode register..Rx BDR 27 mode register, array offset: 0x8100, array step: 0x200 */
    __IO uint32_t RBSR;                              /**< Rx BDR 0 status register..Rx BDR 27 status register, array offset: 0x8104, array step: 0x200 */
    __IO uint32_t RBBSR;                             /**< Rx BDR 0 buffer size register..Rx BDR 27 buffer size register, array offset: 0x8108, array step: 0x200 */
    __IO uint32_t RBCIR;                             /**< Rx BDR 0 consumer index register..Rx BDR 27 consumer index register, array offset: 0x810C, array step: 0x200 */
    __IO uint32_t RBBAR0;                            /**< Rx BDR 0 base address register 0..Rx BDR 27 base address register 0, array offset: 0x8110, array step: 0x200 */
    __IO uint32_t RBBAR1;                            /**< Rx BDR 0 base address register 1..Rx BDR 27 base address register 1, array offset: 0x8114, array step: 0x200 */
    __IO uint32_t RBPIR;                             /**< Rx BDR 0 producer index register..Rx BDR 27 producer index register, array offset: 0x8118, array step: 0x200 */
         uint8_t RESERVED_3[4];
    __IO uint32_t RBLENR;                            /**< Rx BDR 0 length register..Rx BDR 27 length register, array offset: 0x8120, array step: 0x200 */
         uint8_t RESERVED_4[12];
    __IO uint32_t RBRSCR;                            /**< Rx BDR 0 RSC register..Rx BDR 27 RSC register, array offset: 0x8130, array step: 0x200 */
         uint8_t RESERVED_5[76];
    __I  uint32_t RBDCR;                             /**< Rx BDR 0 drop count register..Rx BDR 27 drop count register, array offset: 0x8180, array step: 0x200 */
         uint8_t RESERVED_6[28];
    __IO uint32_t RBIER;                             /**< Rx BDR 0 interrupt enable register..Rx BDR 27 interrupt enable register, array offset: 0x81A0, array step: 0x200 */
    __I  uint32_t RBIDR;                             /**< Rx BDR 0 interrupt detect register..Rx BDR 27 interrupt detect register, array offset: 0x81A4, array step: 0x200 */
    __IO uint32_t RBICR0;                            /**< Rx BDR 0 interrupt coalescing register 0..Rx BDR 27 interrupt coalescing register 0, array offset: 0x81A8, array step: 0x200 */
    __IO uint32_t RBICR1;                            /**< Rx BDR 0 interrupt coalescing register 1..Rx BDR 27 interrupt coalescing register 1, array offset: 0x81AC, array step: 0x200 */
...
#define ENETC_SI_SIMR_DEFAULT_RX_GROUP_MASK      (0x30000U)
...
#define ENETC_SI_PSIMSGRR_MR3_MASK               (0x8U)
#define ENETC_SI_PSIMSGRR_MR3_SHIFT              (3U)
#define ENETC_SI_PSIMSGRR_MR3(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_SI_PSIMSGRR_MR3_SHIFT)) & ENETC_SI_PSIMSGRR_MR3_MASK)
...
#define ENETC_SI_PSIMSGSR_MS3_MASK               (0x8U)
#define ENETC_SI_PSIMSGSR_MS3_SHIFT              (3U)
#define ENETC_SI_PSIMSGSR_MS3(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_SI_PSIMSGSR_MS3_SHIFT)) & ENETC_SI_PSIMSGSR_MS3_MASK)
...
/*! @name PSIVMSGRCVAR0 - PSI VSI 1 message receive address register 0..PSI VSI 3 message receive address register 0 */
/*! @{ */
...
#define ENETC_SI_PSIVMSGRCVAR0_COUNT             (3U)

/*! @name PSIVMSGRCVAR1 - PSI VSI 1 message receive address register 1..PSI VSI 3 message receive address register 1 */
/*! @{ */
...
#define ENETC_SI_PSIVMSGRCVAR1_COUNT             (3U)
...
#define ENETC_SI_PSIIER_MR3IE_MASK               (0x8U)
#define ENETC_SI_PSIIER_MR3IE_SHIFT              (3U)
#define ENETC_SI_PSIIER_MR3IE(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_SI_PSIIER_MR3IE_SHIFT)) & ENETC_SI_PSIIER_MR3IE_MASK)
...
#define ENETC_SI_PSIIER_FLR3IE_MASK              (0x80000U)
#define ENETC_SI_PSIIER_FLR3IE_SHIFT             (19U)
#define ENETC_SI_PSIIER_FLR3IE(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_SI_PSIIER_FLR3IE_SHIFT)) & ENETC_SI_PSIIER_FLR3IE_MASK)
/*! @} */
...
#define ENETC_SI_PSIIDR_MR3_MASK                 (0x8U)
#define ENETC_SI_PSIIDR_MR3_SHIFT                (3U)
#define ENETC_SI_PSIIDR_MR3(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_SI_PSIIDR_MR3_SHIFT)) & ENETC_SI_PSIIDR_MR3_MASK)
...
#define ENETC_SI_PSIIDR_FLR3_MASK                (0x80000U)
#define ENETC_SI_PSIIDR_FLR3_SHIFT               (19U)
#define ENETC_SI_PSIIDR_FLR3(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_SI_PSIIDR_FLR3_SHIFT)) & ENETC_SI_PSIIDR_FLR3_MASK)
/*! @} */
...
#define ENETC_SI_SITXIDR1_TXT24_MASK             (0x100U)
#define ENETC_SI_SITXIDR1_TXT24_SHIFT            (8U)
#define ENETC_SI_SITXIDR1_TXT24(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXT24_SHIFT)) & ENETC_SI_SITXIDR1_TXT24_MASK)

#define ENETC_SI_SITXIDR1_TXT25_MASK             (0x200U)
#define ENETC_SI_SITXIDR1_TXT25_SHIFT            (9U)
#define ENETC_SI_SITXIDR1_TXT25(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXT25_SHIFT)) & ENETC_SI_SITXIDR1_TXT25_MASK)

#define ENETC_SI_SITXIDR1_TXT26_MASK             (0x400U)
#define ENETC_SI_SITXIDR1_TXT26_SHIFT            (10U)
#define ENETC_SI_SITXIDR1_TXT26(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXT26_SHIFT)) & ENETC_SI_SITXIDR1_TXT26_MASK)

#define ENETC_SI_SITXIDR1_TXT27_MASK             (0x800U)
#define ENETC_SI_SITXIDR1_TXT27_SHIFT            (11U)
#define ENETC_SI_SITXIDR1_TXT27(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXT27_SHIFT)) & ENETC_SI_SITXIDR1_TXT27_MASK)
...
#define ENETC_SI_SITXIDR1_TXF24_MASK             (0x1000000U)
#define ENETC_SI_SITXIDR1_TXF24_SHIFT            (24U)
#define ENETC_SI_SITXIDR1_TXF24(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXF24_SHIFT)) & ENETC_SI_SITXIDR1_TXF24_MASK)

#define ENETC_SI_SITXIDR1_TXF25_MASK             (0x2000000U)
#define ENETC_SI_SITXIDR1_TXF25_SHIFT            (25U)
#define ENETC_SI_SITXIDR1_TXF25(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXF25_SHIFT)) & ENETC_SI_SITXIDR1_TXF25_MASK)

#define ENETC_SI_SITXIDR1_TXF26_MASK             (0x4000000U)
#define ENETC_SI_SITXIDR1_TXF26_SHIFT            (26U)
#define ENETC_SI_SITXIDR1_TXF26(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXF26_SHIFT)) & ENETC_SI_SITXIDR1_TXF26_MASK)

#define ENETC_SI_SITXIDR1_TXF27_MASK             (0x8000000U)
#define ENETC_SI_SITXIDR1_TXF27_SHIFT            (27U)
#define ENETC_SI_SITXIDR1_TXF27(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SITXIDR1_TXF27_SHIFT)) & ENETC_SI_SITXIDR1_TXF27_MASK)
/*! @} */
...
#define ENETC_SI_SIRXIDR0_RX24_MASK              (0x1000000U)
#define ENETC_SI_SIRXIDR0_RX24_SHIFT             (24U)
#define ENETC_SI_SIRXIDR0_RX24(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRXIDR0_RX24_SHIFT)) & ENETC_SI_SIRXIDR0_RX24_MASK)

#define ENETC_SI_SIRXIDR0_RX25_MASK              (0x2000000U)
#define ENETC_SI_SIRXIDR0_RX25_SHIFT             (25U)
#define ENETC_SI_SIRXIDR0_RX25(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRXIDR0_RX25_SHIFT)) & ENETC_SI_SIRXIDR0_RX25_MASK)

#define ENETC_SI_SIRXIDR0_RX26_MASK              (0x4000000U)
#define ENETC_SI_SIRXIDR0_RX26_SHIFT             (26U)
#define ENETC_SI_SIRXIDR0_RX26(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRXIDR0_RX26_SHIFT)) & ENETC_SI_SIRXIDR0_RX26_MASK)

#define ENETC_SI_SIRXIDR0_RX27_MASK              (0x8000000U)
#define ENETC_SI_SIRXIDR0_RX27_SHIFT             (27U)
#define ENETC_SI_SIRXIDR0_RX27(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRXIDR0_RX27_SHIFT)) & ENETC_SI_SIRXIDR0_RX27_MASK)
/*! @} */
...
/*! @name SIMSITRVR - Station interface MSI-X transmit ring 0 vector register..Station interface MSI-X transmit ring 27 vector register */
/*! @{ */
...
#define ENETC_SI_SIMSITRVR_COUNT                 (28U)

/*! @name SIMSIRRVR - Station interface MSI-X receive ring 0 vector register..Station interface MSI-X receive ring 27 vector register */
/*! @{ */
...
#define ENETC_SI_SIMSIRRVR_COUNT                 (28U)
...
#define ENETC_SI_SIMAFTCAPR_VERSIONS_MASK        (0xFFFF0000U)
#define ENETC_SI_SIMAFTCAPR_VERSIONS_SHIFT       (16U)
/*! VERSIONS - Table Version */
#define ENETC_SI_SIMAFTCAPR_VERSIONS(x)          (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIMAFTCAPR_VERSIONS_SHIFT)) & ENETC_SI_SIMAFTCAPR_VERSIONS_MASK)
/*! @} */
...
#define ENETC_SI_SIVFTCAPR_VERSIONS_MASK         (0xFFFF0000U)
#define ENETC_SI_SIVFTCAPR_VERSIONS_SHIFT        (16U)
/*! VERSIONS - Table Version */
#define ENETC_SI_SIVFTCAPR_VERSIONS(x)           (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIVFTCAPR_VERSIONS_SHIFT)) & ENETC_SI_SIVFTCAPR_VERSIONS_MASK)
/*! @} */

/*! @name SIRFSCAPR - Station interface RFS capability register */
/*! @{ */

#define ENETC_SI_SIRFSCAPR_NUM_RFS_MASK          (0x1FFU)
#define ENETC_SI_SIRFSCAPR_NUM_RFS_SHIFT         (0U)
#define ENETC_SI_SIRFSCAPR_NUM_RFS(x)            (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRFSCAPR_NUM_RFS_SHIFT)) & ENETC_SI_SIRFSCAPR_NUM_RFS_MASK)

#define ENETC_SI_SIRFSCAPR_VERSIONS_MASK         (0xFFFF0000U)
#define ENETC_SI_SIRFSCAPR_VERSIONS_SHIFT        (16U)
/*! VERSIONS - Table Versions */
#define ENETC_SI_SIRFSCAPR_VERSIONS(x)           (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRFSCAPR_VERSIONS_SHIFT)) & ENETC_SI_SIRFSCAPR_VERSIONS_MASK)
/*! @} */
...
#define ENETC_SI_SIRSSCAPR_VERSIONS_MASK         (0xFFFF0000U)
#define ENETC_SI_SIRSSCAPR_VERSIONS_SHIFT        (16U)
#define ENETC_SI_SIRSSCAPR_VERSIONS(x)           (((uint32_t)(((uint32_t)(x)) << ENETC_SI_SIRSSCAPR_VERSIONS_SHIFT)) & ENETC_SI_SIRSSCAPR_VERSIONS_MASK)
/*! @} */

/*! @name TBMR - Tx BDR 0 mode register..Tx BDR 27 mode register */
/*! @{ */
...
#define ENETC_SI_TBMR_COUNT                      (28U)

/*! @name TBSR - Tx BDR 0 status register..Tx BDR 27 status register */
/*! @{ */
...
#define ENETC_SI_TBSR_COUNT                      (28U)

/*! @name TBBAR0 - Tx BDR 0 base address register 0..Tx BDR 27 base address register 0 */
/*! @{ */
...
#define ENETC_SI_TBBAR0_COUNT                    (28U)

/*! @name TBBAR1 - Tx BDR 0 base address register 1..Tx BDR 27 base address register 1 */
/*! @{ */
...
#define ENETC_SI_TBBAR1_COUNT                    (28U)

/*! @name TBPIR - Tx BDR 0 producer index register..Tx BDR 27 producer index register */
/*! @{ */
...
#define ENETC_SI_TBPIR_COUNT                     (28U)

/*! @name TBCIR - Tx BDR 0 consumer index register..Tx BDR 27 consumer index register */
/*! @{ */
...
#define ENETC_SI_TBCIR_COUNT                     (28U)

/*! @name TBLENR - Tx BDR 0 length register..Tx BDR 27 length register */
/*! @{ */
...
#define ENETC_SI_TBLENR_COUNT                    (28U)

/*! @name TBIER - Tx BDR 0 interrupt enable register..Tx BDR 27 interrupt enable register */
/*! @{ */
...
#define ENETC_SI_TBIER_COUNT                     (28U)

/*! @name TBIDR - Tx BDR 0 interrupt detect register..Tx BDR 27 interrupt detect register */
/*! @{ */
...
#define ENETC_SI_TBIDR_COUNT                     (28U)

/*! @name TBICR0 - Tx BDR 0 interrupt coalescing register 0..Tx BDR 27 interrupt coalescing register 0 */
/*! @{ */
...
#define ENETC_SI_TBICR0_COUNT                    (28U)

/*! @name TBICR1 - Tx BDR 0 interrupt coalescing register 1..Tx BDR 27 interrupt coalescing register 1 */
/*! @{ */
...
#define ENETC_SI_TBICR1_COUNT                    (28U)

/*! @name RBMR - Rx BDR 0 mode register..Rx BDR 27 mode register */
/*! @{ */
...
#define ENETC_SI_RBMR_COUNT                      (28U)

/*! @name RBSR - Rx BDR 0 status register..Rx BDR 27 status register */
/*! @{ */
...
#define ENETC_SI_RBSR_COUNT                      (28U)

/*! @name RBBSR - Rx BDR 0 buffer size register..Rx BDR 27 buffer size register */
/*! @{ */
...
#define ENETC_SI_RBBSR_COUNT                     (28U)

/*! @name RBCIR - Rx BDR 0 consumer index register..Rx BDR 27 consumer index register */
/*! @{ */
...
#define ENETC_SI_RBCIR_COUNT                     (28U)

/*! @name RBBAR0 - Rx BDR 0 base address register 0..Rx BDR 27 base address register 0 */
/*! @{ */
...
#define ENETC_SI_RBBAR0_COUNT                    (28U)

/*! @name RBBAR1 - Rx BDR 0 base address register 1..Rx BDR 27 base address register 1 */
/*! @{ */
...
#define ENETC_SI_RBBAR1_COUNT                    (28U)

/*! @name RBPIR - Rx BDR 0 producer index register..Rx BDR 27 producer index register */
/*! @{ */
...
#define ENETC_SI_RBPIR_COUNT                     (28U)

/*! @name RBLENR - Rx BDR 0 length register..Rx BDR 27 length register */
/*! @{ */
...
#define ENETC_SI_RBLENR_COUNT                    (28U)

/*! @name RBRSCR - Rx BDR 0 RSC register..Rx BDR 27 RSC register */
/*! @{ */
...
#define ENETC_SI_RBRSCR_COUNT                    (28U)

/*! @name RBDCR - Rx BDR 0 drop count register..Rx BDR 27 drop count register */
/*! @{ */
...
#define ENETC_SI_BDR_RBDCR_COUNT                 (28U)

/*! @name RBIER - Rx BDR 0 interrupt enable register..Rx BDR 27 interrupt enable register */
/*! @{ */
...
#define ENETC_SI_RBIER_COUNT                     (28U)

/*! @name RBIDR - Rx BDR 0 interrupt detect register..Rx BDR 27 interrupt detect register */
/*! @{ */
...
#define ENETC_SI_RBIDR_COUNT                     (28U)

/*! @name RBICR0 - Rx BDR 0 interrupt coalescing register 0..Rx BDR 27 interrupt coalescing register 0 */
/*! @{ */
...
#define ENETC_SI_RBICR0_COUNT                    (28U)

/*! @name RBICR1 - Rx BDR 0 interrupt coalescing register 1..Rx BDR 27 interrupt coalescing register 1 */
/*! @{ */
...
#define ENETC_SI_RBICR1_COUNT                    (28U)
