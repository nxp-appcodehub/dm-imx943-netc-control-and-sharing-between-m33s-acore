...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for SRC_GEN
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for SRC_GEN
 *
 * CMSIS Peripheral Access Layer for SRC_GEN
 */

#if !defined(SRC_GEN_H_)
#define SRC_GEN_H_                               /**< Symbol preventing repeated inclusion */
...
/** SRC_GEN - Size of Registers Arrays */
#define SRC_GEN_SRMR_ARRAY_COUNT                  23u
...
typedef struct {
  ...
  __IO uint32_t SRMR[SRC_GEN_SRMR_ARRAY_COUNT];    /**< SRC Reset Mode Register (SRMR), array offset: 0x120, array step: 0x4 */
