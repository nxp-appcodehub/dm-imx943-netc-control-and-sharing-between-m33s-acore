...
#define IRQSTEER_CH_CHN_MASK_COUNT                30u
#define IRQSTEER_CH_CHN_SET_COUNT                 30u
#define IRQSTEER_CH_CHN_STATUS_COUNT              30u
#define IRQSTEER_CH_COUNT                         2u

/** IRQSTEER - Register Layout Typedef */
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x10000 */
         uint8_t RESERVED_0[4];
    __IO uint32_t CHN_MASK[IRQSTEER_CH_CHN_MASK_COUNT];   /**< Channel 0 Interrupt Mask..Channel 1 Interrupt Mask, array offset: 0x4, array step: index*0x10000, index2*0x4 */
    __IO uint32_t CHN_SET[IRQSTEER_CH_CHN_SET_COUNT];   /**< Channel 0 Interrupt Set..Channel 1 Interrupt Set, array offset: 0x7C, array step: index*0x10000, index2*0x4 */
    __I  uint32_t CHN_STATUS[IRQSTEER_CH_CHN_STATUS_COUNT];   /**< Channel 0 Interrupt Status..Channel 1 Interrupt Status, array offset: 0xF4, array step: index*0x10000, index2*0x4 */
    __IO uint32_t CHN_MINTDIS;                       /**< Channel 0 Group Interrupt Disable..Channel 1 Group Interrupt Disable, array offset: 0x16C, array step: 0x10000 */
    __I  uint32_t CHN_MSTRSTAT;                      /**< Channel 0 Group Status..Channel 1 Group Status, array offset: 0x170, array step: 0x10000 */
         uint8_t RESERVED_1[65164];
  } CH[IRQSTEER_CH_COUNT];
} IRQSTEER_Type;
...
/*! @name CHN_MASK - Channel 0 Interrupt Mask..Channel 1 Interrupt Mask */
/*! @{ */
...
#define IRQSTEER_CHN_MASK_COUNT                  (2U)

/* The count of IRQSTEER_CHN_MASK */
#define IRQSTEER_CHN_MASK_COUNT2                 (30U)

/*! @name CHN_SET - Channel 0 Interrupt Set..Channel 1 Interrupt Set */
/*! @{ */
...
#define IRQSTEER_CHN_SET_COUNT                   (2U)

/* The count of IRQSTEER_CHN_SET */
#define IRQSTEER_CHN_SET_COUNT2                  (30U)

/*! @name CHN_STATUS - Channel 0 Interrupt Status..Channel 1 Interrupt Status */
/*! @{ */
...
#define IRQSTEER_CHN_STATUS_COUNT                (2U)

/* The count of IRQSTEER_CHN_STATUS */
#define IRQSTEER_CHN_STATUS_COUNT2               (30U)

/*! @name CHN_MINTDIS - Channel 0 Group Interrupt Disable..Channel 1 Group Interrupt Disable */
/*! @{ */

#define IRQSTEER_CHN_MINTDIS_DISABLE_MASK        (0x7FFFU)
...
/* The count of IRQSTEER_CHN_MINTDIS */
#define IRQSTEER_CHN_MINTDIS_COUNT               (2U)

/*! @name CHN_MSTRSTAT - Channel 0 Group Status..Channel 1 Group Status */
/*! @{ */

#define IRQSTEER_CHN_MSTRSTAT_STATUS_MASK        (0x1U)
#define IRQSTEER_CHN_MSTRSTAT_STATUS_SHIFT       (0U)
/*! STATUS - Group Interrupt Status
 *  0b0..No interrupts asserted
 *  0b1..At least one interrupt asserted
 */
...
/* The count of IRQSTEER_CHN_MSTRSTAT */
#define IRQSTEER_CHN_MSTRSTAT_COUNT              (2U)
