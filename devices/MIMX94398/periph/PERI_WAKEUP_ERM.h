...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for WAKEUP_ERM
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for WAKEUP_ERM
 *
 * CMSIS Peripheral Access Layer for WAKEUP_ERM
 */

#if !defined(WAKEUP_ERM_H_)
#define WAKEUP_ERM_H_                            /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- WAKEUP_ERM Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup WAKEUP_ERM_Peripheral_Access_Layer WAKEUP_ERM Peripheral Access Layer
 * @{
 */

/** WAKEUP_ERM - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- WAKEUP_ERM Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup WAKEUP_ERM_Register_Masks WAKEUP_ERM Register Masks
 * @{
 */
...
#define WAKEUP_ERM_CR0_ENCIE0_MASK               (0x40000000U)
#define WAKEUP_ERM_CR0_ENCIE0_SHIFT              (30U)
/*! ENCIE0 - ENCIE0
 ...
 */
#define WAKEUP_ERM_CR0_ENCIE0(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_CR0_ENCIE0_SHIFT)) & WAKEUP_ERM_CR0_ENCIE0_MASK)

#define WAKEUP_ERM_CR0_ESCIE0_MASK               (0x80000000U)
#define WAKEUP_ERM_CR0_ESCIE0_SHIFT              (31U)
/*! ESCIE0 - ESCIE0
 ...
 */
#define WAKEUP_ERM_CR0_ESCIE0(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_CR0_ESCIE0_SHIFT)) & WAKEUP_ERM_CR0_ESCIE0_MASK)
/*! @} */

/*! @name CR1 - ERM Configuration Register 1 */
/*! @{ */

#define WAKEUP_ERM_CR1_ENCIE9_MASK               (0x4000000U)
#define WAKEUP_ERM_CR1_ENCIE9_SHIFT              (26U)
/*! ENCIE9 - ENCIE9
 ...
 */
#define WAKEUP_ERM_CR1_ENCIE9(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_CR1_ENCIE9_SHIFT)) & WAKEUP_ERM_CR1_ENCIE9_MASK)

#define WAKEUP_ERM_CR1_ESCIE9_MASK               (0x8000000U)
#define WAKEUP_ERM_CR1_ESCIE9_SHIFT              (27U)
/*! ESCIE9 - ESCIE9
 ...
 */
#define WAKEUP_ERM_CR1_ESCIE9(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_CR1_ESCIE9_SHIFT)) & WAKEUP_ERM_CR1_ESCIE9_MASK)
/*! @} */

/*! @name SR0 - ERM Status Register 0 */
/*! @{ */

#define WAKEUP_ERM_SR0_NCE0_MASK                 (0x40000000U)
#define WAKEUP_ERM_SR0_NCE0_SHIFT                (30U)
/*! NCE0 - NCE0
 *  0b0..No non-correctable error event on Memory 0 detected.
 *  0b1..Non-correctable error event on Memory 0 detected.
 */
#define WAKEUP_ERM_SR0_NCE0(x)                   (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_SR0_NCE0_SHIFT)) & WAKEUP_ERM_SR0_NCE0_MASK)

#define WAKEUP_ERM_SR0_SBC0_MASK                 (0x80000000U)
#define WAKEUP_ERM_SR0_SBC0_SHIFT                (31U)
/*! SBC0 - SBC0
 *  0b0..No single-bit correction event on Memory 0 detected.
 *  0b1..Single-bit correction event on Memory 0 detected.
 */
#define WAKEUP_ERM_SR0_SBC0(x)                   (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_SR0_SBC0_SHIFT)) & WAKEUP_ERM_SR0_SBC0_MASK)
/*! @} */

/*! @name SR1 - ERM Status Register 1 */
/*! @{ */

#define WAKEUP_ERM_SR1_NCE9_MASK                 (0x4000000U)
#define WAKEUP_ERM_SR1_NCE9_SHIFT                (26U)
/*! NCE9 - NCE9
 *  0b0..No non-correctable error event on Memory 9 detected.
 *  0b1..Non-correctable error event on Memory 9 detected.
 */
#define WAKEUP_ERM_SR1_NCE9(x)                   (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_SR1_NCE9_SHIFT)) & WAKEUP_ERM_SR1_NCE9_MASK)

#define WAKEUP_ERM_SR1_SBC9_MASK                 (0x8000000U)
#define WAKEUP_ERM_SR1_SBC9_SHIFT                (27U)
/*! SBC9 - SBC9
 *  0b0..No single-bit correction event on Memory 9 detected.
 *  0b1..Single-bit correction event on Memory 9 detected.
 */
#define WAKEUP_ERM_SR1_SBC9(x)                   (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_SR1_SBC9_SHIFT)) & WAKEUP_ERM_SR1_SBC9_MASK)
/*! @} */

/*! @name EAR0 - ERM Memory 0 Error Address Register */
/*! @{ */

#define WAKEUP_ERM_EAR0_EAR_MASK                 (0xFFFFFFFFU)
#define WAKEUP_ERM_EAR0_EAR_SHIFT                (0U)
/*! EAR - EAR */
#define WAKEUP_ERM_EAR0_EAR(x)                   (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_EAR0_EAR_SHIFT)) & WAKEUP_ERM_EAR0_EAR_MASK)
/*! @} */

/*! @name SYN0 - ERM Memory 0 Syndrome Register */
/*! @{ */

#define WAKEUP_ERM_SYN0_SYNDROME_MASK            (0xFF000000U)
#define WAKEUP_ERM_SYN0_SYNDROME_SHIFT           (24U)
/*! SYNDROME - SYNDROME */
#define WAKEUP_ERM_SYN0_SYNDROME(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_SYN0_SYNDROME_SHIFT)) & WAKEUP_ERM_SYN0_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT0 - ERM Memory 0 Correctable Error Count Register */
/*! @{ */

#define WAKEUP_ERM_CORR_ERR_CNT0_COUNT_MASK      (0xFFU)
#define WAKEUP_ERM_CORR_ERR_CNT0_COUNT_SHIFT     (0U)
/*! COUNT - Memory n Correctable Error Count */
#define WAKEUP_ERM_CORR_ERR_CNT0_COUNT(x)        (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_CORR_ERR_CNT0_COUNT_SHIFT)) & WAKEUP_ERM_CORR_ERR_CNT0_COUNT_MASK)
/*! @} */

/*! @name EAR9 - ERM Memory 9 Error Address Register */
/*! @{ */

#define WAKEUP_ERM_EAR9_EAR_MASK                 (0xFFFFFFFFU)
#define WAKEUP_ERM_EAR9_EAR_SHIFT                (0U)
/*! EAR - EAR */
#define WAKEUP_ERM_EAR9_EAR(x)                   (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_EAR9_EAR_SHIFT)) & WAKEUP_ERM_EAR9_EAR_MASK)
/*! @} */

/*! @name SYN9 - ERM Memory 9 Syndrome Register */
/*! @{ */

#define WAKEUP_ERM_SYN9_SYNDROME_MASK            (0xFF000000U)
#define WAKEUP_ERM_SYN9_SYNDROME_SHIFT           (24U)
/*! SYNDROME - SYNDROME */
#define WAKEUP_ERM_SYN9_SYNDROME(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_SYN9_SYNDROME_SHIFT)) & WAKEUP_ERM_SYN9_SYNDROME_MASK)
/*! @} */

/*! @name CORR_ERR_CNT9 - ERM Memory 9 Correctable Error Count Register */
/*! @{ */

#define WAKEUP_ERM_CORR_ERR_CNT9_COUNT_MASK      (0xFFU)
#define WAKEUP_ERM_CORR_ERR_CNT9_COUNT_SHIFT     (0U)
/*! COUNT - Memory n Correctable Error Count */
#define WAKEUP_ERM_CORR_ERR_CNT9_COUNT(x)        (((uint32_t)(((uint32_t)(x)) << WAKEUP_ERM_CORR_ERR_CNT9_COUNT_SHIFT)) & WAKEUP_ERM_CORR_ERR_CNT9_COUNT_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group WAKEUP_ERM_Register_Masks */


/*!
 * @}
 */ /* end of group WAKEUP_ERM_Peripheral_Access_Layer */
