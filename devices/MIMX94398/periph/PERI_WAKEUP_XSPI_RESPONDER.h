...
#if !defined(WAKEUP_XSPI_RESPONDER_H_)
#define WAKEUP_XSPI_RESPONDER_H_                 /**< Symbol preventing repeated inclusion */
...
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_RADDR_OFR_MASK (0x8U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_RADDR_OFR_SHIFT (3U)
/*! RADDR_OFR - Read Address Out-of-Range
 *  0b0..Did not occur
 *  0b1..Occurred
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_RADDR_OFR(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INT_RADDR_OFR_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INT_RADDR_OFR_MASK)

#define WAKEUP_XSPI_RESPONDER_MODULE_INT_WADDR_OFR_MASK (0x10U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_WADDR_OFR_SHIFT (4U)
/*! WADDR_OFR - Write Address Out-of-Range
 *  0b0..Did not occur
 *  0b1..Occurred
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_WADDR_OFR(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INT_WADDR_OFR_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INT_WADDR_OFR_MASK)

#define WAKEUP_XSPI_RESPONDER_MODULE_INT_RD_DONE_MASK (0x20U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_RD_DONE_SHIFT (5U)
/*! RD_DONE - AXI Read Leader Done
 *  0b0..Read is not done
 *  0b1..Read is done
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_RD_DONE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INT_RD_DONE_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INT_RD_DONE_MASK)

#define WAKEUP_XSPI_RESPONDER_MODULE_INT_WR_DONE_MASK (0x40U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_WR_DONE_SHIFT (6U)
/*! WR_DONE - AXI Write Leader Done
 *  0b0..Write is not done
 *  0b1..Write is done
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INT_WR_DONE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INT_WR_DONE_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INT_WR_DONE_MASK)
/*! @} */
...
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RADDR_OFREN_MASK (0x8U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RADDR_OFREN_SHIFT (3U)
/*! RADDR_OFREN - Read Address Out-of-Range Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RADDR_OFREN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RADDR_OFREN_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RADDR_OFREN_MASK)

#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WADDR_OFREN_MASK (0x10U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WADDR_OFREN_SHIFT (4U)
/*! WADDR_OFREN - Write Address Out-of-Range Interrupt Enable
 *  0b0..DISABLE
 *  0b1..Enable
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WADDR_OFREN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WADDR_OFREN_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WADDR_OFREN_MASK)

#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RD_DONEEN_MASK (0x20U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RD_DONEEN_SHIFT (5U)
/*! RD_DONEEN - AXI Read Leader Done Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RD_DONEEN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RD_DONEEN_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INTEN_RD_DONEEN_MASK)

#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WR_DONEEN_MASK (0x40U)
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WR_DONEEN_SHIFT (6U)
/*! WR_DONEEN - AXI Write Leader Done Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WR_DONEEN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WR_DONEEN_SHIFT)) & WAKEUP_XSPI_RESPONDER_MODULE_INTEN_WR_DONEEN_MASK)
/*! @} */
...
#endif  /* WAKEUP_XSPI_RESPONDER_H_ */
