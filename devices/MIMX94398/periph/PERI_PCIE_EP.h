...
typedef struct {
  __I  uint32_t DEVICE_ID_VENDOR_ID_REG;           /**< Device ID , RCRB next offset pointer and Vendor ID Register., offset: 0x0 */
  __IO uint32_t STATUS_COMMAND_REG;                /**< Status and Command Register., offset: 0x4 */
  __I  uint32_t CLASS_CODE_REVISION_ID;            /**< Class Code and Revision ID Register., offset: 0x8 */
  ...
  __IO uint32_t BAR2_REG;                          /**< BAR2 Register., offset: 0x18 */
  __IO uint32_t BAR3_REG;                          /**< BAR3 Register., offset: 0x1C */
  __IO uint32_t BAR4_REG;                          /**< BAR4 Register., offset: 0x20 */
  __IO uint32_t BAR5_REG;                          /**< BAR5 Register., offset: 0x24 */
  ...
  __I  uint32_t LTR_CAP_HDR_REG;                   /**< LTR Extended Capability Header., offset: 0x158 */
  __IO uint32_t LTR_LATENCY_REG;                   /**< LTR Max Snoop and No-Snoop Latency Register., offset: 0x15C */
...
/*! @name DEVICE_ID_VENDOR_ID_REG - Device ID , RCRB next offset pointer and Vendor ID Register. */
/*! @{ */
...
/*! PCI_TYPE0_DEVICE_ID - DEVICE_ID [31:16] */
...
/*! PCI_TYPE0_IO_EN - IO Space Enable. */
...
/*! PCI_TYPE0_MEM_SPACE_EN - Memory Space Enable. */
...
/*! PCI_TYPE0_BUS_MASTER_EN - Bus Master Enable. */
...
/*! PCI_TYPE0_SPECIAL_CYCLE_OPERATION - Special Cycle Enable. */
...
/*! PCI_TYPE_MWI_ENABLE - Memory Write and Invalidate. */
...
/*! PCI_TYPE_VGA_PALETTE_SNOOP - VGA Palette Snoop. */
...
/*! PCI_TYPE0_PARITY_ERR_EN - Parity Error Response. */
...
/*! PCI_TYPE_IDSEL_STEPPING - IDSEL Stepping/Wait Cycle Control. */
...
/*! PCI_TYPE0_INT_EN - Interrupt Disable. */
...
/*! INT_STATUS - Emulation interrupt pending. */
...
/*! FAST_B2B_CAP - Fast Back to Back Transaction Capable. */
 ...
 *  0b1..This bit is set when a Function completes a Posted or Non-Posted Request as a Completer Abort error.
 */
 ...
 *  0b1..This bit is set when a Requester receives a Completion with Completer Abort Completion Status.
 */
 ...
 *  0b1..This bit is set when a Requester receives a Completion with Unsupported Request Completion Status.
 */
...
/*! SIGNALED_SYS_ERR - Signaled System Error.
...
/*! DETECTED_PARITY_ERR - Detected Parity Error.
...
/*! @name CLASS_CODE_REVISION_ID - Class Code and Revision ID Register. */
/*! @{ */
...
/*! BAR2_PREFETCH - BAR2 Prefetchable. */
...
/*! BAR3_MEM_IO - BAR3 Memory Space Indicator. */
...
/*! BAR3_PREFETCH - BAR3 Prefetchable. */
...
/*! BAR4_PREFETCH - BAR4 Prefetchable. */
...
/*! BAR5_PREFETCH - BAR5 Prefetchable. */
...
/*! CARDBUS_CIS_POINTER - CardBus CIS Pointer. */
...
/*! SUBSYS_VENDOR_ID - Subsystem Vendor ID. */
...
/*! PCIE_CAP_CAP_SLOT_PWR_LMT_VALUE - Captured Slot Power Limit Value. */
...
/*! PCIE_CAP_FLR_CAP - Function Level Reset Capability. */
...
#define PCIE_EP_DEVICE_CONTROL_DEVICE_STATUS_PCIE_CAP_INITIATE_FLR_MASK (0x8000U)
#define PCIE_EP_DEVICE_CONTROL_DEVICE_STATUS_PCIE_CAP_INITIATE_FLR_SHIFT (15U)
/*! PCIE_CAP_INITIATE_FLR - Initiate Function Level Reset. */
#define PCIE_EP_DEVICE_CONTROL_DEVICE_STATUS_PCIE_CAP_INITIATE_FLR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_DEVICE_CONTROL_DEVICE_STATUS_PCIE_CAP_INITIATE_FLR_SHIFT)) & PCIE_EP_DEVICE_CONTROL_DEVICE_STATUS_PCIE_CAP_INITIATE_FLR_MASK)
...
#define PCIE_EP_DEVICE_CAPABILITIES2_REG_PCIE_CAP_DMWR_CPL_SUPP_MASK (0x10000000U)
#define PCIE_EP_DEVICE_CAPABILITIES2_REG_PCIE_CAP_DMWR_CPL_SUPP_SHIFT (28U)
/*! PCIE_CAP_DMWR_CPL_SUPP - Deferrable Memory Write (DMWr) Completer Supported. */
#define PCIE_EP_DEVICE_CAPABILITIES2_REG_PCIE_CAP_DMWR_CPL_SUPP(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_DEVICE_CAPABILITIES2_REG_PCIE_CAP_DMWR_CPL_SUPP_SHIFT)) & PCIE_EP_DEVICE_CAPABILITIES2_REG_PCIE_CAP_DMWR_CPL_SUPP_MASK)
...
#define PCIE_EP_DEVICE_CONTROL2_DEVICE_STATUS2_REG_PCIE_CAP_LTR_EN_MASK (0x400U)
#define PCIE_EP_DEVICE_CONTROL2_DEVICE_STATUS2_REG_PCIE_CAP_LTR_EN_SHIFT (10U)
/*! PCIE_CAP_LTR_EN - LTR Mechanism Enable. */
#define PCIE_EP_DEVICE_CONTROL2_DEVICE_STATUS2_REG_PCIE_CAP_LTR_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_DEVICE_CONTROL2_DEVICE_STATUS2_REG_PCIE_CAP_LTR_EN_SHIFT)) & PCIE_EP_DEVICE_CONTROL2_DEVICE_STATUS2_REG_PCIE_CAP_LTR_EN_MASK)
/*! @} */
...
/*! ATOMIC_EGRESS_BLOCKED_ERR_MASK - AtomicOp Egress Block Mask (Optional). */
...
/*! TLP_PRFX_BLOCKED_ERR_MASK - TLP Prefix Blocked Error Mask. */
...
#define PCIE_EP_UNCORR_ERR_MASK_OFF_DMWR_EGRESS_BLOCKED_ERR_MASK_MASK (0x8000000U)
#define PCIE_EP_UNCORR_ERR_MASK_OFF_DMWR_EGRESS_BLOCKED_ERR_MASK_SHIFT (27U)
/*! DMWR_EGRESS_BLOCKED_ERR_MASK - Deferrable Memory Write Egress Block Mask (Optional). */
#define PCIE_EP_UNCORR_ERR_MASK_OFF_DMWR_EGRESS_BLOCKED_ERR_MASK(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_UNCORR_ERR_MASK_OFF_DMWR_EGRESS_BLOCKED_ERR_MASK_SHIFT)) & PCIE_EP_UNCORR_ERR_MASK_OFF_DMWR_EGRESS_BLOCKED_ERR_MASK_MASK)
/*! @} */
...
/*! TLP_PRFX_BLOCKED_ERR_SEVERITY - TLP Prefix Blocked Error Severity (Optional). */
...
#define PCIE_EP_UNCORR_ERR_SEV_OFF_DMWR_EGRESS_BLOCKED_ERR_SEVERITY_MASK (0x8000000U)
#define PCIE_EP_UNCORR_ERR_SEV_OFF_DMWR_EGRESS_BLOCKED_ERR_SEVERITY_SHIFT (27U)
/*! DMWR_EGRESS_BLOCKED_ERR_SEVERITY - Deferrable Memory Write Egress Blocked Severity (Optional). */
#define PCIE_EP_UNCORR_ERR_SEV_OFF_DMWR_EGRESS_BLOCKED_ERR_SEVERITY(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_UNCORR_ERR_SEV_OFF_DMWR_EGRESS_BLOCKED_ERR_SEVERITY_SHIFT)) & PCIE_EP_UNCORR_ERR_SEV_OFF_DMWR_EGRESS_BLOCKED_ERR_SEVERITY_MASK)
/*! @} */
...
/*! RSVDP_LANE_ERR_STATUS - Reserved */
...
/*! @name LTR_CAP_HDR_REG - LTR Extended Capability Header. */
/*! @{ */

#define PCIE_EP_LTR_CAP_HDR_REG_CAP_ID_MASK      (0xFFFFU)
#define PCIE_EP_LTR_CAP_HDR_REG_CAP_ID_SHIFT     (0U)
/*! CAP_ID - LTR Extended Capacity ID. */
#define PCIE_EP_LTR_CAP_HDR_REG_CAP_ID(x)        (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_CAP_HDR_REG_CAP_ID_SHIFT)) & PCIE_EP_LTR_CAP_HDR_REG_CAP_ID_MASK)

#define PCIE_EP_LTR_CAP_HDR_REG_CAP_VERSION_MASK (0xF0000U)
#define PCIE_EP_LTR_CAP_HDR_REG_CAP_VERSION_SHIFT (16U)
/*! CAP_VERSION - Capability Version. */
#define PCIE_EP_LTR_CAP_HDR_REG_CAP_VERSION(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_CAP_HDR_REG_CAP_VERSION_SHIFT)) & PCIE_EP_LTR_CAP_HDR_REG_CAP_VERSION_MASK)

#define PCIE_EP_LTR_CAP_HDR_REG_NEXT_OFFSET_MASK (0xFFF00000U)
#define PCIE_EP_LTR_CAP_HDR_REG_NEXT_OFFSET_SHIFT (20U)
/*! NEXT_OFFSET - Next Capability Offset. */
#define PCIE_EP_LTR_CAP_HDR_REG_NEXT_OFFSET(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_CAP_HDR_REG_NEXT_OFFSET_SHIFT)) & PCIE_EP_LTR_CAP_HDR_REG_NEXT_OFFSET_MASK)
/*! @} */

/*! @name LTR_LATENCY_REG - LTR Max Snoop and No-Snoop Latency Register. */
/*! @{ */

#define PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_MASK (0x3FFU)
#define PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SHIFT (0U)
/*! MAX_SNOOP_LAT - Max Snoop Latency Value. */
#define PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SHIFT)) & PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_MASK)

#define PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SCALE_MASK (0x1C00U)
#define PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SCALE_SHIFT (10U)
/*! MAX_SNOOP_LAT_SCALE - Max Snoop Latency Scale. */
#define PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SCALE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SCALE_SHIFT)) & PCIE_EP_LTR_LATENCY_REG_MAX_SNOOP_LAT_SCALE_MASK)

#define PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_MASK (0x3FF0000U)
#define PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SHIFT (16U)
/*! MAX_NO_SNOOP_LAT - Max No-Snoop Latency Value. */
#define PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SHIFT)) & PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_MASK)

#define PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SCALE_MASK (0x1C000000U)
#define PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SCALE_SHIFT (26U)
/*! MAX_NO_SNOOP_LAT_SCALE - Max No-Snoop Latency Scale. */
#define PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SCALE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SCALE_SHIFT)) & PCIE_EP_LTR_LATENCY_REG_MAX_NO_SNOOP_LAT_SCALE_MASK)
/*! @} */

/*! @name L1SUB_CAP_HEADER_REG - L1 Substates Extended Capability Header. */
/*! @{ */

#define PCIE_EP_L1SUB_CAP_HEADER_REG_EXTENDED_CAP_ID_MASK (0xFFFFU)
#define PCIE_EP_L1SUB_CAP_HEADER_REG_EXTENDED_CAP_ID_SHIFT (0U)
/*! EXTENDED_CAP_ID - L1SUB Extended Capability ID. */
#define PCIE_EP_L1SUB_CAP_HEADER_REG_EXTENDED_CAP_ID(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAP_HEADER_REG_EXTENDED_CAP_ID_SHIFT)) & PCIE_EP_L1SUB_CAP_HEADER_REG_EXTENDED_CAP_ID_MASK)

#define PCIE_EP_L1SUB_CAP_HEADER_REG_CAP_VERSION_MASK (0xF0000U)
#define PCIE_EP_L1SUB_CAP_HEADER_REG_CAP_VERSION_SHIFT (16U)
/*! CAP_VERSION - Capability Version. */
#define PCIE_EP_L1SUB_CAP_HEADER_REG_CAP_VERSION(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAP_HEADER_REG_CAP_VERSION_SHIFT)) & PCIE_EP_L1SUB_CAP_HEADER_REG_CAP_VERSION_MASK)

#define PCIE_EP_L1SUB_CAP_HEADER_REG_NEXT_OFFSET_MASK (0xFFF00000U)
#define PCIE_EP_L1SUB_CAP_HEADER_REG_NEXT_OFFSET_SHIFT (20U)
/*! NEXT_OFFSET - Next Capability Offset. */
#define PCIE_EP_L1SUB_CAP_HEADER_REG_NEXT_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAP_HEADER_REG_NEXT_OFFSET_SHIFT)) & PCIE_EP_L1SUB_CAP_HEADER_REG_NEXT_OFFSET_MASK)
/*! @} */

/*! @name L1SUB_CAPABILITY_REG - L1 Substates Capability Register. */
/*! @{ */

#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_PCIPM_SUPPORT_MASK (0x1U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_PCIPM_SUPPORT_SHIFT (0U)
/*! L1_2_PCIPM_SUPPORT - PCI-PM L12 Supported. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_PCIPM_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_PCIPM_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_PCIPM_SUPPORT_MASK)

#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_PCIPM_SUPPORT_MASK (0x2U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_PCIPM_SUPPORT_SHIFT (1U)
/*! L1_1_PCIPM_SUPPORT - PCI-PM L11 Supported. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_PCIPM_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_PCIPM_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_PCIPM_SUPPORT_MASK)

#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_ASPM_SUPPORT_MASK (0x4U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_ASPM_SUPPORT_SHIFT (2U)
/*! L1_2_ASPM_SUPPORT - ASPM L12 Supported. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_ASPM_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_ASPM_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_L1_2_ASPM_SUPPORT_MASK)

#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_ASPM_SUPPORT_MASK (0x8U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_ASPM_SUPPORT_SHIFT (3U)
/*! L1_1_ASPM_SUPPORT - ASPM L11 Supported. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_ASPM_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_ASPM_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_L1_1_ASPM_SUPPORT_MASK)

#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_PMSUB_SUPPORT_MASK (0x10U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_PMSUB_SUPPORT_SHIFT (4U)
/*! L1_PMSUB_SUPPORT - L1 PM Substates ECN Supported. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_L1_PMSUB_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_L1_PMSUB_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_L1_PMSUB_SUPPORT_MASK)

#define PCIE_EP_L1SUB_CAPABILITY_REG_COMM_MODE_SUPPORT_MASK (0xFF00U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_COMM_MODE_SUPPORT_SHIFT (8U)
/*! COMM_MODE_SUPPORT - Port Common Mode Restore Time. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_COMM_MODE_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_COMM_MODE_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_COMM_MODE_SUPPORT_MASK)
...
#define PCIE_EP_L1SUB_CAPABILITY_REG_PWR_ON_VALUE_SUPPORT_MASK (0xF80000U)
#define PCIE_EP_L1SUB_CAPABILITY_REG_PWR_ON_VALUE_SUPPORT_SHIFT (19U)
/*! PWR_ON_VALUE_SUPPORT - Port T Power On Value. */
#define PCIE_EP_L1SUB_CAPABILITY_REG_PWR_ON_VALUE_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CAPABILITY_REG_PWR_ON_VALUE_SUPPORT_SHIFT)) & PCIE_EP_L1SUB_CAPABILITY_REG_PWR_ON_VALUE_SUPPORT_MASK)
/*! @} */

/*! @name L1SUB_CONTROL1_REG - L1 Substates Control 1 Register. */
/*! @{ */

#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_PCIPM_EN_MASK (0x1U)
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_PCIPM_EN_SHIFT (0U)
/*! L1_2_PCIPM_EN - PCI-PM L12 Enable. */
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_PCIPM_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_L1_2_PCIPM_EN_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_L1_2_PCIPM_EN_MASK)

#define PCIE_EP_L1SUB_CONTROL1_REG_L1_1_PCIPM_EN_MASK (0x2U)
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_1_PCIPM_EN_SHIFT (1U)
/*! L1_1_PCIPM_EN - PCI-PM L11 Enable. */
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_1_PCIPM_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_L1_1_PCIPM_EN_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_L1_1_PCIPM_EN_MASK)

#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_ASPM_EN_MASK (0x4U)
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_ASPM_EN_SHIFT (2U)
/*! L1_2_ASPM_EN - ASPM L12 Enable. */
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_ASPM_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_L1_2_ASPM_EN_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_L1_2_ASPM_EN_MASK)

#define PCIE_EP_L1SUB_CONTROL1_REG_L1_1_ASPM_EN_MASK (0x8U)
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_1_ASPM_EN_SHIFT (3U)
/*! L1_1_ASPM_EN - ASPM L11 Enable. */
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_1_ASPM_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_L1_1_ASPM_EN_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_L1_1_ASPM_EN_MASK)

#define PCIE_EP_L1SUB_CONTROL1_REG_T_COMMON_MODE_MASK (0xFF00U)
#define PCIE_EP_L1SUB_CONTROL1_REG_T_COMMON_MODE_SHIFT (8U)
/*! T_COMMON_MODE - Common Mode Restore Time. */
#define PCIE_EP_L1SUB_CONTROL1_REG_T_COMMON_MODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_T_COMMON_MODE_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_T_COMMON_MODE_MASK)

#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_VAL_MASK (0x3FF0000U)
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_VAL_SHIFT (16U)
/*! L1_2_TH_VAL - LTR L12 Threshold Value. */
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_VAL(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_VAL_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_VAL_MASK)

#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_SCA_MASK (0xE0000000U)
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_SCA_SHIFT (29U)
/*! L1_2_TH_SCA - LTR L12 Threshold Scale. */
#define PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_SCA(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_SCA_SHIFT)) & PCIE_EP_L1SUB_CONTROL1_REG_L1_2_TH_SCA_MASK)
/*! @} */
...
#define PCIE_EP_L1SUB_CONTROL2_REG_T_POWER_ON_VALUE_MASK (0xF8U)
#define PCIE_EP_L1SUB_CONTROL2_REG_T_POWER_ON_VALUE_SHIFT (3U)
/*! T_POWER_ON_VALUE - T Power On Value. */
#define PCIE_EP_L1SUB_CONTROL2_REG_T_POWER_ON_VALUE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1SUB_CONTROL2_REG_T_POWER_ON_VALUE_SHIFT)) & PCIE_EP_L1SUB_CONTROL2_REG_T_POWER_ON_VALUE_MASK)
/*! @} */
...
#define PCIE_EP_ACK_F_ASPM_CTRL_OFF_ASPM_L1_TIMER_ENABLE_MASK (0x80000000U)
#define PCIE_EP_ACK_F_ASPM_CTRL_OFF_ASPM_L1_TIMER_ENABLE_SHIFT (31U)
 ...
 */
#define PCIE_EP_ACK_F_ASPM_CTRL_OFF_ASPM_L1_TIMER_ENABLE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_ACK_F_ASPM_CTRL_OFF_ASPM_L1_TIMER_ENABLE_SHIFT)) & PCIE_EP_ACK_F_ASPM_CTRL_OFF_ASPM_L1_TIMER_ENABLE_MASK)
/*! @} */
 ...
 *  0b00000000..NP cannot pass P (recommended).
 ...
 *  0b00000000..CPL cannot pass P (recommended)
...
#define PCIE_EP_MISC_CONTROL_1_OFF_DISABLE_AUTO_LTR_CLR_MSG_MASK (0x10U)
#define PCIE_EP_MISC_CONTROL_1_OFF_DISABLE_AUTO_LTR_CLR_MSG_SHIFT (4U)
 ...
 */
#define PCIE_EP_MISC_CONTROL_1_OFF_DISABLE_AUTO_LTR_CLR_MSG(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_MISC_CONTROL_1_OFF_DISABLE_AUTO_LTR_CLR_MSG_SHIFT)) & PCIE_EP_MISC_CONTROL_1_OFF_DISABLE_AUTO_LTR_CLR_MSG_MASK)
...
#define PCIE_EP_PHY_INTEROP_CTRL_OFF_PHY_PERST_ON_WARM_RESET_MASK (0x40000000U)
#define PCIE_EP_PHY_INTEROP_CTRL_OFF_PHY_PERST_ON_WARM_RESET_SHIFT (30U)
 ...
 */
#define PCIE_EP_PHY_INTEROP_CTRL_OFF_PHY_PERST_ON_WARM_RESET(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PHY_INTEROP_CTRL_OFF_PHY_PERST_ON_WARM_RESET_SHIFT)) & PCIE_EP_PHY_INTEROP_CTRL_OFF_PHY_PERST_ON_WARM_RESET_MASK)
/*! @} */
...
#define PCIE_EP_LINK_FLUSH_CONTROL_OFF_AUTO_FLUSH_TIMEOUT_MASK (0xFF000000U)
#define PCIE_EP_LINK_FLUSH_CONTROL_OFF_AUTO_FLUSH_TIMEOUT_SHIFT (24U)
/*! AUTO_FLUSH_TIMEOUT - Timeout Value (ms) for automatic flushing. */
#define PCIE_EP_LINK_FLUSH_CONTROL_OFF_AUTO_FLUSH_TIMEOUT(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_LINK_FLUSH_CONTROL_OFF_AUTO_FLUSH_TIMEOUT_SHIFT)) & PCIE_EP_LINK_FLUSH_CONTROL_OFF_AUTO_FLUSH_TIMEOUT_MASK)
/*! @} */
...
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_VALUE_MASK (0x3FFU)
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_VALUE_SHIFT (0U)
/*! SNOOP_LATENCY_VALUE - Snoop Latency Value. */
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_VALUE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_VALUE_SHIFT)) & PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_VALUE_MASK)

#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_SCALE_MASK (0x1C00U)
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_SCALE_SHIFT (10U)
/*! SNOOP_LATENCY_SCALE - Snoop Latency Scale. */
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_SCALE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_SCALE_SHIFT)) & PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_SCALE_MASK)

#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_REQUIRE_MASK (0x8000U)
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_REQUIRE_SHIFT (15U)
/*! SNOOP_LATENCY_REQUIRE - Snoop Latency Requirement. */
#define PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_REQUIRE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_REQUIRE_SHIFT)) & PCIE_EP_PL_LTR_LATENCY_OFF_SNOOP_LATENCY_REQUIRE_MASK)

#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_VALUE_MASK (0x3FF0000U)
#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_VALUE_SHIFT (16U)
/*! NO_SNOOP_LATENCY_VALUE - No Snoop Latency Value. */
#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_VALUE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_VALUE_SHIFT)) & PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_VALUE_MASK)

#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_SCALE_MASK (0x1C000000U)
#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_SCALE_SHIFT (26U)
/*! NO_SNOOP_LATENCY_SCALE - No Snoop Latency Scale. */
#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_SCALE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_SCALE_SHIFT)) & PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_SCALE_MASK)

#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_REQUIRE_MASK (0x80000000U)
#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_REQUIRE_SHIFT (31U)
/*! NO_SNOOP_LATENCY_REQUIRE - No Snoop Latency Requirement. */
#define PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_REQUIRE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_REQUIRE_SHIFT)) & PCIE_EP_PL_LTR_LATENCY_OFF_NO_SNOOP_LATENCY_REQUIRE_MASK)
/*! @} */
...
#define PCIE_EP_L1_SUBSTATES_OFF_L1SUB_LOW_POWER_CLOCK_SWITCH_MODE_MASK (0x100U)
#define PCIE_EP_L1_SUBSTATES_OFF_L1SUB_LOW_POWER_CLOCK_SWITCH_MODE_SHIFT (8U)
 ...
 */
#define PCIE_EP_L1_SUBSTATES_OFF_L1SUB_LOW_POWER_CLOCK_SWITCH_MODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_L1_SUBSTATES_OFF_L1SUB_LOW_POWER_CLOCK_SWITCH_MODE_SHIFT)) & PCIE_EP_L1_SUBSTATES_OFF_L1SUB_LOW_POWER_CLOCK_SWITCH_MODE_MASK)
...
#define PCIE_EP_PHY_INTEROP_CTRL_2_OFF_PMA_PIPE_RST_DELAY_TIMER_MASK (0x3FU)
...
#define PCIE_EP_DBI_FUNCTION_BANK_CTRL_REG_OFF_DBI_FUNCTION_BANK_CTRL_REG_MASK (0x1U)
#define PCIE_EP_DBI_FUNCTION_BANK_CTRL_REG_OFF_DBI_FUNCTION_BANK_CTRL_REG_SHIFT (0U)
 ...
 */
#define PCIE_EP_DBI_FUNCTION_BANK_CTRL_REG_OFF_DBI_FUNCTION_BANK_CTRL_REG(x) (((uint32_t)(((uint32_t)(x)) << PCIE_EP_DBI_FUNCTION_BANK_CTRL_REG_OFF_DBI_FUNCTION_BANK_CTRL_REG_SHIFT)) & PCIE_EP_DBI_FUNCTION_BANK_CTRL_REG_OFF_DBI_FUNCTION_BANK_CTRL_REG_MASK)
/*! @} */

/*! @name UTILITY_OFF - UTILITY register (Reserved). */
/*! @{ */

#define PCIE_EP_UTILITY_OFF_UTILITY_MASK         (0xFFFFFFFFU)
#define PCIE_EP_UTILITY_OFF_UTILITY_SHIFT        (0U)
/*! UTILITY - Reserved. */
#define PCIE_EP_UTILITY_OFF_UTILITY(x)           (((uint32_t)(((uint32_t)(x)) << PCIE_EP_UTILITY_OFF_UTILITY_SHIFT)) & PCIE_EP_UTILITY_OFF_UTILITY_MASK)
/*! @} */

/*! @name PM_UTILITY_OFF - PM Shadow of UTILITY register (Reserved). */
/*! @{ */

#define PCIE_EP_PM_UTILITY_OFF_PM_UTILITY_MASK   (0xFFFFFFFFU)
#define PCIE_EP_PM_UTILITY_OFF_PM_UTILITY_SHIFT  (0U)
/*! PM_UTILITY - Reserved. */
#define PCIE_EP_PM_UTILITY_OFF_PM_UTILITY(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_EP_PM_UTILITY_OFF_PM_UTILITY_SHIFT)) & PCIE_EP_PM_UTILITY_OFF_PM_UTILITY_MASK)
/*! @} */
