...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for m_e_3_wr_I_main_TranStatFilt
**
...
/*!
 * @file m_e_3_wr_I_main_TranStatFilt.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for m_e_3_wr_I_main_TranStatFilt
 *
 * CMSIS Peripheral Access Layer for m_e_3_wr_I_main_TranStatFilt
 */

#if !defined(m_e_3_wr_I_main_TranStatFilt_H_)
#define m_e_3_wr_I_main_TranStatFilt_H_          /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- m_e_3_wr_I_main_TranStatFilt Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup m_e_3_wr_I_main_TranStatFilt_Peripheral_Access_Layer m_e_3_wr_I_main_TranStatFilt Peripheral Access Layer
 * @{
 */

/** m_e_3_wr_I_main_TranStatFilt - Register Layout Typedef */
typedef struct {
...
} m_e_3_wr_I_main_TranStatFilt_Type;

/* ----------------------------------------------------------------------------
   -- m_e_3_wr_I_main_TranStatFilt Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup m_e_3_wr_I_main_TranStatFilt_Register_Masks m_e_3_wr_I_main_TranStatFilt Register Masks
 * @{
 */
...
#define m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_MASK (0xFFU)
#define m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_MASK)

#define m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_MASK (0xFFU)
#define m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_MASK)

#define m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_SHIFT (8U)
#define m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_MODE_MODE_MASK (0x1U)
#define m_e_3_wr_I_main_TranStatFilt_MODE_MODE_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_MODE_MODE_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_MODE_MODE_MASK)
/*! @} */

/*! @name ADDRBASE_LOW - Address Base LSB */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define m_e_3_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name ADDRBASE_HIGH - Address Base MSB */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK (0xFU)
#define m_e_3_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK)
/*! @} */

/*! @name ADDRWINDOWSIZE - Address Window Size */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define m_e_3_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name OPCODE - Packet Opcode */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_OPCODE_RDEN_MASK (0x1U)
#define m_e_3_wr_I_main_TranStatFilt_OPCODE_RDEN_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_OPCODE_RDEN_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_OPCODE_RDEN_MASK)

#define m_e_3_wr_I_main_TranStatFilt_OPCODE_WREN_MASK (0x2U)
#define m_e_3_wr_I_main_TranStatFilt_OPCODE_WREN_SHIFT (1U)
#define m_e_3_wr_I_main_TranStatFilt_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_OPCODE_WREN_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_OPCODE_WREN_MASK)
/*! @} */

/*! @name USERBASE - User Base */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_USERBASE_USERBASE_MASK (0x1FFFFFFFU)
#define m_e_3_wr_I_main_TranStatFilt_USERBASE_USERBASE_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_USERBASE_USERBASE(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_USERBASE_USERBASE_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_USERBASE_USERBASE_MASK)
/*! @} */

/*! @name USERMASK - User Mask */
/*! @{ */

#define m_e_3_wr_I_main_TranStatFilt_USERMASK_USERMASK_MASK (0x1FFFFFFFU)
#define m_e_3_wr_I_main_TranStatFilt_USERMASK_USERMASK_SHIFT (0U)
#define m_e_3_wr_I_main_TranStatFilt_USERMASK_USERMASK(x) (((uint32_t)(((uint32_t)(x)) << m_e_3_wr_I_main_TranStatFilt_USERMASK_USERMASK_SHIFT)) & m_e_3_wr_I_main_TranStatFilt_USERMASK_USERMASK_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group m_e_3_wr_I_main_TranStatFilt_Register_Masks */


/*!
 * @}
 */ /* end of group m_e_3_wr_I_main_TranStatFilt_Peripheral_Access_Layer */
...
#endif  /* m_e_3_wr_I_main_TranStatFilt_H_ */
