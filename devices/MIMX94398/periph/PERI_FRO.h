...
#define FRO_CNFG3_TRIM2_DELAY_MASK               (0xFFFU)
#define FRO_CNFG3_TRIM2_DELAY_SHIFT              (0U)
/*! TRIM2_DELAY - Trim 2 Delay Register */
#define FRO_CNFG3_TRIM2_DELAY(x)                 (((uint32_t)(((uint32_t)(x)) << FRO_CNFG3_TRIM2_DELAY_SHIFT)) & FRO_CNFG3_TRIM2_DELAY_MASK)
/*! @} */
