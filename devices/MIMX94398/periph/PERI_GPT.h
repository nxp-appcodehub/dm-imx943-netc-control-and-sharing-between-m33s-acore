...
typedef struct {
  ...
  __IO uint32_t OCR[GPT_OCR_COUNT];                /**< Output Compare, array offset: 0x10, array step: 0x4 */
  __I  uint32_t ICR[GPT_ICR_COUNT];                /**< Input Capture, array offset: 0x1C, array step: 0x4 */
