...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_GITS0translater
**
...
/*!
 * @file NOC_GITS0translater.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_GITS0translater
 *
 * CMSIS Peripheral Access Layer for NOC_GITS0translater
 */

#if !defined(NOC_GITS0translater_H_)
#define NOC_GITS0translater_H_                   /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_GITS0translater Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_GITS0translater_Peripheral_Access_Layer NOC_GITS0translater Peripheral Access Layer
 * @{
 */

/** NOC_GITS0translater - Register Layout Typedef */
typedef struct {
       uint8_t RESERVED_0[64];
  __O  uint64_t GITS0_TRANSLATER;                  /**< GITS0_TRANSLATER, offset: 0x40 */
} NOC_GITS0translater_Type;

/* ----------------------------------------------------------------------------
   -- NOC_GITS0translater Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_GITS0translater_Register_Masks NOC_GITS0translater Register Masks
 * @{
 */

/*! @name GITS0_TRANSLATER - GITS0_TRANSLATER */
/*! @{ */

#define NOC_GITS0translater_GITS0_TRANSLATER_InterruptID_MASK (0xFFFFFFFFU)
#define NOC_GITS0translater_GITS0_TRANSLATER_InterruptID_SHIFT (0U)
/*! InterruptID - InterruptID */
#define NOC_GITS0translater_GITS0_TRANSLATER_InterruptID(x) (((uint64_t)(((uint64_t)(x)) << NOC_GITS0translater_GITS0_TRANSLATER_InterruptID_SHIFT)) & NOC_GITS0translater_GITS0_TRANSLATER_InterruptID_MASK)

#define NOC_GITS0translater_GITS0_TRANSLATER_DeviceID_MASK (0xFFFFFFFF00000000U)
#define NOC_GITS0translater_GITS0_TRANSLATER_DeviceID_SHIFT (32U)
/*! DeviceID - DeviceID */
#define NOC_GITS0translater_GITS0_TRANSLATER_DeviceID(x) (((uint64_t)(((uint64_t)(x)) << NOC_GITS0translater_GITS0_TRANSLATER_DeviceID_SHIFT)) & NOC_GITS0translater_GITS0_TRANSLATER_DeviceID_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_GITS0translater_Register_Masks */
