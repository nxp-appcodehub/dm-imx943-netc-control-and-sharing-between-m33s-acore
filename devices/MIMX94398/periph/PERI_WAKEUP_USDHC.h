 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for WAKEUP_USDHC
 *
 * CMSIS Peripheral Access Layer for WAKEUP_USDHC
 */

#if !defined(WAKEUP_USDHC_H_)
#define WAKEUP_USDHC_H_                          /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- WAKEUP_USDHC Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup WAKEUP_USDHC_Peripheral_Access_Layer WAKEUP_USDHC Peripheral Access Layer
 * @{
 */

/** WAKEUP_USDHC - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- WAKEUP_USDHC Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup WAKEUP_USDHC_Register_Masks WAKEUP_USDHC Register Masks
 * @{
 */
...
#define WAKEUP_USDHC_DS_ADDR_DS_ADDR_MASK        (0xFFFFFFFFU)
#define WAKEUP_USDHC_DS_ADDR_DS_ADDR_SHIFT       (0U)
/*! DS_ADDR - System address */
#define WAKEUP_USDHC_DS_ADDR_DS_ADDR(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DS_ADDR_DS_ADDR_SHIFT)) & WAKEUP_USDHC_DS_ADDR_DS_ADDR_MASK)
/*! @} */
...
#define WAKEUP_USDHC_CMD_ARG_CMDARG_MASK         (0xFFFFFFFFU)
#define WAKEUP_USDHC_CMD_ARG_CMDARG_SHIFT        (0U)
/*! CMDARG - Command argument */
#define WAKEUP_USDHC_CMD_ARG_CMDARG(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_ARG_CMDARG_SHIFT)) & WAKEUP_USDHC_CMD_ARG_CMDARG_MASK)
/*! @} */

/*! @name CMD_XFR_TYP - Command Transfer Type */
/*! @{ */

#define WAKEUP_USDHC_CMD_XFR_TYP_DMAEN_MASK      (0x1U)
#define WAKEUP_USDHC_CMD_XFR_TYP_DMAEN_SHIFT     (0U)
/*! DMAEN - DMAEN
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_DMAEN(x)        (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_DMAEN_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_DMAEN_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_BCEN_MASK       (0x2U)
#define WAKEUP_USDHC_CMD_XFR_TYP_BCEN_SHIFT      (1U)
/*! BCEN - BCEN
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_BCEN(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_BCEN_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_BCEN_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_AC12EN_MASK     (0x4U)
#define WAKEUP_USDHC_CMD_XFR_TYP_AC12EN_SHIFT    (2U)
/*! AC12EN - AC12EN
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_AC12EN(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_AC12EN_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_AC12EN_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_DDR_EN_MASK     (0x8U)
#define WAKEUP_USDHC_CMD_XFR_TYP_DDR_EN_SHIFT    (3U)
/*! DDR_EN - DDR_EN
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_DDR_EN(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_DDR_EN_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_DDR_EN_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_DTDSEL_MASK     (0x10U)
#define WAKEUP_USDHC_CMD_XFR_TYP_DTDSEL_SHIFT    (4U)
/*! DTDSEL - DTDSEL
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_DTDSEL(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_DTDSEL_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_DTDSEL_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_MSBSEL_MASK     (0x20U)
#define WAKEUP_USDHC_CMD_XFR_TYP_MSBSEL_SHIFT    (5U)
/*! MSBSEL - MSBSEL
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_MSBSEL(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_MSBSEL_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_MSBSEL_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_NIBBLE_POS_MASK (0x40U)
#define WAKEUP_USDHC_CMD_XFR_TYP_NIBBLE_POS_SHIFT (6U)
/*! NIBBLE_POS - NIBBLE_POS
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_NIBBLE_POS(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_NIBBLE_POS_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_NIBBLE_POS_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_AC23EN_MASK     (0x80U)
#define WAKEUP_USDHC_CMD_XFR_TYP_AC23EN_SHIFT    (7U)
/*! AC23EN - AC23EN
 *  0b0..Disable
 *  0b1..Enable
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_AC23EN(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_AC23EN_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_AC23EN_MASK)

#define WAKEUP_USDHC_CMD_XFR_TYP_RSPTYP_MASK     (0x30000U)
#define WAKEUP_USDHC_CMD_XFR_TYP_RSPTYP_SHIFT    (16U)
 ...
 */
#define WAKEUP_USDHC_CMD_XFR_TYP_RSPTYP(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_RSPTYP_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_RSPTYP_MASK)
...
#define WAKEUP_USDHC_CMD_XFR_TYP_CMDINX_MASK     (0x3F000000U)
#define WAKEUP_USDHC_CMD_XFR_TYP_CMDINX_SHIFT    (24U)
/*! CMDINX - Command index */
#define WAKEUP_USDHC_CMD_XFR_TYP_CMDINX(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_XFR_TYP_CMDINX_SHIFT)) & WAKEUP_USDHC_CMD_XFR_TYP_CMDINX_MASK)
/*! @} */

/*! @name CMD_RSP0 - Command Response0 */
/*! @{ */

#define WAKEUP_USDHC_CMD_RSP0_CMDRSP0_MASK       (0xFFFFFFFFU)
#define WAKEUP_USDHC_CMD_RSP0_CMDRSP0_SHIFT      (0U)
/*! CMDRSP0 - Command response 0 */
#define WAKEUP_USDHC_CMD_RSP0_CMDRSP0(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_RSP0_CMDRSP0_SHIFT)) & WAKEUP_USDHC_CMD_RSP0_CMDRSP0_MASK)
/*! @} */

/*! @name CMD_RSP1 - Command Response1 */
/*! @{ */

#define WAKEUP_USDHC_CMD_RSP1_CMDRSP1_MASK       (0xFFFFFFFFU)
#define WAKEUP_USDHC_CMD_RSP1_CMDRSP1_SHIFT      (0U)
/*! CMDRSP1 - Command response 1 */
#define WAKEUP_USDHC_CMD_RSP1_CMDRSP1(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_RSP1_CMDRSP1_SHIFT)) & WAKEUP_USDHC_CMD_RSP1_CMDRSP1_MASK)
/*! @} */

/*! @name CMD_RSP2 - Command Response2 */
/*! @{ */

#define WAKEUP_USDHC_CMD_RSP2_CMDRSP2_MASK       (0xFFFFFFFFU)
#define WAKEUP_USDHC_CMD_RSP2_CMDRSP2_SHIFT      (0U)
/*! CMDRSP2 - Command response 2 */
#define WAKEUP_USDHC_CMD_RSP2_CMDRSP2(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_RSP2_CMDRSP2_SHIFT)) & WAKEUP_USDHC_CMD_RSP2_CMDRSP2_MASK)
/*! @} */

/*! @name CMD_RSP3 - Command Response3 */
/*! @{ */

#define WAKEUP_USDHC_CMD_RSP3_CMDRSP3_MASK       (0xFFFFFFFFU)
#define WAKEUP_USDHC_CMD_RSP3_CMDRSP3_SHIFT      (0U)
/*! CMDRSP3 - Command response 3 */
#define WAKEUP_USDHC_CMD_RSP3_CMDRSP3(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CMD_RSP3_CMDRSP3_SHIFT)) & WAKEUP_USDHC_CMD_RSP3_CMDRSP3_MASK)
/*! @} */

/*! @name DATA_BUFF_ACC_PORT - Data Buffer Access Port */
/*! @{ */

#define WAKEUP_USDHC_DATA_BUFF_ACC_PORT_DATCONT_MASK (0xFFFFFFFFU)
#define WAKEUP_USDHC_DATA_BUFF_ACC_PORT_DATCONT_SHIFT (0U)
/*! DATCONT - Data content */
#define WAKEUP_USDHC_DATA_BUFF_ACC_PORT_DATCONT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DATA_BUFF_ACC_PORT_DATCONT_SHIFT)) & WAKEUP_USDHC_DATA_BUFF_ACC_PORT_DATCONT_MASK)
/*! @} */
...
#define WAKEUP_USDHC_PRES_STATE_BRESP_RCV_MASK   (0x400000U)
#define WAKEUP_USDHC_PRES_STATE_BRESP_RCV_SHIFT  (22U)
/*! BRESP_RCV - Bresp receiving status
 *  0b0..DMA transfer is not completed.
 *  0b1..DMA transfer is completed.
 */
#define WAKEUP_USDHC_PRES_STATE_BRESP_RCV(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_PRES_STATE_BRESP_RCV_SHIFT)) & WAKEUP_USDHC_PRES_STATE_BRESP_RCV_MASK)

#define WAKEUP_USDHC_PRES_STATE_CLSL_MASK        (0x800000U)
#define WAKEUP_USDHC_PRES_STATE_CLSL_SHIFT       (23U)
/*! CLSL - CMD line signal level */
#define WAKEUP_USDHC_PRES_STATE_CLSL(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_PRES_STATE_CLSL_SHIFT)) & WAKEUP_USDHC_PRES_STATE_CLSL_MASK)
...
#define WAKEUP_USDHC_PROT_CTRL_EMODE_MASK        (0x30U)
#define WAKEUP_USDHC_PROT_CTRL_EMODE_SHIFT       (4U)
/*! EMODE - Endian mode
 ...
 *  0b11..Reserved
 */
#define WAKEUP_USDHC_PROT_CTRL_EMODE(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_PROT_CTRL_EMODE_SHIFT)) & WAKEUP_USDHC_PROT_CTRL_EMODE_MASK)

#define WAKEUP_USDHC_PROT_CTRL_DMASEL_MASK       (0x300U)
#define WAKEUP_USDHC_PROT_CTRL_DMASEL_SHIFT      (8U)
/*! DMASEL - DMA select
...
#define WAKEUP_USDHC_PROT_CTRL_RD_DONE_NO_8CLK_MASK (0x100000U)
#define WAKEUP_USDHC_PROT_CTRL_RD_DONE_NO_8CLK_SHIFT (20U)
/*! RD_DONE_NO_8CLK - Read performed number 8 clock */
#define WAKEUP_USDHC_PROT_CTRL_RD_DONE_NO_8CLK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_PROT_CTRL_RD_DONE_NO_8CLK_SHIFT)) & WAKEUP_USDHC_PROT_CTRL_RD_DONE_NO_8CLK_MASK)
...
#define WAKEUP_USDHC_SYS_CTRL_DVS_MASK           (0xF0U)
#define WAKEUP_USDHC_SYS_CTRL_DVS_SHIFT          (4U)
/*! DVS - Divisor
 *  0b0000..Divide-by-1
 *  0b0001..Divide-by-2
 *  0b1110..Divide-by-15
 *  0b1111..Divide-by-16
 */
#define WAKEUP_USDHC_SYS_CTRL_DVS(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_SYS_CTRL_DVS_SHIFT)) & WAKEUP_USDHC_SYS_CTRL_DVS_MASK)

#define WAKEUP_USDHC_SYS_CTRL_SDCLKFS_MASK       (0xFF00U)
#define WAKEUP_USDHC_SYS_CTRL_SDCLKFS_SHIFT      (8U)
/*! SDCLKFS - SDCLK frequency select */
#define WAKEUP_USDHC_SYS_CTRL_SDCLKFS(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_SYS_CTRL_SDCLKFS_SHIFT)) & WAKEUP_USDHC_SYS_CTRL_SDCLKFS_MASK)
...
#define WAKEUP_USDHC_SYS_CTRL_RST_FIFO_MASK      (0x400000U)
#define WAKEUP_USDHC_SYS_CTRL_RST_FIFO_SHIFT     (22U)
/*! RST_FIFO - Reset the async FIFO */
#define WAKEUP_USDHC_SYS_CTRL_RST_FIFO(x)        (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_SYS_CTRL_RST_FIFO_SHIFT)) & WAKEUP_USDHC_SYS_CTRL_RST_FIFO_MASK)

#define WAKEUP_USDHC_SYS_CTRL_IPP_RST_N_MASK     (0x800000U)
#define WAKEUP_USDHC_SYS_CTRL_IPP_RST_N_SHIFT    (23U)
/*! IPP_RST_N - Hardware reset */
#define WAKEUP_USDHC_SYS_CTRL_IPP_RST_N(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_SYS_CTRL_IPP_RST_N_SHIFT)) & WAKEUP_USDHC_SYS_CTRL_IPP_RST_N_MASK)
...
#define WAKEUP_USDHC_SYS_CTRL_INITA_MASK         (0x8000000U)
#define WAKEUP_USDHC_SYS_CTRL_INITA_SHIFT        (27U)
/*! INITA - Initialization active */
#define WAKEUP_USDHC_SYS_CTRL_INITA(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_SYS_CTRL_INITA_SHIFT)) & WAKEUP_USDHC_SYS_CTRL_INITA_MASK)

#define WAKEUP_USDHC_SYS_CTRL_RSTT_MASK          (0x10000000U)
#define WAKEUP_USDHC_SYS_CTRL_RSTT_SHIFT         (28U)
/*! RSTT - Reset tuning */
#define WAKEUP_USDHC_SYS_CTRL_RSTT(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_SYS_CTRL_RSTT_SHIFT)) & WAKEUP_USDHC_SYS_CTRL_RSTT_MASK)
/*! @} */
...
#define WAKEUP_USDHC_INT_STATUS_TP_MASK          (0x2000U)
#define WAKEUP_USDHC_INT_STATUS_TP_SHIFT         (13U)
/*! TP - Tuning pass:(only for SD3.0 SDR104 mode and eMMC HS200 mode) */
#define WAKEUP_USDHC_INT_STATUS_TP(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_INT_STATUS_TP_SHIFT)) & WAKEUP_USDHC_INT_STATUS_TP_MASK)

#define WAKEUP_USDHC_INT_STATUS_CQI_MASK         (0x4000U)
#define WAKEUP_USDHC_INT_STATUS_CQI_SHIFT        (14U)
/*! CQI - Command queuing interrupt */
#define WAKEUP_USDHC_INT_STATUS_CQI(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_INT_STATUS_CQI_SHIFT)) & WAKEUP_USDHC_INT_STATUS_CQI_MASK)

#define WAKEUP_USDHC_INT_STATUS_ERR_INT_STATUS_MASK (0x8000U)
#define WAKEUP_USDHC_INT_STATUS_ERR_INT_STATUS_SHIFT (15U)
/*! ERR_INT_STATUS - Error Interrupt Status */
#define WAKEUP_USDHC_INT_STATUS_ERR_INT_STATUS(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_INT_STATUS_ERR_INT_STATUS_SHIFT)) & WAKEUP_USDHC_INT_STATUS_ERR_INT_STATUS_MASK)
...
#define WAKEUP_USDHC_INT_STATUS_TNE_MASK         (0x4000000U)
#define WAKEUP_USDHC_INT_STATUS_TNE_SHIFT        (26U)
/*! TNE - Tuning error: (only for SD3.0 SDR104 mode and eMMC HS200 mode) */
#define WAKEUP_USDHC_INT_STATUS_TNE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_INT_STATUS_TNE_SHIFT)) & WAKEUP_USDHC_INT_STATUS_TNE_MASK)
...
#define WAKEUP_USDHC_HOST_CTRL_CAP_SDR50_SUPPORT_MASK (0x1U)
#define WAKEUP_USDHC_HOST_CTRL_CAP_SDR50_SUPPORT_SHIFT (0U)
/*! SDR50_SUPPORT - SDR50 support */
#define WAKEUP_USDHC_HOST_CTRL_CAP_SDR50_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_HOST_CTRL_CAP_SDR50_SUPPORT_SHIFT)) & WAKEUP_USDHC_HOST_CTRL_CAP_SDR50_SUPPORT_MASK)

#define WAKEUP_USDHC_HOST_CTRL_CAP_SDR104_SUPPORT_MASK (0x2U)
#define WAKEUP_USDHC_HOST_CTRL_CAP_SDR104_SUPPORT_SHIFT (1U)
/*! SDR104_SUPPORT - SDR104 support */
#define WAKEUP_USDHC_HOST_CTRL_CAP_SDR104_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_HOST_CTRL_CAP_SDR104_SUPPORT_SHIFT)) & WAKEUP_USDHC_HOST_CTRL_CAP_SDR104_SUPPORT_MASK)

#define WAKEUP_USDHC_HOST_CTRL_CAP_DDR50_SUPPORT_MASK (0x4U)
#define WAKEUP_USDHC_HOST_CTRL_CAP_DDR50_SUPPORT_SHIFT (2U)
/*! DDR50_SUPPORT - DDR50 support */
#define WAKEUP_USDHC_HOST_CTRL_CAP_DDR50_SUPPORT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_HOST_CTRL_CAP_DDR50_SUPPORT_SHIFT)) & WAKEUP_USDHC_HOST_CTRL_CAP_DDR50_SUPPORT_MASK)
...
#define WAKEUP_USDHC_HOST_CTRL_CAP_MBL_MASK      (0x70000U)
#define WAKEUP_USDHC_HOST_CTRL_CAP_MBL_SHIFT     (16U)
 ...
 *  0b011..4096 bytes
 */
#define WAKEUP_USDHC_HOST_CTRL_CAP_MBL(x)        (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_HOST_CTRL_CAP_MBL_SHIFT)) & WAKEUP_USDHC_HOST_CTRL_CAP_MBL_MASK)
...
#define WAKEUP_USDHC_WTMK_LVL_RD_WML_MASK        (0xFFU)
#define WAKEUP_USDHC_WTMK_LVL_RD_WML_SHIFT       (0U)
...
#define WAKEUP_USDHC_WTMK_LVL_WR_WML_MASK        (0xFF0000U)
#define WAKEUP_USDHC_WTMK_LVL_WR_WML_SHIFT       (16U)
/*! WR_WML - Write watermark level */
#define WAKEUP_USDHC_WTMK_LVL_WR_WML(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_WTMK_LVL_WR_WML_SHIFT)) & WAKEUP_USDHC_WTMK_LVL_WR_WML_MASK)
/*! @} */
...
#define WAKEUP_USDHC_MIX_CTRL_DDR_EN_MASK        (0x8U)
#define WAKEUP_USDHC_MIX_CTRL_DDR_EN_SHIFT       (3U)
/*! DDR_EN - Dual data rate mode selection */
#define WAKEUP_USDHC_MIX_CTRL_DDR_EN(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MIX_CTRL_DDR_EN_SHIFT)) & WAKEUP_USDHC_MIX_CTRL_DDR_EN_MASK)
...
#define WAKEUP_USDHC_MIX_CTRL_NIBBLE_POS_MASK    (0x40U)
#define WAKEUP_USDHC_MIX_CTRL_NIBBLE_POS_SHIFT   (6U)
/*! NIBBLE_POS - Nibble position indication */
#define WAKEUP_USDHC_MIX_CTRL_NIBBLE_POS(x)      (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MIX_CTRL_NIBBLE_POS_SHIFT)) & WAKEUP_USDHC_MIX_CTRL_NIBBLE_POS_MASK)

#define WAKEUP_USDHC_MIX_CTRL_AC23EN_MASK        (0x80U)
#define WAKEUP_USDHC_MIX_CTRL_AC23EN_SHIFT       (7U)
/*! AC23EN - Auto CMD23 enable */
#define WAKEUP_USDHC_MIX_CTRL_AC23EN(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MIX_CTRL_AC23EN_SHIFT)) & WAKEUP_USDHC_MIX_CTRL_AC23EN_MASK)
...
#define WAKEUP_USDHC_MIX_CTRL_HS400_MODE_MASK    (0x4000000U)
#define WAKEUP_USDHC_MIX_CTRL_HS400_MODE_SHIFT   (26U)
/*! HS400_MODE - Enable HS400 mode */
#define WAKEUP_USDHC_MIX_CTRL_HS400_MODE(x)      (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MIX_CTRL_HS400_MODE_SHIFT)) & WAKEUP_USDHC_MIX_CTRL_HS400_MODE_MASK)

#define WAKEUP_USDHC_MIX_CTRL_EN_HS400_MODE_MASK (0x8000000U)
#define WAKEUP_USDHC_MIX_CTRL_EN_HS400_MODE_SHIFT (27U)
/*! EN_HS400_MODE - Enable enhance HS400 mode */
#define WAKEUP_USDHC_MIX_CTRL_EN_HS400_MODE(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MIX_CTRL_EN_HS400_MODE_SHIFT)) & WAKEUP_USDHC_MIX_CTRL_EN_HS400_MODE_MASK)
/*! @} */

/*! @name FORCE_EVENT - Force Event */
/*! @{ */

#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12NE_MASK (0x1U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12NE_SHIFT (0U)
/*! FEVTAC12NE - Force event auto command 12 not executed */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12NE(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTAC12NE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTAC12NE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12TOE_MASK (0x2U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12TOE_SHIFT (1U)
/*! FEVTAC12TOE - Force event auto command 12 time out error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12TOE(x)  (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTAC12TOE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTAC12TOE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12CE_MASK (0x4U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12CE_SHIFT (2U)
/*! FEVTAC12CE - Force event auto command 12 CRC error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12CE(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTAC12CE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTAC12CE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12EBE_MASK (0x8U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12EBE_SHIFT (3U)
/*! FEVTAC12EBE - Force event Auto Command 12 end bit error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12EBE(x)  (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTAC12EBE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTAC12EBE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12IE_MASK (0x10U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12IE_SHIFT (4U)
/*! FEVTAC12IE - Force event Auto Command 12 index error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12IE(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTAC12IE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTAC12IE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTCNIBAC12E_MASK (0x80U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCNIBAC12E_SHIFT (7U)
/*! FEVTCNIBAC12E - Force event command not executed by Auto Command 12 error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCNIBAC12E(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTCNIBAC12E_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTCNIBAC12E_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTCTOE_MASK   (0x10000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCTOE_SHIFT  (16U)
/*! FEVTCTOE - Force event command time out error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCTOE(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTCTOE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTCTOE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTCCE_MASK    (0x20000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCCE_SHIFT   (17U)
/*! FEVTCCE - Force event command CRC error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCCE(x)      (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTCCE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTCCE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTCEBE_MASK   (0x40000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCEBE_SHIFT  (18U)
/*! FEVTCEBE - Force event command end bit error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCEBE(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTCEBE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTCEBE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTCIE_MASK    (0x80000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCIE_SHIFT   (19U)
/*! FEVTCIE - Force event command index error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCIE(x)      (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTCIE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTCIE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTDTOE_MASK   (0x100000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDTOE_SHIFT  (20U)
/*! FEVTDTOE - Force event data time out error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDTOE(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTDTOE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTDTOE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTDCE_MASK    (0x200000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDCE_SHIFT   (21U)
/*! FEVTDCE - Force event data CRC error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDCE(x)      (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTDCE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTDCE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTDEBE_MASK   (0x400000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDEBE_SHIFT  (22U)
/*! FEVTDEBE - Force event data end bit error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDEBE(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTDEBE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTDEBE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12E_MASK  (0x1000000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12E_SHIFT (24U)
/*! FEVTAC12E - Force event Auto Command 12 error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTAC12E(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTAC12E_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTAC12E_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTTNE_MASK    (0x4000000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTTNE_SHIFT   (26U)
/*! FEVTTNE - Force tuning error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTTNE(x)      (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTTNE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTTNE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTDMAE_MASK   (0x10000000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDMAE_SHIFT  (28U)
/*! FEVTDMAE - Force event DMA error */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTDMAE(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTDMAE_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTDMAE_MASK)

#define WAKEUP_USDHC_FORCE_EVENT_FEVTCINT_MASK   (0x80000000U)
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCINT_SHIFT  (31U)
/*! FEVTCINT - Force event card interrupt */
#define WAKEUP_USDHC_FORCE_EVENT_FEVTCINT(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_FORCE_EVENT_FEVTCINT_SHIFT)) & WAKEUP_USDHC_FORCE_EVENT_FEVTCINT_MASK)
/*! @} */

/*! @name ADMA_ERR_STATUS - ADMA Error Status */
/*! @{ */

#define WAKEUP_USDHC_ADMA_ERR_STATUS_ADMAES_MASK (0x3U)
#define WAKEUP_USDHC_ADMA_ERR_STATUS_ADMAES_SHIFT (0U)
/*! ADMAES - ADMA error state (when ADMA error is occurred) */
#define WAKEUP_USDHC_ADMA_ERR_STATUS_ADMAES(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_ADMA_ERR_STATUS_ADMAES_SHIFT)) & WAKEUP_USDHC_ADMA_ERR_STATUS_ADMAES_MASK)
...
#define WAKEUP_USDHC_ADMA_SYS_ADDR_ADS_ADDR_MASK (0xFFFFFFFCU)
#define WAKEUP_USDHC_ADMA_SYS_ADDR_ADS_ADDR_SHIFT (2U)
/*! ADS_ADDR - ADMA system address */
#define WAKEUP_USDHC_ADMA_SYS_ADDR_ADS_ADDR(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_ADMA_SYS_ADDR_ADS_ADDR_SHIFT)) & WAKEUP_USDHC_ADMA_SYS_ADDR_ADS_ADDR_MASK)
/*! @} */

/*! @name DLL_CTRL - DLL (Delay Line) Control */
/*! @{ */

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_ENABLE_MASK (0x1U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_ENABLE_SHIFT (0U)
/*! DLL_CTRL_ENABLE - DLL and delay chain */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_ENABLE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_ENABLE_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_ENABLE_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_RESET_MASK (0x2U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_RESET_SHIFT (1U)
/*! DLL_CTRL_RESET - DLL reset */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_RESET(x)  (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_RESET_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_RESET_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_FORCE_UPD_MASK (0x4U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_FORCE_UPD_SHIFT (2U)
/*! DLL_CTRL_SLV_FORCE_UPD - DLL slave delay line */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_FORCE_UPD(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_FORCE_UPD_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_FORCE_UPD_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET0_MASK (0x78U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET0_SHIFT (3U)
/*! DLL_CTRL_SLV_DLY_TARGET0 - DLL slave delay target0 */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET0(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET0_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET0_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_GATE_UPDATE_MASK (0x80U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_GATE_UPDATE_SHIFT (7U)
/*! DLL_CTRL_GATE_UPDATE - DLL gate update */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_GATE_UPDATE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_GATE_UPDATE_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_GATE_UPDATE_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_MASK (0x100U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_SHIFT (8U)
...
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_VAL_MASK (0xFE00U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_VAL_SHIFT (9U)
/*! DLL_CTRL_SLV_OVERRIDE_VAL - DLL slave override val */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_VAL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_VAL_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_OVERRIDE_VAL_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET1_MASK (0x70000U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET1_SHIFT (16U)
/*! DLL_CTRL_SLV_DLY_TARGET1 - DLL slave delay target1 */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET1(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET1_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_DLY_TARGET1_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_UPDATE_INT_MASK (0xFF00000U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_UPDATE_INT_SHIFT (20U)
/*! DLL_CTRL_SLV_UPDATE_INT - Slave delay line update interval */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_UPDATE_INT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_UPDATE_INT_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_SLV_UPDATE_INT_MASK)

#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_REF_UPDATE_INT_MASK (0xF0000000U)
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_REF_UPDATE_INT_SHIFT (28U)
/*! DLL_CTRL_REF_UPDATE_INT - DLL control loop update interval */
#define WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_REF_UPDATE_INT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_REF_UPDATE_INT_SHIFT)) & WAKEUP_USDHC_DLL_CTRL_DLL_CTRL_REF_UPDATE_INT_MASK)
/*! @} */

/*! @name DLL_STATUS - DLL Status */
/*! @{ */

#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_LOCK_MASK (0x1U)
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_LOCK_SHIFT (0U)
/*! DLL_STS_SLV_LOCK - Slave delay-line lock status */
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_LOCK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_LOCK_SHIFT)) & WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_LOCK_MASK)

#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_LOCK_MASK (0x2U)
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_LOCK_SHIFT (1U)
/*! DLL_STS_REF_LOCK - Reference DLL lock status */
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_LOCK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_LOCK_SHIFT)) & WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_LOCK_MASK)

#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_SEL_MASK (0x1FCU)
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_SEL_SHIFT (2U)
/*! DLL_STS_SLV_SEL - Slave delay line select status */
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_SEL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_SEL_SHIFT)) & WAKEUP_USDHC_DLL_STATUS_DLL_STS_SLV_SEL_MASK)

#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_SEL_MASK (0xFE00U)
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_SEL_SHIFT (9U)
/*! DLL_STS_REF_SEL - Reference delay line select taps */
#define WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_SEL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_SEL_SHIFT)) & WAKEUP_USDHC_DLL_STATUS_DLL_STS_REF_SEL_MASK)
/*! @} */

/*! @name CLK_TUNE_CTRL_STATUS - CLK Tuning Control and Status */
/*! @{ */

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST_MASK (0xFU)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST_SHIFT (0U)
/*! DLY_CELL_SET_POST - Delay cells on the feedback clock between CLK_OUT and CLK_POST */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT_MASK (0xF0U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT_SHIFT (4U)
/*! DLY_CELL_SET_OUT - Delay cells on the feedback clock between CLK_PRE and CLK_OUT */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE_MASK (0x7F00U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE_SHIFT (8U)
/*! DLY_CELL_SET_PRE - delay cells on the feedback clock between the feedback clock and CLK_PRE */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_NXT_ERR_MASK (0x8000U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_NXT_ERR_SHIFT (15U)
/*! NXT_ERR - NXT error */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_NXT_ERR(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_NXT_ERR_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_NXT_ERR_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_POST_MASK (0xF0000U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_POST_SHIFT (16U)
/*! TAP_SEL_POST - Delay cells added on the feedback clock between CLK_OUT and CLK_POST */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_POST(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_POST_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_POST_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_OUT_MASK (0xF00000U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_OUT_SHIFT (20U)
/*! TAP_SEL_OUT - Delay cells added on the feedback clock between CLK_PRE and CLK_OUT */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_OUT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_OUT_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_OUT_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_PRE_MASK (0x7F000000U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_PRE_SHIFT (24U)
/*! TAP_SEL_PRE - TAP_SEL_PRE */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_PRE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_PRE_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_TAP_SEL_PRE_MASK)

#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_PRE_ERR_MASK (0x80000000U)
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_PRE_ERR_SHIFT (31U)
/*! PRE_ERR - PRE error */
#define WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_PRE_ERR(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_PRE_ERR_SHIFT)) & WAKEUP_USDHC_CLK_TUNE_CTRL_STATUS_PRE_ERR_MASK)
/*! @} */

/*! @name STROBE_DLL_CTRL - Strobe DLL control */
/*! @{ */

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_ENABLE_MASK (0x1U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_ENABLE_SHIFT (0U)
/*! STROBE_DLL_CTRL_ENABLE - Strobe DLL control enable */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_ENABLE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_ENABLE_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_ENABLE_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_RESET_MASK (0x2U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_RESET_SHIFT (1U)
/*! STROBE_DLL_CTRL_RESET - Strobe DLL control reset */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_RESET(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_RESET_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_RESET_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_FORCE_UPD_MASK (0x4U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_FORCE_UPD_SHIFT (2U)
/*! STROBE_DLL_CTRL_SLV_FORCE_UPD - Strobe DLL control slave force updated */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_FORCE_UPD(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_FORCE_UPD_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_FORCE_UPD_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_DLY_TARGET_MASK (0x78U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_DLY_TARGET_SHIFT (3U)
/*! STROBE_DLL_CTRL_SLV_DLY_TARGET - Strobe DLL Control Slave Delay Target */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_DLY_TARGET(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_DLY_TARGET_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_DLY_TARGET_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_GATE_UPDATE_MASK (0x80U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_GATE_UPDATE_SHIFT (7U)
/*! STROBE_DLL_CTRL_GATE_UPDATE - Strobe DLL control gate update */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_GATE_UPDATE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_GATE_UPDATE_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_GATE_UPDATE_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_MASK (0x100U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_SHIFT (8U)
/*! STROBE_DLL_CTRL_SLV_OVERRIDE - Strobe DLL control slave override */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_VAL_MASK (0xFE00U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_VAL_SHIFT (9U)
/*! STROBE_DLL_CTRL_SLV_OVERRIDE_VAL - Strobe DLL control slave Override value */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_VAL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_VAL_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_OVERRIDE_VAL_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_UPDATE_INT_MASK (0xFF00000U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_UPDATE_INT_SHIFT (20U)
/*! STROBE_DLL_CTRL_SLV_UPDATE_INT - Strobe DLL control slave update interval */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_UPDATE_INT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_UPDATE_INT_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_SLV_UPDATE_INT_MASK)

#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_REF_UPDATE_INT_MASK (0xF0000000U)
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_REF_UPDATE_INT_SHIFT (28U)
/*! STROBE_DLL_CTRL_REF_UPDATE_INT - Strobe DLL control reference update interval */
#define WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_REF_UPDATE_INT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_REF_UPDATE_INT_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_CTRL_STROBE_DLL_CTRL_REF_UPDATE_INT_MASK)
/*! @} */

/*! @name STROBE_DLL_STATUS - Strobe DLL status */
/*! @{ */

#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_LOCK_MASK (0x1U)
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_LOCK_SHIFT (0U)
/*! STROBE_DLL_STS_SLV_LOCK - Strobe DLL status slave lock */
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_LOCK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_LOCK_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_LOCK_MASK)

#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_LOCK_MASK (0x2U)
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_LOCK_SHIFT (1U)
/*! STROBE_DLL_STS_REF_LOCK - Strobe DLL status reference lock */
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_LOCK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_LOCK_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_LOCK_MASK)

#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_SEL_MASK (0x1FCU)
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_SEL_SHIFT (2U)
/*! STROBE_DLL_STS_SLV_SEL - Strobe DLL status slave select */
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_SEL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_SEL_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_SLV_SEL_MASK)

#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_SEL_MASK (0xFE00U)
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_SEL_SHIFT (9U)
/*! STROBE_DLL_STS_REF_SEL - Strobe DLL status reference select */
#define WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_SEL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_SEL_SHIFT)) & WAKEUP_USDHC_STROBE_DLL_STATUS_STROBE_DLL_STS_REF_SEL_MASK)
/*! @} */
...
#define WAKEUP_USDHC_VEND_SPEC_AC12_WR_CHKBUSY_EN_MASK (0x8U)
#define WAKEUP_USDHC_VEND_SPEC_AC12_WR_CHKBUSY_EN_SHIFT (3U)
 ...
 */
#define WAKEUP_USDHC_VEND_SPEC_AC12_WR_CHKBUSY_EN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC_AC12_WR_CHKBUSY_EN_SHIFT)) & WAKEUP_USDHC_VEND_SPEC_AC12_WR_CHKBUSY_EN_MASK)

#define WAKEUP_USDHC_VEND_SPEC_FRC_SDCLK_ON_MASK (0x100U)
#define WAKEUP_USDHC_VEND_SPEC_FRC_SDCLK_ON_SHIFT (8U)
/*! FRC_SDCLK_ON - Force CLK
 *  0b0..CLK active or inactive is fully controlled by the hardware.
 *  0b1..Force CLK active
 */
#define WAKEUP_USDHC_VEND_SPEC_FRC_SDCLK_ON(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC_FRC_SDCLK_ON_SHIFT)) & WAKEUP_USDHC_VEND_SPEC_FRC_SDCLK_ON_MASK)

#define WAKEUP_USDHC_VEND_SPEC_CRC_CHK_DIS_MASK  (0x8000U)
#define WAKEUP_USDHC_VEND_SPEC_CRC_CHK_DIS_SHIFT (15U)
 ...
 */
#define WAKEUP_USDHC_VEND_SPEC_CRC_CHK_DIS(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC_CRC_CHK_DIS_SHIFT)) & WAKEUP_USDHC_VEND_SPEC_CRC_CHK_DIS_MASK)

#define WAKEUP_USDHC_VEND_SPEC_CMD_BYTE_EN_MASK  (0x80000000U)
#define WAKEUP_USDHC_VEND_SPEC_CMD_BYTE_EN_SHIFT (31U)
 ...
 */
#define WAKEUP_USDHC_VEND_SPEC_CMD_BYTE_EN(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC_CMD_BYTE_EN_SHIFT)) & WAKEUP_USDHC_VEND_SPEC_CMD_BYTE_EN_MASK)
/*! @} */

/*! @name MMC_BOOT - eMMC Boot */
/*! @{ */

#define WAKEUP_USDHC_MMC_BOOT_DTOCV_ACK_MASK     (0xFU)
#define WAKEUP_USDHC_MMC_BOOT_DTOCV_ACK_SHIFT    (0U)
/*! DTOCV_ACK - DTOCV_ACK
 *  0b0000..SDCLK x 2^32
 *  0b0001..SDCLK x 2^33
 *  0b0010..SDCLK x 2^18
 ...
 *  0b1111..SDCLK x 2^31
 */
#define WAKEUP_USDHC_MMC_BOOT_DTOCV_ACK(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_DTOCV_ACK_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_DTOCV_ACK_MASK)

#define WAKEUP_USDHC_MMC_BOOT_BOOT_ACK_MASK      (0x10U)
#define WAKEUP_USDHC_MMC_BOOT_BOOT_ACK_SHIFT     (4U)
/*! BOOT_ACK - BOOT ACK
 *  0b0..No ack
 *  0b1..Ack
 */
#define WAKEUP_USDHC_MMC_BOOT_BOOT_ACK(x)        (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_BOOT_ACK_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_BOOT_ACK_MASK)

#define WAKEUP_USDHC_MMC_BOOT_BOOT_MODE_MASK     (0x20U)
#define WAKEUP_USDHC_MMC_BOOT_BOOT_MODE_SHIFT    (5U)
/*! BOOT_MODE - Boot mode
 *  0b0..Normal boot
 *  0b1..Alternative boot
 */
#define WAKEUP_USDHC_MMC_BOOT_BOOT_MODE(x)       (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_BOOT_MODE_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_BOOT_MODE_MASK)

#define WAKEUP_USDHC_MMC_BOOT_BOOT_EN_MASK       (0x40U)
#define WAKEUP_USDHC_MMC_BOOT_BOOT_EN_SHIFT      (6U)
/*! BOOT_EN - Boot enable
 *  0b0..Fast boot disable
 *  0b1..Fast boot enable
 */
#define WAKEUP_USDHC_MMC_BOOT_BOOT_EN(x)         (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_BOOT_EN_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_BOOT_EN_MASK)

#define WAKEUP_USDHC_MMC_BOOT_AUTO_SABG_EN_MASK  (0x80U)
#define WAKEUP_USDHC_MMC_BOOT_AUTO_SABG_EN_SHIFT (7U)
/*! AUTO_SABG_EN - Auto stop at block gap */
#define WAKEUP_USDHC_MMC_BOOT_AUTO_SABG_EN(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_AUTO_SABG_EN_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_AUTO_SABG_EN_MASK)

#define WAKEUP_USDHC_MMC_BOOT_DISABLE_TIME_OUT_MASK (0x100U)
#define WAKEUP_USDHC_MMC_BOOT_DISABLE_TIME_OUT_SHIFT (8U)
/*! DISABLE_TIME_OUT - Time out
 *  0b0..Enable time out
 *  0b1..Disable time out
 */
#define WAKEUP_USDHC_MMC_BOOT_DISABLE_TIME_OUT(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_DISABLE_TIME_OUT_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_DISABLE_TIME_OUT_MASK)

#define WAKEUP_USDHC_MMC_BOOT_BOOT_BLK_CNT_MASK  (0xFFFF0000U)
#define WAKEUP_USDHC_MMC_BOOT_BOOT_BLK_CNT_SHIFT (16U)
/*! BOOT_BLK_CNT - Stop At Block Gap value of automatic mode */
#define WAKEUP_USDHC_MMC_BOOT_BOOT_BLK_CNT(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_MMC_BOOT_BOOT_BLK_CNT_SHIFT)) & WAKEUP_USDHC_MMC_BOOT_BOOT_BLK_CNT_MASK)
/*! @} */

/*! @name VEND_SPEC2 - Vendor Specific 2 Register */
/*! @{ */

#define WAKEUP_USDHC_VEND_SPEC2_CARD_INT_D3_TEST_MASK (0x8U)
#define WAKEUP_USDHC_VEND_SPEC2_CARD_INT_D3_TEST_SHIFT (3U)
 ...
 */
#define WAKEUP_USDHC_VEND_SPEC2_CARD_INT_D3_TEST(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_CARD_INT_D3_TEST_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_CARD_INT_D3_TEST_MASK)

#define WAKEUP_USDHC_VEND_SPEC2_TUNING_BIT_EN_MASK (0x30U)
#define WAKEUP_USDHC_VEND_SPEC2_TUNING_BIT_EN_SHIFT (4U)
 ...
 *  0b11..Invalid
 */
#define WAKEUP_USDHC_VEND_SPEC2_TUNING_BIT_EN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_TUNING_BIT_EN_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_TUNING_BIT_EN_MASK)

#define WAKEUP_USDHC_VEND_SPEC2_TUNING_CMD_EN_MASK (0x40U)
#define WAKEUP_USDHC_VEND_SPEC2_TUNING_CMD_EN_SHIFT (6U)
 ...
 */
#define WAKEUP_USDHC_VEND_SPEC2_TUNING_CMD_EN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_TUNING_CMD_EN_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_TUNING_CMD_EN_MASK)

#define WAKEUP_USDHC_VEND_SPEC2_HS400_WR_CLK_STOP_EN_MASK (0x400U)
#define WAKEUP_USDHC_VEND_SPEC2_HS400_WR_CLK_STOP_EN_SHIFT (10U)
/*! HS400_WR_CLK_STOP_EN - HS400 write clock stop enable */
#define WAKEUP_USDHC_VEND_SPEC2_HS400_WR_CLK_STOP_EN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_HS400_WR_CLK_STOP_EN_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_HS400_WR_CLK_STOP_EN_MASK)

#define WAKEUP_USDHC_VEND_SPEC2_HS400_RD_CLK_STOP_EN_MASK (0x800U)
#define WAKEUP_USDHC_VEND_SPEC2_HS400_RD_CLK_STOP_EN_SHIFT (11U)
/*! HS400_RD_CLK_STOP_EN - HS400 read clock stop enable */
#define WAKEUP_USDHC_VEND_SPEC2_HS400_RD_CLK_STOP_EN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_HS400_RD_CLK_STOP_EN_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_HS400_RD_CLK_STOP_EN_MASK)
...
#define WAKEUP_USDHC_VEND_SPEC2_EN_32K_CLK_MASK  (0x8000U)
#define WAKEUP_USDHC_VEND_SPEC2_EN_32K_CLK_SHIFT (15U)
 ...
 */
#define WAKEUP_USDHC_VEND_SPEC2_EN_32K_CLK(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_EN_32K_CLK_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_EN_32K_CLK_MASK)

#define WAKEUP_USDHC_VEND_SPEC2_FBCLK_TAP_SEL_MASK (0xFFFF0000U)
#define WAKEUP_USDHC_VEND_SPEC2_FBCLK_TAP_SEL_SHIFT (16U)
/*! FBCLK_TAP_SEL - Enable extra delay on internal feedback clock */
#define WAKEUP_USDHC_VEND_SPEC2_FBCLK_TAP_SEL(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_VEND_SPEC2_FBCLK_TAP_SEL_SHIFT)) & WAKEUP_USDHC_VEND_SPEC2_FBCLK_TAP_SEL_MASK)
/*! @} */

/*! @name TUNING_CTRL - Tuning Control */
/*! @{ */

#define WAKEUP_USDHC_TUNING_CTRL_TUNING_START_TAP_MASK (0x7FU)
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_START_TAP_SHIFT (0U)
/*! TUNING_START_TAP - Tuning start */
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_START_TAP(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_TUNING_CTRL_TUNING_START_TAP_SHIFT)) & WAKEUP_USDHC_TUNING_CTRL_TUNING_START_TAP_MASK)

#define WAKEUP_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING_MASK (0x80U)
#define WAKEUP_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING_SHIFT (7U)
/*! DIS_CMD_CHK_FOR_STD_TUNING - Disable command check for standard tuning */
#define WAKEUP_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING_SHIFT)) & WAKEUP_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING_MASK)

#define WAKEUP_USDHC_TUNING_CTRL_TUNING_COUNTER_MASK (0xFF00U)
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_COUNTER_SHIFT (8U)
/*! TUNING_COUNTER - Tuning counter */
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_COUNTER(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_TUNING_CTRL_TUNING_COUNTER_SHIFT)) & WAKEUP_USDHC_TUNING_CTRL_TUNING_COUNTER_MASK)

#define WAKEUP_USDHC_TUNING_CTRL_TUNING_STEP_MASK (0x70000U)
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_STEP_SHIFT (16U)
/*! TUNING_STEP - TUNING_STEP */
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_STEP(x)  (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_TUNING_CTRL_TUNING_STEP_SHIFT)) & WAKEUP_USDHC_TUNING_CTRL_TUNING_STEP_MASK)

#define WAKEUP_USDHC_TUNING_CTRL_TUNING_WINDOW_MASK (0x700000U)
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_WINDOW_SHIFT (20U)
/*! TUNING_WINDOW - Data window */
#define WAKEUP_USDHC_TUNING_CTRL_TUNING_WINDOW(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_TUNING_CTRL_TUNING_WINDOW_SHIFT)) & WAKEUP_USDHC_TUNING_CTRL_TUNING_WINDOW_MASK)

#define WAKEUP_USDHC_TUNING_CTRL_STD_TUNING_EN_MASK (0x1000000U)
#define WAKEUP_USDHC_TUNING_CTRL_STD_TUNING_EN_SHIFT (24U)
/*! STD_TUNING_EN - Standard tuning circuit and procedure enable */
#define WAKEUP_USDHC_TUNING_CTRL_STD_TUNING_EN(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_TUNING_CTRL_STD_TUNING_EN_SHIFT)) & WAKEUP_USDHC_TUNING_CTRL_STD_TUNING_EN_MASK)
/*! @} */

/*! @name CQVER - Command Queuing Version */
/*! @{ */

#define WAKEUP_USDHC_CQVER_VERSION_SUFFIX_MASK   (0xFU)
#define WAKEUP_USDHC_CQVER_VERSION_SUFFIX_SHIFT  (0U)
/*! VERSION_SUFFIX - eMMC version suffix */
#define WAKEUP_USDHC_CQVER_VERSION_SUFFIX(x)     (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQVER_VERSION_SUFFIX_SHIFT)) & WAKEUP_USDHC_CQVER_VERSION_SUFFIX_MASK)

#define WAKEUP_USDHC_CQVER_MINOR_VN_MASK         (0xF0U)
#define WAKEUP_USDHC_CQVER_MINOR_VN_SHIFT        (4U)
/*! MINOR_VN - eMMC minor version number */
#define WAKEUP_USDHC_CQVER_MINOR_VN(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQVER_MINOR_VN_SHIFT)) & WAKEUP_USDHC_CQVER_MINOR_VN_MASK)

#define WAKEUP_USDHC_CQVER_MAJOR_VN_MASK         (0xF00U)
#define WAKEUP_USDHC_CQVER_MAJOR_VN_SHIFT        (8U)
/*! MAJOR_VN - eMMC major version number */
#define WAKEUP_USDHC_CQVER_MAJOR_VN(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQVER_MAJOR_VN_SHIFT)) & WAKEUP_USDHC_CQVER_MAJOR_VN_MASK)
/*! @} */

/*! @name CQCAP - Command Queuing Capabilities */
/*! @{ */

#define WAKEUP_USDHC_CQCAP_ITCFVAL_MASK          (0x3FFU)
#define WAKEUP_USDHC_CQCAP_ITCFVAL_SHIFT         (0U)
/*! ITCFVAL - Internal timer clock frequency value */
#define WAKEUP_USDHC_CQCAP_ITCFVAL(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCAP_ITCFVAL_SHIFT)) & WAKEUP_USDHC_CQCAP_ITCFVAL_MASK)

#define WAKEUP_USDHC_CQCAP_ITCFMUL_MASK          (0xF000U)
#define WAKEUP_USDHC_CQCAP_ITCFMUL_SHIFT         (12U)
 ...
 */
#define WAKEUP_USDHC_CQCAP_ITCFMUL(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCAP_ITCFMUL_SHIFT)) & WAKEUP_USDHC_CQCAP_ITCFMUL_MASK)
/*! @} */

/*! @name CQCFG - Command Queuing Configuration */
/*! @{ */

#define WAKEUP_USDHC_CQCFG_CQUE_MASK             (0x1U)
#define WAKEUP_USDHC_CQCFG_CQUE_SHIFT            (0U)
/*! CQUE - Command queuing enable */
#define WAKEUP_USDHC_CQCFG_CQUE(x)               (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCFG_CQUE_SHIFT)) & WAKEUP_USDHC_CQCFG_CQUE_MASK)

#define WAKEUP_USDHC_CQCFG_TDS_MASK              (0x100U)
#define WAKEUP_USDHC_CQCFG_TDS_SHIFT             (8U)
/*! TDS - Task descriptor size
 *  0b0..Task descriptor size is 64 bits
 *  0b1..Task descriptor size is 128 bits
 */
#define WAKEUP_USDHC_CQCFG_TDS(x)                (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCFG_TDS_SHIFT)) & WAKEUP_USDHC_CQCFG_TDS_MASK)

#define WAKEUP_USDHC_CQCFG_DCMDE_MASK            (0x1000U)
#define WAKEUP_USDHC_CQCFG_DCMDE_SHIFT           (12U)
 ...
 */
#define WAKEUP_USDHC_CQCFG_DCMDE(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCFG_DCMDE_SHIFT)) & WAKEUP_USDHC_CQCFG_DCMDE_MASK)
/*! @} */

/*! @name CQCTL - Command Queuing Control */
/*! @{ */

#define WAKEUP_USDHC_CQCTL_HALT_MASK             (0x1U)
#define WAKEUP_USDHC_CQCTL_HALT_SHIFT            (0U)
/*! HALT - Halt */
#define WAKEUP_USDHC_CQCTL_HALT(x)               (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCTL_HALT_SHIFT)) & WAKEUP_USDHC_CQCTL_HALT_MASK)

#define WAKEUP_USDHC_CQCTL_CLEAR_MASK            (0x100U)
#define WAKEUP_USDHC_CQCTL_CLEAR_SHIFT           (8U)
/*! CLEAR - Clear all tasks */
#define WAKEUP_USDHC_CQCTL_CLEAR(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCTL_CLEAR_SHIFT)) & WAKEUP_USDHC_CQCTL_CLEAR_MASK)
/*! @} */

/*! @name CQIS - Command Queuing Interrupt Status */
/*! @{ */

#define WAKEUP_USDHC_CQIS_HAC_MASK               (0x1U)
#define WAKEUP_USDHC_CQIS_HAC_SHIFT              (0U)
/*! HAC - Halt complete interrupt */
#define WAKEUP_USDHC_CQIS_HAC(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIS_HAC_SHIFT)) & WAKEUP_USDHC_CQIS_HAC_MASK)

#define WAKEUP_USDHC_CQIS_TCC_MASK               (0x2U)
#define WAKEUP_USDHC_CQIS_TCC_SHIFT              (1U)
/*! TCC - Task complete interrupt */
#define WAKEUP_USDHC_CQIS_TCC(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIS_TCC_SHIFT)) & WAKEUP_USDHC_CQIS_TCC_MASK)

#define WAKEUP_USDHC_CQIS_RED_MASK               (0x4U)
#define WAKEUP_USDHC_CQIS_RED_SHIFT              (2U)
/*! RED - Response error detected interrupt */
#define WAKEUP_USDHC_CQIS_RED(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIS_RED_SHIFT)) & WAKEUP_USDHC_CQIS_RED_MASK)

#define WAKEUP_USDHC_CQIS_TCL_MASK               (0x8U)
#define WAKEUP_USDHC_CQIS_TCL_SHIFT              (3U)
/*! TCL - Task cleared */
#define WAKEUP_USDHC_CQIS_TCL(x)                 (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIS_TCL_SHIFT)) & WAKEUP_USDHC_CQIS_TCL_MASK)
/*! @} */

/*! @name CQISTE - Command Queuing Interrupt Status Enable */
/*! @{ */

#define WAKEUP_USDHC_CQISTE_HAC_STE_MASK         (0x1U)
#define WAKEUP_USDHC_CQISTE_HAC_STE_SHIFT        (0U)
/*! HAC_STE - Halt complete status enable
 *  0b0..CQIS[HAC] is disabled
 *  0b1..CQIS[HAC] is set when its interrupt condition is active
 */
#define WAKEUP_USDHC_CQISTE_HAC_STE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISTE_HAC_STE_SHIFT)) & WAKEUP_USDHC_CQISTE_HAC_STE_MASK)

#define WAKEUP_USDHC_CQISTE_TCC_STE_MASK         (0x2U)
#define WAKEUP_USDHC_CQISTE_TCC_STE_SHIFT        (1U)
/*! TCC_STE - Task complete status enable
 *  0b0..CQIS[TCC] is disabled
 *  0b1..CQIS[TCC] is set when its interrupt condition is active
 */
#define WAKEUP_USDHC_CQISTE_TCC_STE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISTE_TCC_STE_SHIFT)) & WAKEUP_USDHC_CQISTE_TCC_STE_MASK)

#define WAKEUP_USDHC_CQISTE_RED_STE_MASK         (0x4U)
#define WAKEUP_USDHC_CQISTE_RED_STE_SHIFT        (2U)
 ...
 */
#define WAKEUP_USDHC_CQISTE_RED_STE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISTE_RED_STE_SHIFT)) & WAKEUP_USDHC_CQISTE_RED_STE_MASK)

#define WAKEUP_USDHC_CQISTE_TCL_STE_MASK         (0x8U)
#define WAKEUP_USDHC_CQISTE_TCL_STE_SHIFT        (3U)
/*! TCL_STE - Task cleared status enable
 *  0b0..CQIS[TCL] is disabled
 *  0b1..CQIS[TCL] is set when its interrupt condition is active
 */
#define WAKEUP_USDHC_CQISTE_TCL_STE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISTE_TCL_STE_SHIFT)) & WAKEUP_USDHC_CQISTE_TCL_STE_MASK)
/*! @} */

/*! @name CQISGE - Command Queuing Interrupt Signal Enable */
/*! @{ */

#define WAKEUP_USDHC_CQISGE_HAC_SGE_MASK         (0x1U)
#define WAKEUP_USDHC_CQISGE_HAC_SGE_SHIFT        (0U)
/*! HAC_SGE - Halt complete signal enable */
#define WAKEUP_USDHC_CQISGE_HAC_SGE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISGE_HAC_SGE_SHIFT)) & WAKEUP_USDHC_CQISGE_HAC_SGE_MASK)

#define WAKEUP_USDHC_CQISGE_TCC_SGE_MASK         (0x2U)
#define WAKEUP_USDHC_CQISGE_TCC_SGE_SHIFT        (1U)
/*! TCC_SGE - Task complete signal enable */
#define WAKEUP_USDHC_CQISGE_TCC_SGE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISGE_TCC_SGE_SHIFT)) & WAKEUP_USDHC_CQISGE_TCC_SGE_MASK)

#define WAKEUP_USDHC_CQISGE_RED_SGE_MASK         (0x4U)
#define WAKEUP_USDHC_CQISGE_RED_SGE_SHIFT        (2U)
/*! RED_SGE - Response error detected signal enable */
#define WAKEUP_USDHC_CQISGE_RED_SGE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISGE_RED_SGE_SHIFT)) & WAKEUP_USDHC_CQISGE_RED_SGE_MASK)

#define WAKEUP_USDHC_CQISGE_TCL_SGE_MASK         (0x8U)
#define WAKEUP_USDHC_CQISGE_TCL_SGE_SHIFT        (3U)
/*! TCL_SGE - Task cleared signal enable */
#define WAKEUP_USDHC_CQISGE_TCL_SGE(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQISGE_TCL_SGE_SHIFT)) & WAKEUP_USDHC_CQISGE_TCL_SGE_MASK)
/*! @} */

/*! @name CQIC - Command Queuing Interrupt Coalescing */
/*! @{ */

#define WAKEUP_USDHC_CQIC_ICTOVAL_MASK           (0x7FU)
#define WAKEUP_USDHC_CQIC_ICTOVAL_SHIFT          (0U)
/*! ICTOVAL - Interrupt coalescing timeout value */
#define WAKEUP_USDHC_CQIC_ICTOVAL(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICTOVAL_SHIFT)) & WAKEUP_USDHC_CQIC_ICTOVAL_MASK)

#define WAKEUP_USDHC_CQIC_ICTOVALWEN_MASK        (0x80U)
#define WAKEUP_USDHC_CQIC_ICTOVALWEN_SHIFT       (7U)
/*! ICTOVALWEN - Interrupt coalescing timeout value write enable */
#define WAKEUP_USDHC_CQIC_ICTOVALWEN(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICTOVALWEN_SHIFT)) & WAKEUP_USDHC_CQIC_ICTOVALWEN_MASK)

#define WAKEUP_USDHC_CQIC_ICCTH_MASK             (0x1F00U)
#define WAKEUP_USDHC_CQIC_ICCTH_SHIFT            (8U)
/*! ICCTH - Interrupt coalescing counter threshold */
#define WAKEUP_USDHC_CQIC_ICCTH(x)               (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICCTH_SHIFT)) & WAKEUP_USDHC_CQIC_ICCTH_MASK)

#define WAKEUP_USDHC_CQIC_ICCTHWEN_MASK          (0x8000U)
#define WAKEUP_USDHC_CQIC_ICCTHWEN_SHIFT         (15U)
/*! ICCTHWEN - Interrupt coalescing counter threshold write enable */
#define WAKEUP_USDHC_CQIC_ICCTHWEN(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICCTHWEN_SHIFT)) & WAKEUP_USDHC_CQIC_ICCTHWEN_MASK)

#define WAKEUP_USDHC_CQIC_ICCTR_MASK             (0x10000U)
#define WAKEUP_USDHC_CQIC_ICCTR_SHIFT            (16U)
/*! ICCTR - Counter and timer reset */
#define WAKEUP_USDHC_CQIC_ICCTR(x)               (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICCTR_SHIFT)) & WAKEUP_USDHC_CQIC_ICCTR_MASK)

#define WAKEUP_USDHC_CQIC_ICSB_MASK              (0x100000U)
#define WAKEUP_USDHC_CQIC_ICSB_SHIFT             (20U)
 ...
 */
#define WAKEUP_USDHC_CQIC_ICSB(x)                (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICSB_SHIFT)) & WAKEUP_USDHC_CQIC_ICSB_MASK)

#define WAKEUP_USDHC_CQIC_ICENDIS_MASK           (0x80000000U)
#define WAKEUP_USDHC_CQIC_ICENDIS_SHIFT          (31U)
/*! ICENDIS - Interrupt coalescing enable/disable */
#define WAKEUP_USDHC_CQIC_ICENDIS(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQIC_ICENDIS_SHIFT)) & WAKEUP_USDHC_CQIC_ICENDIS_MASK)
/*! @} */

/*! @name CQTDLBA - Command Queuing Task Descriptor List Base Address */
/*! @{ */

#define WAKEUP_USDHC_CQTDLBA_TDLBA_MASK          (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQTDLBA_TDLBA_SHIFT         (0U)
/*! TDLBA - Task descriptor list base address */
#define WAKEUP_USDHC_CQTDLBA_TDLBA(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTDLBA_TDLBA_SHIFT)) & WAKEUP_USDHC_CQTDLBA_TDLBA_MASK)
/*! @} */

/*! @name CQTDLBAU - Command Queuing Task Descriptor List Base Address Upper 32 Bits */
/*! @{ */

#define WAKEUP_USDHC_CQTDLBAU_TDLBAU_MASK        (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQTDLBAU_TDLBAU_SHIFT       (0U)
/*! TDLBAU - Task descriptor list base address */
#define WAKEUP_USDHC_CQTDLBAU_TDLBAU(x)          (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTDLBAU_TDLBAU_SHIFT)) & WAKEUP_USDHC_CQTDLBAU_TDLBAU_MASK)
/*! @} */

/*! @name CQTDBR - Command Queuing Task Doorbell */
/*! @{ */

#define WAKEUP_USDHC_CQTDBR_TDBR_MASK            (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQTDBR_TDBR_SHIFT           (0U)
/*! TDBR - Task doorbell */
#define WAKEUP_USDHC_CQTDBR_TDBR(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTDBR_TDBR_SHIFT)) & WAKEUP_USDHC_CQTDBR_TDBR_MASK)
/*! @} */

/*! @name CQTCN - Command Queuing Task Completion Notification */
/*! @{ */

#define WAKEUP_USDHC_CQTCN_TCN_MASK              (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQTCN_TCN_SHIFT             (0U)
/*! TCN - Task complete notification */
#define WAKEUP_USDHC_CQTCN_TCN(x)                (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTCN_TCN_SHIFT)) & WAKEUP_USDHC_CQTCN_TCN_MASK)
/*! @} */

/*! @name CQDQS - Command Queuing Device Queue Status */
/*! @{ */

#define WAKEUP_USDHC_CQDQS_DQS_MASK              (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQDQS_DQS_SHIFT             (0U)
/*! DQS - Device queue status */
#define WAKEUP_USDHC_CQDQS_DQS(x)                (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQDQS_DQS_SHIFT)) & WAKEUP_USDHC_CQDQS_DQS_MASK)
/*! @} */

/*! @name CQDPT - Command Queuing Device Pending Tasks */
/*! @{ */

#define WAKEUP_USDHC_CQDPT_DPT_MASK              (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQDPT_DPT_SHIFT             (0U)
/*! DPT - Device pending tasks */
#define WAKEUP_USDHC_CQDPT_DPT(x)                (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQDPT_DPT_SHIFT)) & WAKEUP_USDHC_CQDPT_DPT_MASK)
/*! @} */

/*! @name CQTCLR - Command Queuing Task Clear */
/*! @{ */

#define WAKEUP_USDHC_CQTCLR_TCLR_MASK            (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQTCLR_TCLR_SHIFT           (0U)
/*! TCLR - Task clear */
#define WAKEUP_USDHC_CQTCLR_TCLR(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTCLR_TCLR_SHIFT)) & WAKEUP_USDHC_CQTCLR_TCLR_MASK)
/*! @} */

/*! @name CQSSC1 - Command Queuing Send Status Configuration 1 */
/*! @{ */

#define WAKEUP_USDHC_CQSSC1_CIT_MASK             (0xFFFFU)
#define WAKEUP_USDHC_CQSSC1_CIT_SHIFT            (0U)
/*! CIT - Send status command idle timer */
#define WAKEUP_USDHC_CQSSC1_CIT(x)               (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQSSC1_CIT_SHIFT)) & WAKEUP_USDHC_CQSSC1_CIT_MASK)

#define WAKEUP_USDHC_CQSSC1_CBC_MASK             (0xF0000U)
#define WAKEUP_USDHC_CQSSC1_CBC_SHIFT            (16U)
/*! CBC - Send status command block counter */
#define WAKEUP_USDHC_CQSSC1_CBC(x)               (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQSSC1_CBC_SHIFT)) & WAKEUP_USDHC_CQSSC1_CBC_MASK)
/*! @} */

/*! @name CQSSC2 - Command Queuing Send Status Configuration 2 */
/*! @{ */

#define WAKEUP_USDHC_CQSSC2_SSC2_MASK            (0xFFFFU)
#define WAKEUP_USDHC_CQSSC2_SSC2_SHIFT           (0U)
/*! SSC2 - Send queue status RCA */
#define WAKEUP_USDHC_CQSSC2_SSC2(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQSSC2_SSC2_SHIFT)) & WAKEUP_USDHC_CQSSC2_SSC2_MASK)
/*! @} */

/*! @name CQCRDCT - Command Queuing Command Response for Direct-Command Task */
/*! @{ */

#define WAKEUP_USDHC_CQCRDCT_CRDCT_MASK          (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQCRDCT_CRDCT_SHIFT         (0U)
/*! CRDCT - Direct command last response */
#define WAKEUP_USDHC_CQCRDCT_CRDCT(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCRDCT_CRDCT_SHIFT)) & WAKEUP_USDHC_CQCRDCT_CRDCT_MASK)
/*! @} */

/*! @name CQRMEM - Command Queuing Response Mode Error Mask */
/*! @{ */

#define WAKEUP_USDHC_CQRMEM_RMEM_MASK            (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQRMEM_RMEM_SHIFT           (0U)
 ...
 */
#define WAKEUP_USDHC_CQRMEM_RMEM(x)              (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQRMEM_RMEM_SHIFT)) & WAKEUP_USDHC_CQRMEM_RMEM_MASK)
/*! @} */

/*! @name CQTERRI - Command Queuing Task Error Information */
/*! @{ */

#define WAKEUP_USDHC_CQTERRI_RMECI_MASK          (0x3FU)
#define WAKEUP_USDHC_CQTERRI_RMECI_SHIFT         (0U)
/*! RMECI - Response mode error command index */
#define WAKEUP_USDHC_CQTERRI_RMECI(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTERRI_RMECI_SHIFT)) & WAKEUP_USDHC_CQTERRI_RMECI_MASK)

#define WAKEUP_USDHC_CQTERRI_RMETID_MASK         (0x1F00U)
#define WAKEUP_USDHC_CQTERRI_RMETID_SHIFT        (8U)
/*! RMETID - Response mode error task ID */
#define WAKEUP_USDHC_CQTERRI_RMETID(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTERRI_RMETID_SHIFT)) & WAKEUP_USDHC_CQTERRI_RMETID_MASK)

#define WAKEUP_USDHC_CQTERRI_RMEFV_MASK          (0x8000U)
#define WAKEUP_USDHC_CQTERRI_RMEFV_SHIFT         (15U)
/*! RMEFV - Response mode error fields valid */
#define WAKEUP_USDHC_CQTERRI_RMEFV(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTERRI_RMEFV_SHIFT)) & WAKEUP_USDHC_CQTERRI_RMEFV_MASK)

#define WAKEUP_USDHC_CQTERRI_DTECI_MASK          (0x3F0000U)
#define WAKEUP_USDHC_CQTERRI_DTECI_SHIFT         (16U)
/*! DTECI - Data transfer error command index */
#define WAKEUP_USDHC_CQTERRI_DTECI(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTERRI_DTECI_SHIFT)) & WAKEUP_USDHC_CQTERRI_DTECI_MASK)

#define WAKEUP_USDHC_CQTERRI_DTETID_MASK         (0x1F000000U)
#define WAKEUP_USDHC_CQTERRI_DTETID_SHIFT        (24U)
/*! DTETID - Data transfer error task ID */
#define WAKEUP_USDHC_CQTERRI_DTETID(x)           (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTERRI_DTETID_SHIFT)) & WAKEUP_USDHC_CQTERRI_DTETID_MASK)

#define WAKEUP_USDHC_CQTERRI_DTEFV_MASK          (0x80000000U)
#define WAKEUP_USDHC_CQTERRI_DTEFV_SHIFT         (31U)
/*! DTEFV - Data transfer error fields valid */
#define WAKEUP_USDHC_CQTERRI_DTEFV(x)            (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQTERRI_DTEFV_SHIFT)) & WAKEUP_USDHC_CQTERRI_DTEFV_MASK)
/*! @} */

/*! @name CQCRI - Command Queuing Command Response Index */
/*! @{ */

#define WAKEUP_USDHC_CQCRI_LCMDRI_MASK           (0x3FU)
#define WAKEUP_USDHC_CQCRI_LCMDRI_SHIFT          (0U)
/*! LCMDRI - Last command response index */
#define WAKEUP_USDHC_CQCRI_LCMDRI(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCRI_LCMDRI_SHIFT)) & WAKEUP_USDHC_CQCRI_LCMDRI_MASK)
/*! @} */

/*! @name CQCRA - Command Queuing Command Response Argument */
/*! @{ */

#define WAKEUP_USDHC_CQCRA_LCMDRA_MASK           (0xFFFFFFFFU)
#define WAKEUP_USDHC_CQCRA_LCMDRA_SHIFT          (0U)
/*! LCMDRA - Last command response argument */
#define WAKEUP_USDHC_CQCRA_LCMDRA(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_USDHC_CQCRA_LCMDRA_SHIFT)) & WAKEUP_USDHC_CQCRA_LCMDRA_MASK)
/*! @} */
...
/*!
 * @}
 */ /* end of group WAKEUP_USDHC_Peripheral_Access_Layer */
