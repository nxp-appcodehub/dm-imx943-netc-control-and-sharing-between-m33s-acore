...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for SW_PSEUDO_MAC_PORT
**
...
/*!
 * @file SW_PSEUDO_MAC_PORT.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for SW_PSEUDO_MAC_PORT
 *
 * CMSIS Peripheral Access Layer for SW_PSEUDO_MAC_PORT
 */

#if !defined(SW_PSEUDO_MAC_PORT_H_)
#define SW_PSEUDO_MAC_PORT_H_                    /**< Symbol preventing repeated inclusion */
