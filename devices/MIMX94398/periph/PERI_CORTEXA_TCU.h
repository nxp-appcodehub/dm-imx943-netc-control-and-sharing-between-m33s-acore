...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for CORTEXA_TCU
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for CORTEXA_TCU
 *
 * CMSIS Peripheral Access Layer for CORTEXA_TCU
 */

#if !defined(CORTEXA_TCU_H_)
#define CORTEXA_TCU_H_                           /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- CORTEXA_TCU Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CORTEXA_TCU_Peripheral_Access_Layer CORTEXA_TCU Peripheral Access Layer
 * @{
 */

/** CORTEXA_TCU - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- CORTEXA_TCU Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CORTEXA_TCU_Register_Masks CORTEXA_TCU Register Masks
 * @{
 */
...
#define CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_MASK (0xFFFFFFFFU)
#define CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_SHIFT (0U)
/*! out - 32-Bit Magic KW0 used in conjuction with Magic KW1 to unlock the writes to test mode registers (Value is 0x12345678) */
#define CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW0_out(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_SHIFT)) & CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_MASK)
/*! @} */

/*! @name TCU_MAGIC_KW__MAGIC_KW1 - Magic KW1 */
/*! @{ */

#define CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_MASK (0xFFFFFFFFU)
#define CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_SHIFT (0U)
/*! out - 32-Bit Magic KW1 used in conjuction with Magic KW0 to unlock the writes to test mode registers (Value - 0x87654321) */
#define CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW1_out(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_SHIFT)) & CORTEXA_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_MASK)
/*! @} */

/*! @name TCU_PLL_COUNTER - tcu pll counter reg */
/*! @{ */

#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_rst_n_MASK (0x1U)
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_rst_n_SHIFT (0U)
/*! pll_count_rst_n - pll count reset */
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_rst_n(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_rst_n_SHIFT)) & CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_rst_n_MASK)

#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_start_MASK (0x2U)
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_start_SHIFT (1U)
/*! pll_count_start - pll count start */
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_start(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_start_SHIFT)) & CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_start_MASK)

#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_div_en_MASK (0x4U)
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_div_en_SHIFT (2U)
/*! pll_count_div_en - pll count div en */
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_div_en(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_div_en_SHIFT)) & CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_div_en_MASK)

#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_MASK (0x38U)
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_SHIFT (3U)
/*! pll_count_clk_sel - pll count clk sel */
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_clk_sel(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_SHIFT)) & CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_MASK)

#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_ref_val_MASK (0xFF00U)
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_ref_val_SHIFT (8U)
/*! pll_count_ref_val - pll count ref val */
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_ref_val(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_ref_val_SHIFT)) & CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_ref_val_MASK)

#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_cnt_MASK (0xFFFF0000U)
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_cnt_SHIFT (16U)
/*! pll_count_cnt - pll count cnt */
#define CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_cnt(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_cnt_SHIFT)) & CORTEXA_TCU_TCU_PLL_COUNTER_pll_count_cnt_MASK)
/*! @} */

/*! @name TCU_DFT_FUSE - observe MIX fuse state and override it */
/*! @{ */

#define CORTEXA_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_MASK (0x1U)
#define CORTEXA_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_SHIFT (0U)
/*! tcu_dft_fuse_disable - dft fuse disable */
#define CORTEXA_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_SHIFT)) & CORTEXA_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_MASK)

#define CORTEXA_TCU_TCU_DFT_FUSE_tcu_fuse_obs_MASK (0x3FEU)
#define CORTEXA_TCU_TCU_DFT_FUSE_tcu_fuse_obs_SHIFT (1U)
/*! tcu_fuse_obs - fuse observation */
#define CORTEXA_TCU_TCU_DFT_FUSE_tcu_fuse_obs(x) (((uint32_t)(((uint32_t)(x)) << CORTEXA_TCU_TCU_DFT_FUSE_tcu_fuse_obs_SHIFT)) & CORTEXA_TCU_TCU_DFT_FUSE_tcu_fuse_obs_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group CORTEXA_TCU_Register_Masks */


/*!
 * @}
 */ /* end of group CORTEXA_TCU_Peripheral_Access_Layer */
