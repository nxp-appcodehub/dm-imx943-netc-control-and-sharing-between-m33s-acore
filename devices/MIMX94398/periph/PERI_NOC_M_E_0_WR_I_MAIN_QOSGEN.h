...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_m_e_0_wr_I_main_QosGen
**
...
/*!
 * @file NOC_m_e_0_wr_I_main_QosGen.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_m_e_0_wr_I_main_QosGen
 *
 * CMSIS Peripheral Access Layer for NOC_m_e_0_wr_I_main_QosGen
 */

#if !defined(NOC_m_e_0_wr_I_main_QosGen_H_)
#define NOC_m_e_0_wr_I_main_QosGen_H_            /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_m_e_0_wr_I_main_QosGen Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_m_e_0_wr_I_main_QosGen_Peripheral_Access_Layer NOC_m_e_0_wr_I_main_QosGen Peripheral Access Layer
 * @{
 */

/** NOC_m_e_0_wr_I_main_QosGen - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL; /**< offset: 0x18 */
} NOC_m_e_0_wr_I_main_QosGen_Type;

/* ----------------------------------------------------------------------------
   -- NOC_m_e_0_wr_I_main_QosGen Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_m_e_0_wr_I_main_QosGen_Register_Masks NOC_m_e_0_wr_I_main_QosGen Register Masks
 * @{
 */
...
#define NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORETYPEID_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORETYPEID_MASK)

#define NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_USERID_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_USERID_MASK)

#define NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_NOCID_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P0_MASK (0x7U)
#define NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P0_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P0(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P0_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P0_MASK)

#define NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P1_MASK (0x700U)
#define NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P1_SHIFT (8U)
#define NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P1(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P1_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define NOC_m_e_0_wr_I_main_QosGen_MODE_MODE_MASK (0x3U)
#define NOC_m_e_0_wr_I_main_QosGen_MODE_MODE_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_MODE_MODE(x)  (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_MODE_MODE_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_MODE_MODE_MASK)
/*! @} */

/*! @name BANDWIDTH - Bandwidth */
/*! @{ */

#define NOC_m_e_0_wr_I_main_QosGen_BANDWIDTH_BANDWIDTH_MASK (0xFFFU)
#define NOC_m_e_0_wr_I_main_QosGen_BANDWIDTH_BANDWIDTH_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_BANDWIDTH_BANDWIDTH(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_BANDWIDTH_BANDWIDTH_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_BANDWIDTH_BANDWIDTH_MASK)
/*! @} */

/*! @name SATURATION - Saturation */
/*! @{ */

#define NOC_m_e_0_wr_I_main_QosGen_SATURATION_SATURATION_MASK (0x3FFU)
#define NOC_m_e_0_wr_I_main_QosGen_SATURATION_SATURATION_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_SATURATION_SATURATION(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_SATURATION_SATURATION_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_SATURATION_SATURATION_MASK)
/*! @} */

/*! @name M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL -  */
/*! @{ */

#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_SOCKETQOSEN_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_SOCKETQOSEN_MASK)

#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTTHREN_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTTHREN_MASK)

#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_INTCLKEN_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_INTCLKEN_MASK)

#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTLIMITEN_SHIFT)) & NOC_m_e_0_wr_I_main_QosGen_M_E_0_WR_I_MAIN_QOSGENERATOR_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_m_e_0_wr_I_main_QosGen_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_m_e_0_wr_I_main_QosGen_Peripheral_Access_Layer */
...
#endif  /* NOC_m_e_0_wr_I_main_QosGen_H_ */
