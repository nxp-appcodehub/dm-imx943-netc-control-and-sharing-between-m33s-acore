...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_LSTCU
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_LSTCU
 *
 * CMSIS Peripheral Access Layer for NOC_LSTCU
 */

#if !defined(NOC_LSTCU_H_)
#define NOC_LSTCU_H_                             /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_LSTCU Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_LSTCU_Peripheral_Access_Layer NOC_LSTCU Peripheral Access Layer
 * @{
 */

/** NOC_LSTCU - Size of Registers Arrays */
#define NOC_LSTCU_MBIST_SCH_PTR_COUNT             1u

/** NOC_LSTCU - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t MBPTR[NOC_LSTCU_MBIST_SCH_PTR_COUNT]; /**< MBIST Scheduler Pointer, array offset: 0x300, array step: 0x4 */
} NOC_LSTCU_Type;

/* ----------------------------------------------------------------------------
   -- NOC_LSTCU Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_LSTCU_Register_Masks NOC_LSTCU Register Masks
 * @{
 */
...
#define NOC_LSTCU_ERR_STAT_INVP_MB_MASK          (0x2U)
#define NOC_LSTCU_ERR_STAT_INVP_MB_SHIFT         (1U)
/*! INVP_MB - Invalid Pointer MBIST
 *  0b0..No invalid pointer
 *  0b1..Invalid BIST pointer specified
 */
#define NOC_LSTCU_ERR_STAT_INVP_MB(x)            (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_ERR_STAT_INVP_MB_SHIFT)) & NOC_LSTCU_ERR_STAT_INVP_MB_MASK)

#define NOC_LSTCU_ERR_STAT_UFSF_MASK             (0x10000U)
#define NOC_LSTCU_ERR_STAT_UFSF_SHIFT            (16U)
/*! UFSF - Unrecoverable Fault Status
 *  0b0..No unrecoverable fault
 *  0b1..Unrecoverable fault
 */
#define NOC_LSTCU_ERR_STAT_UFSF(x)               (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_ERR_STAT_UFSF_SHIFT)) & NOC_LSTCU_ERR_STAT_UFSF_MASK)

#define NOC_LSTCU_ERR_STAT_RFSF_MASK             (0x20000U)
#define NOC_LSTCU_ERR_STAT_RFSF_SHIFT            (17U)
/*! RFSF - Recoverable Fault Status
 *  0b0..No recoverable fault
 *  0b1..Recoverable fault
 */
#define NOC_LSTCU_ERR_STAT_RFSF(x)               (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_ERR_STAT_RFSF_SHIFT)) & NOC_LSTCU_ERR_STAT_RFSF_MASK)
/*! @} */

/*! @name ERR_FM - Error Fault Mapping */
/*! @{ */

#define NOC_LSTCU_ERR_FM_INVPFMMB_MASK           (0x2U)
#define NOC_LSTCU_ERR_FM_INVPFMMB_SHIFT          (1U)
/*! INVPFMMB - Invalid BIST Pointer Fault Mapping During MBIST Scheduling
 *  0b0..Recoverable
 *  0b1..Unrecoverable
 */
#define NOC_LSTCU_ERR_FM_INVPFMMB(x)             (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_ERR_FM_INVPFMMB_SHIFT)) & NOC_LSTCU_ERR_FM_INVPFMMB_MASK)
/*! @} */

/*! @name MB_RSTAT0 - MBIST Run Status 0 */
/*! @{ */

#define NOC_LSTCU_MB_RSTAT0_MBSTAT0_MASK         (0x1U)
#define NOC_LSTCU_MB_RSTAT0_MBSTAT0_SHIFT        (0U)
/*! MBSTAT0 - MBIST Run Result Status 0
 *  0b0..Pass
 *  0b1..Fail
 */
#define NOC_LSTCU_MB_RSTAT0_MBSTAT0(x)           (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_MB_RSTAT0_MBSTAT0_SHIFT)) & NOC_LSTCU_MB_RSTAT0_MBSTAT0_MASK)
/*! @} */

/*! @name MBFM0 - MBIST Fault Mapping 0 */
/*! @{ */

#define NOC_LSTCU_MBFM0_MBSTATFM0_MASK           (0x1U)
#define NOC_LSTCU_MBFM0_MBSTATFM0_SHIFT          (0U)
/*! MBSTATFM0 - MBIST Fault Mapping n
 *  0b0..Recoverable
 *  0b1..Unrecoverable
 */
#define NOC_LSTCU_MBFM0_MBSTATFM0(x)             (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_MBFM0_MBSTATFM0_SHIFT)) & NOC_LSTCU_MBFM0_MBSTATFM0_MASK)
/*! @} */

/*! @name STAG - Stagger */
/*! @{ */

#define NOC_LSTCU_STAG_MB_DELAY_MASK             (0xFF00U)
#define NOC_LSTCU_STAG_MB_DELAY_SHIFT            (8U)
/*! MB_DELAY - MBIST Delay */
#define NOC_LSTCU_STAG_MB_DELAY(x)               (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_STAG_MB_DELAY_SHIFT)) & NOC_LSTCU_STAG_MB_DELAY_MASK)
/*! @} */

/*! @name PH1_DUR - Phase 1 Duration */
/*! @{ */

#define NOC_LSTCU_PH1_DUR_PH1DUR_MASK            (0x3FFU)
#define NOC_LSTCU_PH1_DUR_PH1DUR_SHIFT           (0U)
/*! PH1DUR - Phase 1 Duration */
#define NOC_LSTCU_PH1_DUR_PH1DUR(x)              (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_PH1_DUR_PH1DUR_SHIFT)) & NOC_LSTCU_PH1_DUR_PH1DUR_MASK)
/*! @} */

/*! @name MBPTR - MBIST Scheduler Pointer */
/*! @{ */

#define NOC_LSTCU_MBPTR_MBPTR_MASK               (0xFFU)
#define NOC_LSTCU_MBPTR_MBPTR_SHIFT              (0U)
/*! MBPTR - MBIST Pointer */
#define NOC_LSTCU_MBPTR_MBPTR(x)                 (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_MBPTR_MBPTR_SHIFT)) & NOC_LSTCU_MBPTR_MBPTR_MASK)

#define NOC_LSTCU_MBPTR_MBCSM_MASK               (0x100U)
#define NOC_LSTCU_MBPTR_MBCSM_SHIFT              (8U)
/*! MBCSM - MBIST Mode
 *  0b0..Sequential
 *  0b1..Concurrent
 */
#define NOC_LSTCU_MBPTR_MBCSM(x)                 (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_MBPTR_MBCSM_SHIFT)) & NOC_LSTCU_MBPTR_MBCSM_MASK)

#define NOC_LSTCU_MBPTR_MBEOL_MASK               (0x80000000U)
#define NOC_LSTCU_MBPTR_MBEOL_SHIFT              (31U)
/*! MBEOL - MBIST End of List
 *  0b0..Not end of list
 *  0b1..End of list
 */
#define NOC_LSTCU_MBPTR_MBEOL(x)                 (((uint32_t)(((uint32_t)(x)) << NOC_LSTCU_MBPTR_MBEOL_SHIFT)) & NOC_LSTCU_MBPTR_MBEOL_MASK)
/*! @} */

/* The count of NOC_LSTCU_MBPTR */
#define NOC_LSTCU_MBPTR_COUNT                    (1U)


/*!
 * @}
 */ /* end of group NOC_LSTCU_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_LSTCU_Peripheral_Access_Layer */
