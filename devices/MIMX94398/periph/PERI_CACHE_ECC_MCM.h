...
typedef struct {
  ...
  __IO uint32_t FCCU_SW_FAULTS;                    /**< FCCU Software Faults, offset: 0xAC */
} CACHE_ECC_MCM_Type;
...
#define CACHE_ECC_MCM_FCCU_SW_FAULTS_FCCU_SW_FAULTS_MASK (0x3FU)
#define CACHE_ECC_MCM_FCCU_SW_FAULTS_FCCU_SW_FAULTS_SHIFT (0U)
/*! FCCU_SW_FAULTS - FCCU Software Faults */
#define CACHE_ECC_MCM_FCCU_SW_FAULTS_FCCU_SW_FAULTS(x) (((uint32_t)(((uint32_t)(x)) << CACHE_ECC_MCM_FCCU_SW_FAULTS_FCCU_SW_FAULTS_SHIFT)) & CACHE_ECC_MCM_FCCU_SW_FAULTS_FCCU_SW_FAULTS_MASK)
/*! @} */
