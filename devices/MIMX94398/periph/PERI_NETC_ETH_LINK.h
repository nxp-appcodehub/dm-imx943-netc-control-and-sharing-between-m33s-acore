...
typedef struct {
  ...
  __IO uint32_t PM0_MDIO_CFG;                      /**< Port MAC 0 Internal MDIO Configuration Register, offset: 0x30, not available in all instances (available on 48 out of 144) */
  __IO uint32_t PM0_MDIO_CTL;                      /**< Port MAC 0 Internal MDIO Interface Control Register, offset: 0x34, not available in all instances (available on 48 out of 144) */
  __IO uint32_t PM0_MDIO_DATA;                     /**< Port MAC 0 Internal MDIO Interface Data Register, offset: 0x38, not available in all instances (available on 48 out of 144) */
  __IO uint32_t PM0_MDIO_ADDR;                     /**< Port MAC 0 Internal MDIO Register Address Register, offset: 0x3C, not available in all instances (available on 48 out of 144) */
  ...
  __I  uint32_t PM1_IF_STATUS;                     /**< Port MAC 1 Interface Status Register, offset: 0x704 */
...
/*! REG_LOWP_RXETY - Rx low power empty indicator */
...
/*! DEV_ADDR - MDIO device address (Clause 45) / register address (Clause 22) */
...
/*! PORT_ADDR - MDIO port address (Clause 45) / PHY address (Clause 22) */
...
/*! LI_FAULT - Link Interruption fault (XGMII) event mask */
...
/*! TBCAn - Incremented for each valid frame transmitted(to the FIFO interface) in which all bits of
 *    the destination address were 1 .
 */
...
#define NETC_ETH_LINK_PM0_IF_MODE_ENA_MASK       (0x8000U)
#define NETC_ETH_LINK_PM0_IF_MODE_ENA_SHIFT      (15U)
/*! ENA - AN Enable
 *  0b0..SSP and HD fields determine the RGMII link speed and duplex mode
 *  0b1..RGMII Auto-Negotiation Enabled - PHY in-band status information is used to select the speed of operation and duplex mode.
 */
#define NETC_ETH_LINK_PM0_IF_MODE_ENA(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM0_IF_MODE_ENA_SHIFT)) & NETC_ETH_LINK_PM0_IF_MODE_ENA_MASK)
/*! @} */

/*! @name PM0_IF_STATUS - Port MAC 0 Interface Status Register */
/*! @{ */

#define NETC_ETH_LINK_PM0_IF_STATUS_RGFD_MASK    (0x1000U)
#define NETC_ETH_LINK_PM0_IF_STATUS_RGFD_SHIFT   (12U)
/*! RGFD - RGMII full duplex */
#define NETC_ETH_LINK_PM0_IF_STATUS_RGFD(x)      (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM0_IF_STATUS_RGFD_SHIFT)) & NETC_ETH_LINK_PM0_IF_STATUS_RGFD_MASK)

#define NETC_ETH_LINK_PM0_IF_STATUS_RGSP_MASK    (0x6000U)
#define NETC_ETH_LINK_PM0_IF_STATUS_RGSP_SHIFT   (13U)
/*! RGSP - RGMII speed setting */
#define NETC_ETH_LINK_PM0_IF_STATUS_RGSP(x)      (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM0_IF_STATUS_RGSP_SHIFT)) & NETC_ETH_LINK_PM0_IF_STATUS_RGSP_MASK)

#define NETC_ETH_LINK_PM0_IF_STATUS_RGLNK_MASK   (0x8000U)
#define NETC_ETH_LINK_PM0_IF_STATUS_RGLNK_SHIFT  (15U)
/*! RGLNK - RGMII link */
#define NETC_ETH_LINK_PM0_IF_STATUS_RGLNK(x)     (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM0_IF_STATUS_RGLNK_SHIFT)) & NETC_ETH_LINK_PM0_IF_STATUS_RGLNK_MASK)
/*! @} */
...
#define NETC_ETH_LINK_PM1_IF_MODE_ENA_MASK       (0x8000U)
#define NETC_ETH_LINK_PM1_IF_MODE_ENA_SHIFT      (15U)
/*! ENA - AN Enable
 *  0b0..SSP and HD fields determine the RGMII link speed and duplex mode
 *  0b1..RGMII Auto-Negotiation Enabled - PHY in-band status information is used to select the speed of operation and duplex mode.
 */
#define NETC_ETH_LINK_PM1_IF_MODE_ENA(x)         (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM1_IF_MODE_ENA_SHIFT)) & NETC_ETH_LINK_PM1_IF_MODE_ENA_MASK)
/*! @} */

/*! @name PM1_IF_STATUS - Port MAC 1 Interface Status Register */
/*! @{ */

#define NETC_ETH_LINK_PM1_IF_STATUS_RGFD_MASK    (0x1000U)
#define NETC_ETH_LINK_PM1_IF_STATUS_RGFD_SHIFT   (12U)
/*! RGFD - RGMII full duplex */
#define NETC_ETH_LINK_PM1_IF_STATUS_RGFD(x)      (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM1_IF_STATUS_RGFD_SHIFT)) & NETC_ETH_LINK_PM1_IF_STATUS_RGFD_MASK)

#define NETC_ETH_LINK_PM1_IF_STATUS_RGSP_MASK    (0x6000U)
#define NETC_ETH_LINK_PM1_IF_STATUS_RGSP_SHIFT   (13U)
/*! RGSP - RGMII speed setting */
#define NETC_ETH_LINK_PM1_IF_STATUS_RGSP(x)      (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM1_IF_STATUS_RGSP_SHIFT)) & NETC_ETH_LINK_PM1_IF_STATUS_RGSP_MASK)

#define NETC_ETH_LINK_PM1_IF_STATUS_RGLNK_MASK   (0x8000U)
#define NETC_ETH_LINK_PM1_IF_STATUS_RGLNK_SHIFT  (15U)
/*! RGLNK - RGMII link */
#define NETC_ETH_LINK_PM1_IF_STATUS_RGLNK(x)     (((uint32_t)(((uint32_t)(x)) << NETC_ETH_LINK_PM1_IF_STATUS_RGLNK_SHIFT)) & NETC_ETH_LINK_PM1_IF_STATUS_RGLNK_MASK)
/*! @} */
