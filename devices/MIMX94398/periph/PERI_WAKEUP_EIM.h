...
#define WAKEUP_EIM_EICHEN_EICH9EN_MASK           (0x400000U)
#define WAKEUP_EIM_EICHEN_EICH9EN_SHIFT          (22U)
 ...
 */
#define WAKEUP_EIM_EICHEN_EICH9EN(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHEN_EICH9EN_SHIFT)) & WAKEUP_EIM_EICHEN_EICH9EN_MASK)

#define WAKEUP_EIM_EICHEN_EICH8EN_MASK           (0x800000U)
#define WAKEUP_EIM_EICHEN_EICH8EN_SHIFT          (23U)
 ...
 */
#define WAKEUP_EIM_EICHEN_EICH8EN(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHEN_EICH8EN_SHIFT)) & WAKEUP_EIM_EICHEN_EICH8EN_MASK)
...
#define WAKEUP_EIM_EICHD1_WORD0_CHKBIT_MASK_MASK (0xFFE00000U)
#define WAKEUP_EIM_EICHD1_WORD0_CHKBIT_MASK_SHIFT (21U)
/*! CHKBIT_MASK - Checkbit Mask */
...
#define WAKEUP_EIM_EICHD6_WORD1_B0_3DATA_MASK_MASK (0xFFFFFFFFU)
...
#define WAKEUP_EIM_EICHD8_WORD0_CHKBIT_MASK_MASK (0xFFFFFC00U)
#define WAKEUP_EIM_EICHD8_WORD0_CHKBIT_MASK_SHIFT (10U)
/*! CHKBIT_MASK - Checkbit Mask */
#define WAKEUP_EIM_EICHD8_WORD0_CHKBIT_MASK(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHD8_WORD0_CHKBIT_MASK_SHIFT)) & WAKEUP_EIM_EICHD8_WORD0_CHKBIT_MASK_MASK)
/*! @} */

/*! @name EICHD8_WORD1 - Error Injection Channel Descriptor 8, Word1 */
/*! @{ */

#define WAKEUP_EIM_EICHD8_WORD1_B0_3DATA_MASK_MASK (0x1U)
#define WAKEUP_EIM_EICHD8_WORD1_B0_3DATA_MASK_SHIFT (0U)
/*! B0_3DATA_MASK - Data Mask Bytes 0-3 */
#define WAKEUP_EIM_EICHD8_WORD1_B0_3DATA_MASK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHD8_WORD1_B0_3DATA_MASK_SHIFT)) & WAKEUP_EIM_EICHD8_WORD1_B0_3DATA_MASK_MASK)
/*! @} */

/*! @name EICHD9_WORD0 - Error Injection Channel Descriptor 9, Word0 */
/*! @{ */

#define WAKEUP_EIM_EICHD9_WORD0_CHKBIT_MASK_MASK (0xFF000000U)
#define WAKEUP_EIM_EICHD9_WORD0_CHKBIT_MASK_SHIFT (24U)
/*! CHKBIT_MASK - Checkbit Mask */
#define WAKEUP_EIM_EICHD9_WORD0_CHKBIT_MASK(x)   (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHD9_WORD0_CHKBIT_MASK_SHIFT)) & WAKEUP_EIM_EICHD9_WORD0_CHKBIT_MASK_MASK)
/*! @} */

/*! @name EICHD9_WORD1 - Error Injection Channel Descriptor 9, Word1 */
/*! @{ */

#define WAKEUP_EIM_EICHD9_WORD1_B0_3DATA_MASK_MASK (0xFFFFFFFFU)
#define WAKEUP_EIM_EICHD9_WORD1_B0_3DATA_MASK_SHIFT (0U)
/*! B0_3DATA_MASK - Data Mask Bytes 0-3 */
#define WAKEUP_EIM_EICHD9_WORD1_B0_3DATA_MASK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHD9_WORD1_B0_3DATA_MASK_SHIFT)) & WAKEUP_EIM_EICHD9_WORD1_B0_3DATA_MASK_MASK)
/*! @} */

/*! @name EICHD9_WORD2 - Error Injection Channel Descriptor 9, Word2 */
/*! @{ */

#define WAKEUP_EIM_EICHD9_WORD2_B4_7DATA_MASK_MASK (0xFFFFFFFFU)
#define WAKEUP_EIM_EICHD9_WORD2_B4_7DATA_MASK_SHIFT (0U)
/*! B4_7DATA_MASK - Data Mask Bytes 4-7 */
#define WAKEUP_EIM_EICHD9_WORD2_B4_7DATA_MASK(x) (((uint32_t)(((uint32_t)(x)) << WAKEUP_EIM_EICHD9_WORD2_B4_7DATA_MASK_SHIFT)) & WAKEUP_EIM_EICHD9_WORD2_B4_7DATA_MASK_MASK)
/*! @} */
