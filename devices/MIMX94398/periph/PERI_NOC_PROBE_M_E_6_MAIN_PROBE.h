...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_Probe_m_e_6_main_Probe
**
...
/*!
 * @file NOC_Probe_m_e_6_main_Probe.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_Probe_m_e_6_main_Probe
 *
 * CMSIS Peripheral Access Layer for NOC_Probe_m_e_6_main_Probe
 */

#if !defined(NOC_Probe_m_e_6_main_Probe_H_)
#define NOC_Probe_m_e_6_main_Probe_H_            /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_Probe_m_e_6_main_Probe Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_Probe_m_e_6_main_Probe_Peripheral_Access_Layer NOC_Probe_m_e_6_main_Probe Peripheral Access Layer
 * @{
 */

/** NOC_Probe_m_e_6_main_Probe - Size of Registers Arrays */
#define NOC_Probe_m_e_6_main_Probe_COUNTERS_COUNT 10u

/** NOC_Probe_m_e_6_main_Probe - Register Layout Typedef */
typedef struct {
  ...
  } COUNTERS[NOC_Probe_m_e_6_main_Probe_COUNTERS_COUNT];
} NOC_Probe_m_e_6_main_Probe_Type;

/* ----------------------------------------------------------------------------
   -- NOC_Probe_m_e_6_main_Probe Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_Probe_m_e_6_main_Probe_Register_Masks NOC_Probe_m_e_6_main_Probe Register Masks
 * @{
 */
...
#define NOC_Probe_m_e_6_main_Probe_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_Probe_m_e_6_main_Probe_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_Probe_m_e_6_main_Probe_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_ID_COREID_CORETYPEID_SHIFT)) & NOC_Probe_m_e_6_main_Probe_ID_COREID_CORETYPEID_MASK)

#define NOC_Probe_m_e_6_main_Probe_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_Probe_m_e_6_main_Probe_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_Probe_m_e_6_main_Probe_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_Probe_m_e_6_main_Probe_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_USERID_SHIFT)) & NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_USERID_MASK)

#define NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_NOCID_SHIFT)) & NOC_Probe_m_e_6_main_Probe_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MAINCTL - Main Control */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_ERREN_MASK (0x1U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_ERREN_SHIFT (0U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_ERREN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_ERREN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_ERREN_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_TRACEEN_MASK (0x2U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_TRACEEN_SHIFT (1U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_TRACEEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_TRACEEN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_TRACEEN_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_PAYLOADEN_MASK (0x4U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_PAYLOADEN_SHIFT (2U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_PAYLOADEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_PAYLOADEN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_PAYLOADEN_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_STATEN_MASK (0x8U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_STATEN_SHIFT (3U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_STATEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_STATEN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_STATEN_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_ALARMEN_MASK (0x10U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_ALARMEN_SHIFT (4U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_ALARMEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_ALARMEN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_ALARMEN_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_STATCONDDUMP_MASK (0x20U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_STATCONDDUMP_SHIFT (5U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_STATCONDDUMP(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_STATCONDDUMP_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_STATCONDDUMP_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_INTRUSIVEMODE_MASK (0x40U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_INTRUSIVEMODE_SHIFT (6U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_INTRUSIVEMODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_INTRUSIVEMODE_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_INTRUSIVEMODE_MASK)

#define NOC_Probe_m_e_6_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_MASK (0x80U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_SHIFT (7U)
#define NOC_Probe_m_e_6_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_MASK)
/*! @} */

/*! @name CFGCTL - Configuration Control */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_CFGCTL_GLOBALEN_MASK (0x1U)
#define NOC_Probe_m_e_6_main_Probe_CFGCTL_GLOBALEN_SHIFT (0U)
#define NOC_Probe_m_e_6_main_Probe_CFGCTL_GLOBALEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_CFGCTL_GLOBALEN_SHIFT)) & NOC_Probe_m_e_6_main_Probe_CFGCTL_GLOBALEN_MASK)

#define NOC_Probe_m_e_6_main_Probe_CFGCTL_ACTIVE_MASK (0x2U)
#define NOC_Probe_m_e_6_main_Probe_CFGCTL_ACTIVE_SHIFT (1U)
#define NOC_Probe_m_e_6_main_Probe_CFGCTL_ACTIVE(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_CFGCTL_ACTIVE_SHIFT)) & NOC_Probe_m_e_6_main_Probe_CFGCTL_ACTIVE_MASK)
/*! @} */

/*! @name STATPERIOD - Statistics Period */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_STATPERIOD_STATPERIOD_MASK (0x1FU)
#define NOC_Probe_m_e_6_main_Probe_STATPERIOD_STATPERIOD_SHIFT (0U)
#define NOC_Probe_m_e_6_main_Probe_STATPERIOD_STATPERIOD(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_STATPERIOD_STATPERIOD_SHIFT)) & NOC_Probe_m_e_6_main_Probe_STATPERIOD_STATPERIOD_MASK)
/*! @} */

/*! @name STATGO - StatGo */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_STATGO_STATGO_MASK (0x1U)
#define NOC_Probe_m_e_6_main_Probe_STATGO_STATGO_SHIFT (0U)
#define NOC_Probe_m_e_6_main_Probe_STATGO_STATGO(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_STATGO_STATGO_SHIFT)) & NOC_Probe_m_e_6_main_Probe_STATGO_STATGO_MASK)
/*! @} */

/*! @name SRC - Counters n Source */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_SRC_INTEVENT_MASK (0x1FU)
#define NOC_Probe_m_e_6_main_Probe_SRC_INTEVENT_SHIFT (0U)
/*! INTEVENT
 ...
 *  0b11111..reserved
 */
#define NOC_Probe_m_e_6_main_Probe_SRC_INTEVENT(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_SRC_INTEVENT_SHIFT)) & NOC_Probe_m_e_6_main_Probe_SRC_INTEVENT_MASK)

#define NOC_Probe_m_e_6_main_Probe_SRC_EXTEVENT_MASK (0x20U)
#define NOC_Probe_m_e_6_main_Probe_SRC_EXTEVENT_SHIFT (5U)
#define NOC_Probe_m_e_6_main_Probe_SRC_EXTEVENT(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_SRC_EXTEVENT_SHIFT)) & NOC_Probe_m_e_6_main_Probe_SRC_EXTEVENT_MASK)
/*! @} */

/* The count of NOC_Probe_m_e_6_main_Probe_SRC */
#define NOC_Probe_m_e_6_main_Probe_SRC_COUNT     (10U)

/*! @name VAL - Counters n Value */
/*! @{ */

#define NOC_Probe_m_e_6_main_Probe_VAL_COUNTERS_VAL_MASK (0x3FFFFFFU)
#define NOC_Probe_m_e_6_main_Probe_VAL_COUNTERS_VAL_SHIFT (0U)
/*! COUNTERS_VAL - Value */
#define NOC_Probe_m_e_6_main_Probe_VAL_COUNTERS_VAL(x) (((uint32_t)(((uint32_t)(x)) << NOC_Probe_m_e_6_main_Probe_VAL_COUNTERS_VAL_SHIFT)) & NOC_Probe_m_e_6_main_Probe_VAL_COUNTERS_VAL_MASK)
/*! @} */

/* The count of NOC_Probe_m_e_6_main_Probe_VAL */
#define NOC_Probe_m_e_6_main_Probe_VAL_COUNT     (10U)


/*!
 * @}
 */ /* end of group NOC_Probe_m_e_6_main_Probe_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_Probe_m_e_6_main_Probe_Peripheral_Access_Layer */
...
#endif  /* NOC_Probe_m_e_6_main_Probe_H_ */
