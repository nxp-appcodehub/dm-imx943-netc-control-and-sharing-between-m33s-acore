...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_I_PXP_wr_I_main_TranStatFltr
**
...
/*!
 * @file NOC_I_PXP_wr_I_main_TranStatFltr.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_I_PXP_wr_I_main_TranStatFltr
 *
 * CMSIS Peripheral Access Layer for NOC_I_PXP_wr_I_main_TranStatFltr
 */

#if !defined(NOC_I_PXP_wr_I_main_TranStatFltr_H_)
#define NOC_I_PXP_wr_I_main_TranStatFltr_H_      /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_I_PXP_wr_I_main_TranStatFltr Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_I_PXP_wr_I_main_TranStatFltr_Peripheral_Access_Layer NOC_I_PXP_wr_I_main_TranStatFltr Peripheral Access Layer
 * @{
 */

/** NOC_I_PXP_wr_I_main_TranStatFltr - Register Layout Typedef */
typedef struct {
...
} NOC_I_PXP_wr_I_main_TranStatFltr_Type;

/* ----------------------------------------------------------------------------
   -- NOC_I_PXP_wr_I_main_TranStatFltr Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_I_PXP_wr_I_main_TranStatFltr_Register_Masks NOC_I_PXP_wr_I_main_TranStatFltr Register Masks
 * @{
 */
...
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORETYPEID_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORETYPEID_MASK)

#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_USERID_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_USERID_MASK)

#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_NOCID_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_MODE_MODE_MASK (0x1U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_MODE_MODE_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_MODE_MODE_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_MODE_MODE_MASK)
/*! @} */

/*! @name ADDRBASE_LOW - Address Base LSB */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name ADDRWINDOWSIZE - Address Window Size */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name OPCODE - Packet Opcode */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_RDEN_MASK (0x1U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_RDEN_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_RDEN_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_RDEN_MASK)

#define NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_WREN_MASK (0x2U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_WREN_SHIFT (1U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_WREN_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_OPCODE_WREN_MASK)
/*! @} */

/*! @name USERBASE - User Base */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_USERBASE_USERBASE_MASK (0x7FFFFFFFU)
#define NOC_I_PXP_wr_I_main_TranStatFltr_USERBASE_USERBASE_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_USERBASE_USERBASE(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_USERBASE_USERBASE_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_USERBASE_USERBASE_MASK)
/*! @} */

/*! @name USERMASK - User Mask */
/*! @{ */

#define NOC_I_PXP_wr_I_main_TranStatFltr_USERMASK_USERMASK_MASK (0x7FFFFFFFU)
#define NOC_I_PXP_wr_I_main_TranStatFltr_USERMASK_USERMASK_SHIFT (0U)
#define NOC_I_PXP_wr_I_main_TranStatFltr_USERMASK_USERMASK(x) (((uint32_t)(((uint32_t)(x)) << NOC_I_PXP_wr_I_main_TranStatFltr_USERMASK_USERMASK_SHIFT)) & NOC_I_PXP_wr_I_main_TranStatFltr_USERMASK_USERMASK_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_I_PXP_wr_I_main_TranStatFltr_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_I_PXP_wr_I_main_TranStatFltr_Peripheral_Access_Layer */
...
#endif  /* NOC_I_PXP_wr_I_main_TranStatFltr_H_ */
