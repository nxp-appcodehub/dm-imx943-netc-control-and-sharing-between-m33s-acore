...
#if !defined(ENETC_PF_TMR_H_)
#define ENETC_PF_TMR_H_                          /**< Symbol preventing repeated inclusion */
...
typedef struct {
  ...
  __IO uint32_t TMR_FIPER[ENETC_PF_TMR_TMR_FIPERF_COUNT]; /**< Timer Fixed Interval Period, array offset: 0xD0, array step: 0x4 */
...
#define ENETC_PF_TMR_TMR_OARR_NUM_CLK_MASK       (0xFU)
#define ENETC_PF_TMR_TMR_OARR_NUM_CLK_SHIFT      (0U)
/*! NUM_CLK - Number of clocks between TMROFF updates */
#define ENETC_PF_TMR_TMR_OARR_NUM_CLK(x)         (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_OARR_NUM_CLK_SHIFT)) & ENETC_PF_TMR_TMR_OARR_NUM_CLK_MASK)

#define ENETC_PF_TMR_TMR_OARR_VALUE_MASK         (0xFF0000U)
#define ENETC_PF_TMR_TMR_OARR_VALUE_SHIFT        (16U)
/*! VALUE - The value to adjust the TMROFF every NUM_CLK clock period */
#define ENETC_PF_TMR_TMR_OARR_VALUE(x)           (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_OARR_VALUE_SHIFT)) & ENETC_PF_TMR_TMR_OARR_VALUE_MASK)

#define ENETC_PF_TMR_TMR_OARR_ENABLE_MASK        (0x80000000U)
#define ENETC_PF_TMR_TMR_OARR_ENABLE_SHIFT       (31U)
 ...
 */
#define ENETC_PF_TMR_TMR_OARR_ENABLE(x)          (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_OARR_ENABLE_SHIFT)) & ENETC_PF_TMR_TMR_OARR_ENABLE_MASK)
/*! @} */

/*! @name TMR_OAAR - Offset Adjustment Amount */
/*! @{ */

#define ENETC_PF_TMR_TMR_OAAR_AMOUNT_MASK        (0xFFFFU)
#define ENETC_PF_TMR_TMR_OAAR_AMOUNT_SHIFT       (0U)
/*! AMOUNT - The adjustment amount to be added or subtracted from TMROFF */
#define ENETC_PF_TMR_TMR_OAAR_AMOUNT(x)          (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_OAAR_AMOUNT_SHIFT)) & ENETC_PF_TMR_TMR_OAAR_AMOUNT_MASK)

#define ENETC_PF_TMR_TMR_OAAR_INCR_MASK          (0x80000000U)
#define ENETC_PF_TMR_TMR_OAAR_INCR_SHIFT         (31U)
/*! INCR - Increment or decrement the TMROFF by amount specified at TMR_OAAR rate */
#define ENETC_PF_TMR_TMR_OAAR_INCR(x)            (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_OAAR_INCR_SHIFT)) & ENETC_PF_TMR_TMR_OAAR_INCR_MASK)
/*! @} */
...
#define ENETC_PF_TMR_TMR_MSIVEC_VECTOR_MASK      (0x1U)
#define ENETC_PF_TMR_TMR_MSIVEC_VECTOR_SHIFT     (0U)
/*! VECTOR - Vector */
