...
#define XCACHE_CCR_ENWRBUF_MASK                  (0x2U)
#define XCACHE_CCR_ENWRBUF_SHIFT                 (1U)
/*! ENWRBUF - Enable Write Buffer
 *  0b0..Write buffer disabled
 *  0b1..Write buffer enabled
 */
#define XCACHE_CCR_ENWRBUF(x)                    (((uint32_t)(((uint32_t)(x)) << XCACHE_CCR_ENWRBUF_SHIFT)) & XCACHE_CCR_ENWRBUF_MASK)
