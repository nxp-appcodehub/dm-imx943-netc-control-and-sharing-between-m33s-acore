 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for AON_LSTCU
 *
 * CMSIS Peripheral Access Layer for AON_LSTCU
 */

#if !defined(AON_LSTCU_H_)
#define AON_LSTCU_H_                             /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- AON_LSTCU Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup AON_LSTCU_Peripheral_Access_Layer AON_LSTCU Peripheral Access Layer
 * @{
 */

/** AON_LSTCU - Size of Registers Arrays */
#define AON_LSTCU_MBIST_SCH_PTR_COUNT             1u

/** AON_LSTCU - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t MBPTR[AON_LSTCU_MBIST_SCH_PTR_COUNT]; /**< MBIST Scheduler Pointer, array offset: 0x300, array step: 0x4 */
} AON_LSTCU_Type;

/* ----------------------------------------------------------------------------
   -- AON_LSTCU Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup AON_LSTCU_Register_Masks AON_LSTCU Register Masks
 * @{
 */
...
#define AON_LSTCU_ERR_STAT_INVP_FB_MASK          (0x1U)
#define AON_LSTCU_ERR_STAT_INVP_FB_SHIFT         (0U)
 ...
 */
#define AON_LSTCU_ERR_STAT_INVP_FB(x)            (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_STAT_INVP_FB_SHIFT)) & AON_LSTCU_ERR_STAT_INVP_FB_MASK)

#define AON_LSTCU_ERR_STAT_INVP_MB_MASK          (0x2U)
#define AON_LSTCU_ERR_STAT_INVP_MB_SHIFT         (1U)
/*! INVP_MB - Invalid Pointer MBIST
 *  0b0..No invalid pointer
 *  0b1..Invalid BIST pointer specified
 */
#define AON_LSTCU_ERR_STAT_INVP_MB(x)            (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_STAT_INVP_MB_SHIFT)) & AON_LSTCU_ERR_STAT_INVP_MB_MASK)

#define AON_LSTCU_ERR_STAT_INVP_LB_MASK          (0x4U)
#define AON_LSTCU_ERR_STAT_INVP_LB_SHIFT         (2U)
/*! INVP_LB - Invalid Pointer LBIST
 *  0b0..Invalid scheduling of LSTCU by CSTCU occurs when CSTCU triggers LSTCU for BIST execution but LSTCU does
 *       not have corresponding BIST controller to execute BIST operation
 *  0b1..Invalid scheduling of LSTCU by CSTCU for BIST execution
 */
#define AON_LSTCU_ERR_STAT_INVP_LB(x)            (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_STAT_INVP_LB_SHIFT)) & AON_LSTCU_ERR_STAT_INVP_LB_MASK)

#define AON_LSTCU_ERR_STAT_UFSF_MASK             (0x10000U)
#define AON_LSTCU_ERR_STAT_UFSF_SHIFT            (16U)
/*! UFSF - Unrecoverable Fault Status
 *  0b0..No unrecoverable fault
 *  0b1..Unrecoverable fault
 */
#define AON_LSTCU_ERR_STAT_UFSF(x)               (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_STAT_UFSF_SHIFT)) & AON_LSTCU_ERR_STAT_UFSF_MASK)

#define AON_LSTCU_ERR_STAT_RFSF_MASK             (0x20000U)
#define AON_LSTCU_ERR_STAT_RFSF_SHIFT            (17U)
/*! RFSF - Recoverable Fault Status
 *  0b0..No recoverable fault
 *  0b1..Recoverable fault
 */
#define AON_LSTCU_ERR_STAT_RFSF(x)               (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_STAT_RFSF_SHIFT)) & AON_LSTCU_ERR_STAT_RFSF_MASK)
/*! @} */

/*! @name ERR_FM - Error Fault Mapping */
/*! @{ */

#define AON_LSTCU_ERR_FM_INVPFMFB_MASK           (0x1U)
#define AON_LSTCU_ERR_FM_INVPFMFB_SHIFT          (0U)
/*! INVPFMFB - Invalid BIST Pointer Fault Mapping During Functional Mode BIST Scheduling
 *  0b0..Recoverable
 *  0b1..Unrecoverable
 */
#define AON_LSTCU_ERR_FM_INVPFMFB(x)             (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_FM_INVPFMFB_SHIFT)) & AON_LSTCU_ERR_FM_INVPFMFB_MASK)

#define AON_LSTCU_ERR_FM_INVPFMMB_MASK           (0x2U)
#define AON_LSTCU_ERR_FM_INVPFMMB_SHIFT          (1U)
/*! INVPFMMB - Invalid BIST Pointer Fault Mapping During MBIST Scheduling
 *  0b0..Recoverable
 *  0b1..Unrecoverable
 */
#define AON_LSTCU_ERR_FM_INVPFMMB(x)             (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_FM_INVPFMMB_SHIFT)) & AON_LSTCU_ERR_FM_INVPFMMB_MASK)

#define AON_LSTCU_ERR_FM_INVPFMLB_MASK           (0x4U)
#define AON_LSTCU_ERR_FM_INVPFMLB_SHIFT          (2U)
/*! INVPFMLB - Invalid BIST Pointer Fault Mapping During LBIST Scheduling
 *  0b0..Recoverable
 *  0b1..Unrecoverable
 */
#define AON_LSTCU_ERR_FM_INVPFMLB(x)             (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_ERR_FM_INVPFMLB_SHIFT)) & AON_LSTCU_ERR_FM_INVPFMLB_MASK)
/*! @} */

/*! @name MB_RSTAT0 - MBIST Run Status 0 */
/*! @{ */

#define AON_LSTCU_MB_RSTAT0_MBSTAT0_MASK         (0x1U)
#define AON_LSTCU_MB_RSTAT0_MBSTAT0_SHIFT        (0U)
/*! MBSTAT0 - MBIST Run Result Status 0
 *  0b0..Pass
 *  0b1..Fail
 */
#define AON_LSTCU_MB_RSTAT0_MBSTAT0(x)           (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_MB_RSTAT0_MBSTAT0_SHIFT)) & AON_LSTCU_MB_RSTAT0_MBSTAT0_MASK)
/*! @} */

/*! @name MBFM0 - MBIST Fault Mapping 0 */
/*! @{ */

#define AON_LSTCU_MBFM0_MBSTATFM0_MASK           (0x1U)
#define AON_LSTCU_MBFM0_MBSTATFM0_SHIFT          (0U)
/*! MBSTATFM0 - MBIST Fault Mapping n
 *  0b0..Recoverable
 *  0b1..Unrecoverable
 */
#define AON_LSTCU_MBFM0_MBSTATFM0(x)             (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_MBFM0_MBSTATFM0_SHIFT)) & AON_LSTCU_MBFM0_MBSTATFM0_MASK)
/*! @} */

/*! @name STAG - Stagger */
/*! @{ */

#define AON_LSTCU_STAG_MB_DELAY_MASK             (0xFF00U)
#define AON_LSTCU_STAG_MB_DELAY_SHIFT            (8U)
/*! MB_DELAY - MBIST Delay */
#define AON_LSTCU_STAG_MB_DELAY(x)               (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_STAG_MB_DELAY_SHIFT)) & AON_LSTCU_STAG_MB_DELAY_MASK)
/*! @} */

/*! @name PH1_DUR - Phase 1 Duration */
/*! @{ */

#define AON_LSTCU_PH1_DUR_PH1DUR_MASK            (0x3FFU)
#define AON_LSTCU_PH1_DUR_PH1DUR_SHIFT           (0U)
/*! PH1DUR - Phase 1 Duration */
#define AON_LSTCU_PH1_DUR_PH1DUR(x)              (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_PH1_DUR_PH1DUR_SHIFT)) & AON_LSTCU_PH1_DUR_PH1DUR_MASK)
/*! @} */

/*! @name MBPTR - MBIST Scheduler Pointer */
/*! @{ */

#define AON_LSTCU_MBPTR_MBPTR_MASK               (0xFFU)
#define AON_LSTCU_MBPTR_MBPTR_SHIFT              (0U)
/*! MBPTR - MBIST Pointer */
#define AON_LSTCU_MBPTR_MBPTR(x)                 (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_MBPTR_MBPTR_SHIFT)) & AON_LSTCU_MBPTR_MBPTR_MASK)

#define AON_LSTCU_MBPTR_MBCSM_MASK               (0x100U)
#define AON_LSTCU_MBPTR_MBCSM_SHIFT              (8U)
/*! MBCSM - MBIST Mode
 *  0b0..Sequential
 *  0b1..Concurrent
 */
#define AON_LSTCU_MBPTR_MBCSM(x)                 (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_MBPTR_MBCSM_SHIFT)) & AON_LSTCU_MBPTR_MBCSM_MASK)

#define AON_LSTCU_MBPTR_MBEOL_MASK               (0x80000000U)
#define AON_LSTCU_MBPTR_MBEOL_SHIFT              (31U)
/*! MBEOL - MBIST End of List
 *  0b0..Not end of list
 *  0b1..End of list
 */
#define AON_LSTCU_MBPTR_MBEOL(x)                 (((uint32_t)(((uint32_t)(x)) << AON_LSTCU_MBPTR_MBEOL_SHIFT)) & AON_LSTCU_MBPTR_MBEOL_MASK)
/*! @} */

/* The count of AON_LSTCU_MBPTR */
#define AON_LSTCU_MBPTR_COUNT                    (1U)


/*!
 * @}
 */ /* end of group AON_LSTCU_Register_Masks */
