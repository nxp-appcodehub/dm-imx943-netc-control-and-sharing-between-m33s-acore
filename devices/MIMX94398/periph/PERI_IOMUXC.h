...
#define IOMUXC_SW_MUX_CTL_PAD_COUNT               192u
#define IOMUXC_SW_PAD_CTL_PAD_COUNT               192u
#define IOMUXC_SELECT_INPUT_COUNT                 203u
...
typedef struct {
  ...
  __IO uint32_t SW_PAD_CTL_PAD[IOMUXC_SW_PAD_CTL_PAD_COUNT]; /**< SW_PAD_CTL_PAD_DAP_TDI SW PAD Control Register..SW_PAD_CTL_PAD_WDOG_ANY SW PAD Control Register, array offset: 0x304, array step: 0x4 */
  __IO uint32_t SW_PAD_CTL_PAD_FCCU_ERR0;          /**< SW_PAD_CTL_PAD_FCCU_ERR0 SW PAD Control Register, offset: 0x604 */
  __IO uint32_t SELECT_INPUT[IOMUXC_SELECT_INPUT_COUNT]; /**< IMX943_AONMIX_TOP_CAN1_IPP_IND_CANRX_SELECT_INPUT DAISY Register..JTAG_MUX_TMS_SELECT_INPUT DAISY Register, array offset: 0x608, array step: 0x4 */
} IOMUXC_Type;
 ...
 *  0b000..Select mux mode: ALT0 mux port: IMX943_NETCMIX_TOP_NETC_PINMUX_ETH4_RXD03 of instance: imx943_netcmix_top
 *  0b001..Select mux mode: ALT1 mux port: IMX943_CCMSRCGPCMIX_TOP_ENET_REF_CLK_ROOT of instance: imx943_ccmsrcgpcmix_top
 *  0b010..Select mux mode: ALT2 mux port: IMX943_WAKEUPMIX_TOP_XSPI2_A_DATA07 of instance: imx943_wakeupmix_top
 *  0b011..Select mux mode: ALT3 mux port: IMX943_WAKEUPMIX_TOP_FLEXIO2_4_1_FLEXIO13 of instance: imx943_wakeupmix_top
 *  0b100..Select mux mode: ALT4 mux port: IMX943_WAKEUPMIX_TOP_FLEXIO1_3_2_FLEXIO09 of instance: imx943_wakeupmix_top
 *  0b101..Select mux mode: ALT5 mux port: IMX943_WAKEUPMIX_TOP_GPIO7_IO07 of instance: imx943_wakeupmix_top
 *  0b110..Select mux mode: ALT6 mux port: IMX943_WAKEUPMIX_TOP_DIG_ENCODER2_DATA_CLK of instance: imx943_wakeupmix_top
 *  0b111..Select mux mode: ALT7 mux port: IMX943_WAKEUPMIX_TOP_XBAR1_XBAR_INOUT05 of instance: imx943_wakeupmix_top
 */
...
#define IOMUXC_SW_PAD_CTL_PAD_SMC_MASK           (0x3E000U)
...
#define IOMUXC_SW_PAD_CTL_PAD_FCCU_ERR0_SMC_MASK (0x3E000U)
...
/*! @name SELECT_INPUT - IMX943_AONMIX_TOP_CAN1_IPP_IND_CANRX_SELECT_INPUT DAISY Register..JTAG_MUX_TMS_SELECT_INPUT DAISY Register */
/*! @{ */
