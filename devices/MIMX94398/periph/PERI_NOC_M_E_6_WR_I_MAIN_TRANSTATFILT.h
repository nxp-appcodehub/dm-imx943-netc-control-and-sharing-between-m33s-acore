...
/*!
 * @file NOC_m_e_6_wr_I_main_TranStatFilt.h
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_m_e_6_wr_I_main_TranStatFilt
 *
 * CMSIS Peripheral Access Layer for NOC_m_e_6_wr_I_main_TranStatFilt
 */

#if !defined(NOC_m_e_6_wr_I_main_TranStatFilt_H_)
#define NOC_m_e_6_wr_I_main_TranStatFilt_H_      /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_m_e_6_wr_I_main_TranStatFilt Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_m_e_6_wr_I_main_TranStatFilt_Peripheral_Access_Layer NOC_m_e_6_wr_I_main_TranStatFilt Peripheral Access Layer
 * @{
 */

/** NOC_m_e_6_wr_I_main_TranStatFilt - Register Layout Typedef */
typedef struct {
...
} NOC_m_e_6_wr_I_main_TranStatFilt_Type;

/* ----------------------------------------------------------------------------
   -- NOC_m_e_6_wr_I_main_TranStatFilt Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_m_e_6_wr_I_main_TranStatFilt_Register_Masks NOC_m_e_6_wr_I_main_TranStatFilt Register Masks
 * @{
 */
...
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORETYPEID_MASK)

#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_USERID_MASK)

#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_MODE_MODE_MASK (0x1U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_MODE_MODE_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_MODE_MODE_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_MODE_MODE_MASK)
/*! @} */

/*! @name ADDRBASE_LOW - Address Base LSB */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name ADDRBASE_HIGH - Address Base MSB */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK (0xFU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK)
/*! @} */

/*! @name ADDRWINDOWSIZE - Address Window Size */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name OPCODE - Packet Opcode */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_RDEN_MASK (0x1U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_RDEN_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_RDEN_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_RDEN_MASK)

#define NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_WREN_MASK (0x2U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_WREN_SHIFT (1U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_WREN_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_OPCODE_WREN_MASK)
/*! @} */

/*! @name USERBASE - User Base */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_USERBASE_USERBASE_MASK (0x1FFFFFFFU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_USERBASE_USERBASE_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_USERBASE_USERBASE(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_USERBASE_USERBASE_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_USERBASE_USERBASE_MASK)
/*! @} */

/*! @name USERMASK - User Mask */
/*! @{ */

#define NOC_m_e_6_wr_I_main_TranStatFilt_USERMASK_USERMASK_MASK (0x1FFFFFFFU)
#define NOC_m_e_6_wr_I_main_TranStatFilt_USERMASK_USERMASK_SHIFT (0U)
#define NOC_m_e_6_wr_I_main_TranStatFilt_USERMASK_USERMASK(x) (((uint32_t)(((uint32_t)(x)) << NOC_m_e_6_wr_I_main_TranStatFilt_USERMASK_USERMASK_SHIFT)) & NOC_m_e_6_wr_I_main_TranStatFilt_USERMASK_USERMASK_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_m_e_6_wr_I_main_TranStatFilt_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_m_e_6_wr_I_main_TranStatFilt_Peripheral_Access_Layer */
...
#endif  /* NOC_m_e_6_wr_I_main_TranStatFilt_H_ */
