 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for NOC_EIM
 *
 * CMSIS Peripheral Access Layer for NOC_EIM
 */

#if !defined(NOC_EIM_H_)
#define NOC_EIM_H_                               /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_EIM Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_EIM_Peripheral_Access_Layer NOC_EIM Peripheral Access Layer
 * @{
 */

/** NOC_EIM - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- NOC_EIM Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_EIM_Register_Masks NOC_EIM Register Masks
 * @{
 */
...
#define NOC_EIM_EIMCR_GEIEN_MASK                 (0x1U)
#define NOC_EIM_EIMCR_GEIEN_SHIFT                (0U)
/*! GEIEN - Global Error Injection Enable
 *  0b0..Disabled
 *  0b1..Enabled
 */
#define NOC_EIM_EIMCR_GEIEN(x)                   (((uint32_t)(((uint32_t)(x)) << NOC_EIM_EIMCR_GEIEN_SHIFT)) & NOC_EIM_EIMCR_GEIEN_MASK)
/*! @} */
 ...
 */
#define NOC_EIM_EICHEN_EICH0EN(x)                (((uint32_t)(((uint32_t)(x)) << NOC_EIM_EICHEN_EICH0EN_SHIFT)) & NOC_EIM_EICHEN_EICH0EN_MASK)
/*! @} */

/*! @name EICHD0_WORD0 - Error Injection Channel Descriptor 0, Word0 */
/*! @{ */

#define NOC_EIM_EICHD0_WORD0_CHKBIT_MASK_MASK    (0xF8000000U)
#define NOC_EIM_EICHD0_WORD0_CHKBIT_MASK_SHIFT   (27U)
/*! CHKBIT_MASK - Checkbit Mask */
#define NOC_EIM_EICHD0_WORD0_CHKBIT_MASK(x)      (((uint32_t)(((uint32_t)(x)) << NOC_EIM_EICHD0_WORD0_CHKBIT_MASK_SHIFT)) & NOC_EIM_EICHD0_WORD0_CHKBIT_MASK_MASK)
/*! @} */

/*! @name EICHD0_WORD1 - Error Injection Channel Descriptor 0, Word1 */
/*! @{ */

#define NOC_EIM_EICHD0_WORD1_B0_3DATA_MASK_MASK  (0x1U)
...
#define NOC_EIM_EICHD1_WORD0_CHKBIT_MASK_MASK    (0xFF000000U)
#define NOC_EIM_EICHD1_WORD0_CHKBIT_MASK_SHIFT   (24U)
/*! CHKBIT_MASK - Checkbit Mask */
#define NOC_EIM_EICHD1_WORD0_CHKBIT_MASK(x)      (((uint32_t)(((uint32_t)(x)) << NOC_EIM_EICHD1_WORD0_CHKBIT_MASK_SHIFT)) & NOC_EIM_EICHD1_WORD0_CHKBIT_MASK_MASK)
/*! @} */

/*! @name EICHD1_WORD1 - Error Injection Channel Descriptor 1, Word1 */
/*! @{ */

#define NOC_EIM_EICHD1_WORD1_B0_3DATA_MASK_MASK  (0x1U)
...
/*!
 * @}
 */ /* end of group NOC_EIM_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_EIM_Peripheral_Access_Layer */
