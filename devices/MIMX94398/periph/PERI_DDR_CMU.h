...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for DDR_CMU
**
 ...
 * @version 1.0
 * @date 2023-11-01
 * @brief CMSIS Peripheral Access Layer for DDR_CMU
 *
 * CMSIS Peripheral Access Layer for DDR_CMU
 */

#if !defined(DDR_CMU_H_)
#define DDR_CMU_H_                               /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- DDR_CMU Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup DDR_CMU_Peripheral_Access_Layer DDR_CMU Peripheral Access Layer
 * @{
 */

/** DDR_CMU - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- DDR_CMU Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup DDR_CMU_Register_Masks DDR_CMU Register Masks
 * @{
 */
...
#define DDR_CMU_GCR_FCE_MASK                     (0x1U)
#define DDR_CMU_GCR_FCE_SHIFT                    (0U)
/*! FCE - Frequency Check Enable
 *  0b0..Stops frequency checking
 *  0b1..Starts frequency checking
 */
#define DDR_CMU_GCR_FCE(x)                       (((uint32_t)(((uint32_t)(x)) << DDR_CMU_GCR_FCE_SHIFT)) & DDR_CMU_GCR_FCE_MASK)
/*! @} */

/*! @name RCCR - Reference Count Configuration Register */
/*! @{ */

#define DDR_CMU_RCCR_REF_CNT_MASK                (0xFFFFU)
#define DDR_CMU_RCCR_REF_CNT_SHIFT               (0U)
/*! REF_CNT - Reference clock count */
#define DDR_CMU_RCCR_REF_CNT(x)                  (((uint32_t)(((uint32_t)(x)) << DDR_CMU_RCCR_REF_CNT_SHIFT)) & DDR_CMU_RCCR_REF_CNT_MASK)
/*! @} */

/*! @name HTCR - High Threshold Configuration Register */
/*! @{ */

#define DDR_CMU_HTCR_HFREF_MASK                  (0xFFFFFFU)
#define DDR_CMU_HTCR_HFREF_SHIFT                 (0U)
/*! HFREF - High frequency reference threshold */
#define DDR_CMU_HTCR_HFREF(x)                    (((uint32_t)(((uint32_t)(x)) << DDR_CMU_HTCR_HFREF_SHIFT)) & DDR_CMU_HTCR_HFREF_MASK)
/*! @} */

/*! @name LTCR - Low Threshold Configuration Register */
/*! @{ */

#define DDR_CMU_LTCR_LFREF_MASK                  (0xFFFFFFU)
#define DDR_CMU_LTCR_LFREF_SHIFT                 (0U)
/*! LFREF - Low Frequency Reference Threshold */
#define DDR_CMU_LTCR_LFREF(x)                    (((uint32_t)(((uint32_t)(x)) << DDR_CMU_LTCR_LFREF_SHIFT)) & DDR_CMU_LTCR_LFREF_MASK)
/*! @} */

/*! @name SR - Status Register */
/*! @{ */

#define DDR_CMU_SR_FLL_MASK                      (0x1U)
#define DDR_CMU_SR_FLL_SHIFT                     (0U)
/*! FLL - Frequency lower than low frequency reference threshold event status
 *  0b0..No FLL event
 *  0b1..FLL event occurred
 */
#define DDR_CMU_SR_FLL(x)                        (((uint32_t)(((uint32_t)(x)) << DDR_CMU_SR_FLL_SHIFT)) & DDR_CMU_SR_FLL_MASK)

#define DDR_CMU_SR_FHH_MASK                      (0x2U)
#define DDR_CMU_SR_FHH_SHIFT                     (1U)
/*! FHH - Frequency higher than high frequency reference threshold event status
 *  0b0..No FHH event
 *  0b1..FHH event occurred
 */
#define DDR_CMU_SR_FHH(x)                        (((uint32_t)(((uint32_t)(x)) << DDR_CMU_SR_FHH_SHIFT)) & DDR_CMU_SR_FHH_MASK)

#define DDR_CMU_SR_RS_MASK                       (0x10U)
#define DDR_CMU_SR_RS_SHIFT                      (4U)
/*! RS - Run Status
 *  0b0..Frequency check stopped
 *  0b1..Frequency check running
 */
#define DDR_CMU_SR_RS(x)                         (((uint32_t)(((uint32_t)(x)) << DDR_CMU_SR_RS_SHIFT)) & DDR_CMU_SR_RS_MASK)
/*! @} */

/*! @name IER - Interrupt Enable Register */
/*! @{ */

#define DDR_CMU_IER_FLLAIE_MASK                  (0x4U)
#define DDR_CMU_IER_FLLAIE_SHIFT                 (2U)
 ...
 */
#define DDR_CMU_IER_FLLAIE(x)                    (((uint32_t)(((uint32_t)(x)) << DDR_CMU_IER_FLLAIE_SHIFT)) & DDR_CMU_IER_FLLAIE_MASK)

#define DDR_CMU_IER_FHHAIE_MASK                  (0x8U)
#define DDR_CMU_IER_FHHAIE_SHIFT                 (3U)
 ...
 */
#define DDR_CMU_IER_FHHAIE(x)                    (((uint32_t)(((uint32_t)(x)) << DDR_CMU_IER_FHHAIE_SHIFT)) & DDR_CMU_IER_FHHAIE_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group DDR_CMU_Register_Masks */


/*!
 * @}
 */ /* end of group DDR_CMU_Peripheral_Access_Layer */
