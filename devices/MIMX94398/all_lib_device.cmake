...
#set.board.imx943evk
#  # description: Sm_cfg Driver
#  set(CONFIG_USE_driver_sm_cfg true)

#  # description: Non_sm_cfg Driver
#  set(CONFIG_USE_driver_non_sm_cfg true)

#  # description: srtm_config Driver
#  set(CONFIG_USE_driver_srtm_config true)

#  # description: rpmsg_config Driver
#  set(CONFIG_USE_driver_rpmsg_config_cm33_core1 true)

#  # description: rpmsg_config Driver
#  set(CONFIG_USE_driver_rpmsg_config_cm7_core0 true)

#  # description: rpmsg_config Driver
#  set(CONFIG_USE_driver_rpmsg_config_cm7_core1 true)

#  # description: Board_project_template imx943evk
#  set(CONFIG_USE_board_project_template true)

#  # description: app_srtm Driver
#  set(CONFIG_USE_driver_app_srtm_cm33_core1 true)

#  # description: app_srtm Driver
#  set(CONFIG_USE_driver_app_srtm_cm7_core0 true)

#  # description: app_srtm Driver
#  set(CONFIG_USE_driver_app_srtm_cm7_core1 true)
...
#set.device.MIMX94398
#  # description: Rte_device
#  set(CONFIG_USE_device_RTE true)

#  # description: Irqsteer_1_soc cm33 core0 Driver
#  set(CONFIG_USE_driver_irqsteer_1_soc_cm33_core0 true)

#  # description: Electric Specification Driver
#  set(CONFIG_USE_driver_elec_spec true)
...
#  # description: Supply Driver
#  set(CONFIG_USE_driver_supply true)

#  # description: Cpu Driver
#  set(CONFIG_USE_driver_cpu true)
...
#  # description: Ccm Driver
#  set(CONFIG_USE_driver_ccm true)

#  # description: Src1 Driver
#  set(CONFIG_USE_driver_src1 true)

#  # description: FRO Driver
#  set(CONFIG_USE_driver_fro true)
...
#  # description: Irqsteer_1_soc cm33 core1 Driver
#  set(CONFIG_USE_driver_irqsteer_1_soc_cm33_core1 true)

#  # description: Irqsteer_1_soc cm7 core0 Driver
#  set(CONFIG_USE_driver_irqsteer_1_soc_cm7_core0 true)

#  # description: Irqsteer_1_soc cm7 core1 Driver
#  set(CONFIG_USE_driver_irqsteer_1_soc_cm7_core1 true)
...
#  # description: Device MIMX94398_cmsis
#  set(CONFIG_USE_device_CMSIS true)

#  # description: Device MIMX94398_system
...
#  # description: System Manager Agent porting layer for cortex-m33 core0 of imx943
#  set(CONFIG_USE_component_sm_imx943_cm33_core0 true)

#  # description: System Manager Agent porting layer for cortex-m33 core1 of imx943
#  set(CONFIG_USE_component_sm_imx943_cm33_core1 true)

#  # description: System Manager Agent porting layer for cortex-m7 core0 of imx943
#  set(CONFIG_USE_component_sm_imx943_cm7_core0 true)

#  # description: System Manager Agent porting layer for cortex-m7 core1 of imx943
#  set(CONFIG_USE_component_sm_imx943_cm7_core1 true)
...
#  # description: Component sm_reset
#  set(CONFIG_USE_component_sm_reset true)
...
#  # description: Driver netc imx943
#  set(CONFIG_USE_driver_netc_imx943 true)
...
#  set(CONFIG_USE_driver_dcif true)

#  # description: IRQSTEER Driver
#  set(CONFIG_USE_driver_irqsteer_1 true)

#  # description: GPT Driver
#  set(CONFIG_USE_driver_gpt true)

#  # description: FRACT_PLL Driver
#  set(CONFIG_USE_driver_fract_pll true)
...
#  # description: BBNSM Driver
#  set(CONFIG_USE_driver_bbnsm true)

#  # description: Component hal reset
#  set(CONFIG_USE_component_hal_reset true)

#  # description: reset1 porting layer for imx943
#  set(CONFIG_USE_component_hal_reset_imx943 true)
...
#  # description: Driver srtm rtc adapter
#  set(CONFIG_USE_component_srtm_rtc_adapter true)
...
#  # description: Component rtc_bbnsm_adapter
...
#  # description: power porting layer for imx943
#  set(CONFIG_USE_component_hal_power_imx943 true)
...
#  # description: pinctrl porting layer for imx943
#  set(CONFIG_USE_component_hal_pinctrl_imx943 true)
...
#  # description: Component ele_base_api
#  set(CONFIG_USE_component_ele_base_api true)
...
#  # description: clock porting layer for imx943
#  set(CONFIG_USE_component_hal_clock_imx943 true)
...
#  set(CONFIG_USE_middleware_soem_netc true)
...
#  # description: RPMsg-Lite for i.MX943 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_imx943_m7 true)

#  # description: RPMsg-Lite for i.MX943 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_imx943_m33 true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/imx943evk/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../components/audio
  ${CMAKE_CURRENT_LIST_DIR}/../../components/button
  ${CMAKE_CURRENT_LIST_DIR}/../../components/clock
  ${CMAKE_CURRENT_LIST_DIR}/../../components/clock/porting/platform/imx943
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/ele_base_api
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/pinctrl/porting/platform/imx943
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/power/porting/platform/imx943
  ${CMAKE_CURRENT_LIST_DIR}/../../components/pwm
  ${CMAKE_CURRENT_LIST_DIR}/../../components/reset
  ${CMAKE_CURRENT_LIST_DIR}/../../components/reset1
  ${CMAKE_CURRENT_LIST_DIR}/../../components/reset1/porting/platform/imx943
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/porting/platform/imx943/cm33_core0
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/porting/platform/imx943/cm33_core1
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/porting/platform/imx943/cm7_core0
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/porting/platform/imx943/cm7_core1
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/power
  ${CMAKE_CURRENT_LIST_DIR}/../../components/sm/reset
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../examples/imx943evk
  ${CMAKE_CURRENT_LIST_DIR}/../../examples/imx943evk/cm33_core1
  ${CMAKE_CURRENT_LIST_DIR}/../../examples/imx943evk/cm7_core0
  ${CMAKE_CURRENT_LIST_DIR}/../../examples/imx943evk/cm7_core1
  ${CMAKE_CURRENT_LIST_DIR}/../../examples/imx943evk/non_sm
  ${CMAKE_CURRENT_LIST_DIR}/../../examples/imx943evk/sm
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/soem
  ...
  ${CMAKE_CURRENT_LIST_DIR}/drivers/cm33_core0
  ${CMAKE_CURRENT_LIST_DIR}/drivers/cm33_core1
  ${CMAKE_CURRENT_LIST_DIR}/drivers/cm7_core0
  ${CMAKE_CURRENT_LIST_DIR}/drivers/cm7_core1
...
include_if_use(component_ak4497_adapter.MIMX94398)
include_if_use(component_at_least_one_i2c_mux_device_enabled.MIMX94398)
include_if_use(component_audio_sai_edma_adapter.MIMX94398)
include_if_use(component_button.MIMX94398)
include_if_use(component_codec_adapters.MIMX94398)
include_if_use(component_codec_i2c.MIMX94398)
include_if_use(component_common_task)
include_if_use(component_cs42448_adapter.MIMX94398)
include_if_use(component_cs42888_adapter.MIMX94398)
include_if_use(component_da7212_adapter.MIMX94398)
include_if_use(component_ele_base_api.MIMX94398)
include_if_use(component_enable_pca9544.MIMX94398)
include_if_use(component_enable_pca9548.MIMX94398)
include_if_use(component_eth_phy_common.MIMX94398)
include_if_use(component_flash_nor_lpspi.MIMX94398)
include_if_use(component_gpt_adapter.MIMX94398)
include_if_use(component_hal_clock.MIMX94398)
include_if_use(component_hal_clock_imx943.MIMX94398)
include_if_use(component_hal_pinctrl.MIMX94398)
include_if_use(component_hal_pinctrl_imx943.MIMX94398)
include_if_use(component_hal_power.MIMX94398)
include_if_use(component_hal_power_imx943.MIMX94398)
include_if_use(component_hal_reset.MIMX94398)
include_if_use(component_hal_reset_imx943.MIMX94398)
include_if_use(component_i2c_adapter_interface.MIMX94398)
include_if_use(component_i2c_mux_pca954x.MIMX94398)
include_if_use(component_i3c_bus.MIMX94398)
include_if_use(component_lists.MIMX94398)
include_if_use(component_lpi2c_adapter.MIMX94398)
include_if_use(component_lpit_adapter.MIMX94398)
include_if_use(component_lpspi_adapter.MIMX94398)
include_if_use(component_lptmr_adapter.MIMX94398)
include_if_use(component_lpuart_adapter.MIMX94398)
include_if_use(component_mem_manager.MIMX94398)
include_if_use(component_mem_manager_freertos.MIMX94398)
include_if_use(component_mem_manager_legacy.MIMX94398)
include_if_use(component_mem_manager_light.MIMX94398)
include_if_use(component_mflash_offchip.MIMX94398)
include_if_use(component_mflash_onchip.MIMX94398)
...
include_if_use(component_panic.MIMX94398)
include_if_use(component_pcm186x_adapter.MIMX94398)
include_if_use(component_pcm512x_adapter.MIMX94398)
include_if_use(component_phyaqr113c.MIMX94398)
include_if_use(component_phyar8031.MIMX94398)
include_if_use(component_phydp8384x.MIMX94398)
include_if_use(component_phyksz8041.MIMX94398)
include_if_use(component_phyksz8081.MIMX94398)
include_if_use(component_phylan8720a.MIMX94398)
include_if_use(component_phylan8741.MIMX94398)
include_if_use(component_phyrtl8201.MIMX94398)
include_if_use(component_phyrtl8211f.MIMX94398)
include_if_use(component_phyvsc8541.MIMX94398)
include_if_use(component_pwm_tpm_adapter.MIMX94398)
include_if_use(component_reset_adapter.MIMX94398)
include_if_use(component_rgpio_adapter.MIMX94398)
include_if_use(component_rpmsg_endpoint.MIMX94398)
include_if_use(component_rtc_bbnsm_adapter.MIMX94398)
include_if_use(component_serial_manager.MIMX94398)
include_if_use(component_serial_manager_spi.MIMX94398)
include_if_use(component_serial_manager_swo.MIMX94398)
include_if_use(component_serial_manager_uart.MIMX94398)
include_if_use(component_serial_manager_virtual.MIMX94398)
include_if_use(component_sgtl_adapter.MIMX94398)
include_if_use(component_silicon_id_imx8.MIMX94398)
include_if_use(component_silicon_id_imx93.MIMX94398)
include_if_use(component_silicon_id_imxrt10xx.MIMX94398)
include_if_use(component_silicon_id_imxrt1170.MIMX94398)
include_if_use(component_silicon_id_imxrt1180.MIMX94398)
include_if_use(component_silicon_id_rw610.MIMX94398)
include_if_use(component_silicon_id_scfw.MIMX94398)
include_if_use(component_sm_clock.MIMX94398)
include_if_use(component_sm_crc.MIMX94398)
include_if_use(component_sm_imx943_cm33_core0.MIMX94398)
include_if_use(component_sm_imx943_cm33_core1.MIMX94398)
include_if_use(component_sm_imx943_cm7_core0.MIMX94398)
include_if_use(component_sm_imx943_cm7_core1.MIMX94398)
include_if_use(component_sm_pinctrl.MIMX94398)
include_if_use(component_sm_power.MIMX94398)
include_if_use(component_sm_reset.MIMX94398)
include_if_use(component_sm_scmi.MIMX94398)
include_if_use(component_sm_smt.MIMX94398)
include_if_use(component_software_crc_adapter.MIMX94398)
include_if_use(component_software_rng_adapter.MIMX94398)
include_if_use(component_srtm_audio_service.MIMX94398)
include_if_use(component_srtm_auto_service.MIMX94398)
include_if_use(component_srtm_i2c_codec_adapter.MIMX94398)
include_if_use(component_srtm_i2c_service.MIMX94398)
include_if_use(component_srtm_io_service.MIMX94398)
include_if_use(component_srtm_keypad_service.MIMX94398)
include_if_use(component_srtm_lfcl_service.MIMX94398)
include_if_use(component_srtm_netc_service.MIMX94398)
include_if_use(component_srtm_pdm_edma_adapter.MIMX94398)
include_if_use(component_srtm_pf1550_adapter.MIMX94398)
include_if_use(component_srtm_pmic_service.MIMX94398)
include_if_use(component_srtm_pwm_adapter.MIMX94398)
include_if_use(component_srtm_pwm_service.MIMX94398)
include_if_use(component_srtm_rtc_adapter.MIMX94398)
include_if_use(component_srtm_rtc_service.MIMX94398)
include_if_use(component_srtm_sai_edma_adapter.MIMX94398)
include_if_use(component_srtm_sensor_service.MIMX94398)
include_if_use(component_srtm_snvs_lp_rtc_adapter.MIMX94398)
include_if_use(component_srtm_wm8524_adapter.MIMX94398)
include_if_use(component_tfa9896_adapter.MIMX94398)
include_if_use(component_tfa9xxx_adapter.MIMX94398)
include_if_use(component_timer_manager.MIMX94398)
include_if_use(component_tpm_adapter.MIMX94398)
include_if_use(component_wm8524_adapter.MIMX94398)
include_if_use(component_wm8904_adapter.MIMX94398)
include_if_use(component_wm8960_adapter.MIMX94398)
include_if_use(component_wm8962_adapter.MIMX94398)
include_if_use(device_CMSIS.MIMX94398)
include_if_use(device_RTE.MIMX94398)
include_if_use(device_project_template.MIMX94398)
include_if_use(device_startup.MIMX94398)
include_if_use(device_system.MIMX94398)
include_if_use(driver_adp5585.MIMX94398)
include_if_use(driver_ak4497.MIMX94398)
include_if_use(driver_aoi.MIMX94398)
include_if_use(driver_app_srtm_cm33_core1)
include_if_use(driver_app_srtm_cm7_core0)
include_if_use(driver_app_srtm_cm7_core1)
include_if_use(driver_bbnsm.MIMX94398)
include_if_use(driver_cache_armv7_m7.MIMX94398)
include_if_use(driver_cache_xcache.MIMX94398)
include_if_use(driver_camera-common.MIMX94398)
include_if_use(driver_camera-device-ap1302.MIMX94398)
include_if_use(driver_camera-device-common.MIMX94398)
include_if_use(driver_camera-device-max9286.MIMX94398)
include_if_use(driver_camera-device-mt9m114.MIMX94398)
include_if_use(driver_camera-device-ov5640.MIMX94398)
include_if_use(driver_camera-device-ov7670.MIMX94398)
include_if_use(driver_camera-device-ov7725.MIMX94398)
include_if_use(driver_camera-device-sccb.MIMX94398)
include_if_use(driver_camera-receiver-common.MIMX94398)
include_if_use(driver_ccm.MIMX94398)
include_if_use(driver_clock.MIMX94398)
include_if_use(driver_cmsis_lpuart.MIMX94398)
include_if_use(driver_codec.MIMX94398)
include_if_use(driver_common.MIMX94398)
include_if_use(driver_cpu.MIMX94398)
include_if_use(driver_cs42448.MIMX94398)
include_if_use(driver_cs42888.MIMX94398)
include_if_use(driver_dbi.MIMX94398)
include_if_use(driver_dc-fb-common.MIMX94398)
include_if_use(driver_dc-fb-dbi.MIMX94398)
include_if_use(driver_dcif.MIMX94398)
include_if_use(driver_dialog7212.MIMX94398)
include_if_use(driver_display-adv7535.MIMX94398)
include_if_use(driver_display-common.MIMX94398)
include_if_use(driver_display-it6161.MIMX94398)
include_if_use(driver_display-it6263.MIMX94398)
include_if_use(driver_display-sn65dsi83.MIMX94398)
include_if_use(driver_ecat.MIMX94398)
include_if_use(driver_edma4.MIMX94398)
include_if_use(driver_edma_soc.MIMX94398)
include_if_use(driver_elec_spec.MIMX94398)
include_if_use(driver_enet.MIMX94398)
include_if_use(driver_enet_qos.MIMX94398)
include_if_use(driver_eqdc.MIMX94398)
include_if_use(driver_ewm.MIMX94398)
include_if_use(driver_fbdev.MIMX94398)
include_if_use(driver_flexcan.MIMX94398)
include_if_use(driver_flexcan_edma.MIMX94398)
include_if_use(driver_flexio.MIMX94398)
include_if_use(driver_flexio_i2c_master.MIMX94398)
include_if_use(driver_flexio_i2s.MIMX94398)
include_if_use(driver_flexio_i2s_edma.MIMX94398)
include_if_use(driver_flexio_spi.MIMX94398)
include_if_use(driver_flexio_spi_edma.MIMX94398)
include_if_use(driver_flexio_uart.MIMX94398)
include_if_use(driver_flexio_uart_edma.MIMX94398)
include_if_use(driver_flexspi_edma.MIMX94398)
include_if_use(driver_fract_pll.MIMX94398)
include_if_use(driver_fro.MIMX94398)
include_if_use(driver_fxas21002cq.MIMX94398)
include_if_use(driver_fxls8974cf.MIMX94398)
include_if_use(driver_fxos8700cq.MIMX94398)
include_if_use(driver_gpt.MIMX94398)
include_if_use(driver_htu21d.MIMX94398)
include_if_use(driver_icm42688p.MIMX94398)
include_if_use(driver_iomuxc.MIMX94398)
include_if_use(driver_irqsteer_1.MIMX94398)
include_if_use(driver_irqsteer_1_soc_cm33_core0.MIMX94398)
include_if_use(driver_irqsteer_1_soc_cm33_core1.MIMX94398)
include_if_use(driver_irqsteer_1_soc_cm7_core0.MIMX94398)
include_if_use(driver_irqsteer_1_soc_cm7_core1.MIMX94398)
include_if_use(driver_lpi2c.MIMX94398)
include_if_use(driver_lpi2c_edma.MIMX94398)
include_if_use(driver_lpit.MIMX94398)
include_if_use(driver_lpspi.MIMX94398)
include_if_use(driver_lpspi_edma.MIMX94398)
include_if_use(driver_lptmr.MIMX94398)
include_if_use(driver_lpuart.MIMX94398)
include_if_use(driver_lpuart_edma.MIMX94398)
include_if_use(driver_lsm6dso.MIMX94398)
include_if_use(driver_max30101.MIMX94398)
include_if_use(driver_memory.MIMX94398)
include_if_use(driver_mma8451q.MIMX94398)
include_if_use(driver_mma8652fc.MIMX94398)
include_if_use(driver_msgintr.MIMX94398)
include_if_use(driver_mu1.MIMX94398)
include_if_use(driver_netc.MIMX94398)
include_if_use(driver_netc_imx943.MIMX94398)
include_if_use(driver_netc_msg.MIMX94398)
include_if_use(driver_netc_phywrapper.MIMX94398)
include_if_use(driver_netc_switch.MIMX94398)
include_if_use(driver_non_sm_cfg)
include_if_use(driver_p3t1755.MIMX94398)
include_if_use(driver_pca6416a.MIMX94398)
include_if_use(driver_pca9420.MIMX94398)
include_if_use(driver_pca9422.MIMX94398)
include_if_use(driver_pcal6408.MIMX94398)
include_if_use(driver_pcal6524.MIMX94398)
include_if_use(driver_pcm186x.MIMX94398)
include_if_use(driver_pcm512x.MIMX94398)
include_if_use(driver_pdm.MIMX94398)
include_if_use(driver_pdm_edma.MIMX94398)
include_if_use(driver_pf1550.MIMX94398)
include_if_use(driver_pf3000.MIMX94398)
include_if_use(driver_pf5020.MIMX94398)
include_if_use(driver_power.MIMX94398)
include_if_use(driver_pwm.MIMX94398)
include_if_use(driver_pxp.MIMX94398)
include_if_use(driver_reset.MIMX94398)
include_if_use(driver_rgpio.MIMX94398)
include_if_use(driver_rpmsg_config_cm33_core1)
include_if_use(driver_rpmsg_config_cm7_core0)
include_if_use(driver_rpmsg_config_cm7_core1)
include_if_use(driver_s3mu.MIMX94398)
include_if_use(driver_sai.MIMX94398)
include_if_use(driver_sai_edma.MIMX94398)
include_if_use(driver_sar_adc.MIMX94398)
include_if_use(driver_sema42.MIMX94398)
include_if_use(driver_sgtl5000.MIMX94398)
include_if_use(driver_sinc.MIMX94398)
include_if_use(driver_sm_cfg)
include_if_use(driver_sramctl.MIMX94398)
include_if_use(driver_src1.MIMX94398)
include_if_use(driver_srtm.MIMX94398)
include_if_use(driver_srtm_config)
include_if_use(driver_srtm_freertos.MIMX94398)
include_if_use(driver_supply.MIMX94398)
include_if_use(driver_tfa9896.MIMX94398)
include_if_use(driver_tfa9xxx.MIMX94398)
include_if_use(driver_tfa9xxx_hal.MIMX94398)
include_if_use(driver_tpm.MIMX94398)
include_if_use(driver_trdc_soc.MIMX94398)
include_if_use(driver_tsl2561.MIMX94398)
include_if_use(driver_tstmr.MIMX94398)
include_if_use(driver_video-common.MIMX94398)
include_if_use(driver_video-i2c.MIMX94398)
include_if_use(driver_wm8524.MIMX94398)
include_if_use(driver_wm8904.MIMX94398)
include_if_use(driver_wm8960.MIMX94398)
include_if_use(driver_wm8962.MIMX94398)
include_if_use(driver_xbar_1.MIMX94398)
...
include_if_use(middleware_multicore_rpmsg-lite_imx943_m33)
include_if_use(middleware_multicore_rpmsg-lite_imx943_m7)
...
include_if_use(middleware_soem_netc)
include_if_use(middleware_tinycbor)
include_if_use(utilities_misc_utilities.MIMX94398)
include_if_use(utility_assert.MIMX94398)
include_if_use(utility_assert_lite.MIMX94398)
include_if_use(utility_debug_console.MIMX94398)
include_if_use(utility_debug_console_lite.MIMX94398)
include_if_use(utility_debug_console_template_config.MIMX94398)
include_if_use(utility_incbin.MIMX94398)
include_if_use(utility_notifier.MIMX94398)
include_if_use(utility_shell.MIMX94398)
include_if_use(utility_str.MIMX94398)
