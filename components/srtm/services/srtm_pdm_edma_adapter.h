...
#ifndef _SRTM_PDM_EDMA_ADAPTER_H_
#define _SRTM_PDM_EDMA_ADAPTER_H_
 ...
 */
#ifndef SRTM_PDM_EDMA_ADAPTER_FORCE_LOCAL_AND_EXTRA_BUFFERS
#define SRTM_PDM_EDMA_ADAPTER_FORCE_LOCAL_AND_EXTRA_BUFFERS 0
#endif

#define SRTM_PDM_EDMA_MAX_LOCAL_PERIOD_ALIGNMENT (4U)

/*! @brief Extra device intitialize function for PDM EDMA adapter. */
...
/*! @brief PDM EDMA configuration.  */
typedef struct _srtm_pdm_edma_config
{
...
/*! @brief PDM EDMA local buffer.  */
typedef struct _srtm_pdm_edma_local_buf
{
 ...
 */
typedef void (*srtm_pdm_edma_hwvad_callback_t)(srtm_sai_adapter_t adapter, void *params);
...
typedef void (*srtm_pdm_edma_data_callback_t)(srtm_sai_adapter_t adapter, void *data, uint32_t bytes, void *params);
 ...
 *
 * @param adapter PDM EDMA adapter to set.
 ...
 * NOTE: It used only if local buffer is set by SRTM_PdmEdmaAdapter_SetRxLocalBuf and it must be called before service
 * start.
 *
 * @param adapter PDM EDMA adapter to set.
 ...
 *
 * @param adapter PDM EDMA adapter instance.
 ...
 * the HWVAD will be enabled when the PDM capture starts. SRTM_PdmEdmaAdapter_EnableHwvad can be used to disable or
