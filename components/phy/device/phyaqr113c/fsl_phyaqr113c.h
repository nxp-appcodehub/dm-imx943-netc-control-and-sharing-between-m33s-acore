...
@section PHYAQR113C
  The current PHYAQR113C driver version is 2.0.0.

  - 2.0.0
    - Initial version.
*/

#ifndef _FSL_PHYAQR113C_H_
#define _FSL_PHYAQR113C_H_
...
typedef struct _phy_aqr113c_resource
{
    mdioWriteExt write;
    mdioReadExt read;
} phy_aqr113c_resource_t;

extern const phy_operations_t phyaqr113c_ops;
